	...
	namespace Microsoft
	{
		namespace Win32
		{
			namespace SafeHandles
			{
				...
				//	Get:IsInvalid
				mscorlib::System::Boolean  CriticalHandleZeroOrMinusOneIsInvalid::get_IsInvalid() const
				{
				...
				//	Get:IsClosed
				mscorlib::System::Boolean  CriticalHandleZeroOrMinusOneIsInvalid::get_IsClosed() const
				{
