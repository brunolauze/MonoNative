#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_INVALIDPROGRAMEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_INVALIDPROGRAMEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.InvalidProgramException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "InvalidProgramException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "InvalidProgramException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "InvalidProgramException", 2, __parameter_types__, __parameters__);
			};
		
			InvalidProgramException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			InvalidProgramException(MonoObject *nativeObject)
			...
			InvalidProgramException & operator=(InvalidProgramException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(InvalidProgramException &value) { return mscorlib::System::Object::Equals(value); };
