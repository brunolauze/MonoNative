#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_OPERATIONCANCELEDEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_OPERATIONCANCELEDEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.OperationCanceledException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "OperationCanceledException");
			};
		
			OperationCanceledException(mscorlib::System::String message)
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.OperationCanceledException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "OperationCanceledException", 1, __parameter_types__, __parameters__);
			};
		
			OperationCanceledException(mscorlib::System::String message, mscorlib::System::Exception innerException)
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.OperationCanceledException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "OperationCanceledException", 2, __parameter_types__, __parameters__);
			};
		
			OperationCanceledException(mscorlib::System::Threading::CancellationToken token)
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.OperationCanceledException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
			...
			OperationCanceledException(mscorlib::System::String message, mscorlib::System::Threading::CancellationToken token)
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.OperationCanceledException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__parameters__[0] = (MonoObject*)message;
				__parameters__[1] = (MonoObject*)token;
				__native_object__ = Global::New("mscorlib", "System", "OperationCanceledException", 2, __parameter_types__, __parameters__);
			};
		
			OperationCanceledException(mscorlib::System::String message, mscorlib::System::Exception innerException, mscorlib::System::Threading::CancellationToken token)
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.OperationCanceledException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__parameters__[0] = (MonoObject*)message;
				__parameters__[1] = (MonoObject*)innerException;
				__parameters__[2] = (MonoObject*)token;
				__native_object__ = Global::New("mscorlib", "System", "OperationCanceledException", 3, __parameter_types__, __parameters__);
			};
		
			OperationCanceledException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			OperationCanceledException(MonoObject *nativeObject)
			...
			OperationCanceledException & operator=(OperationCanceledException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(OperationCanceledException &value) { return mscorlib::System::Object::Equals(value); };
