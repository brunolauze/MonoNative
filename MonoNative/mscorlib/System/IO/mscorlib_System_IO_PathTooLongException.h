#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_IO_PATHTOOLONGEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_IO_PATHTOOLONGEXCEPTION_H
	...
	namespace System
	{
		namespace IO
		{
			...
			public:
				...
				: mscorlib::System::IO::IOException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.IO.PathTooLongException"))
				, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					__native_object__ = Global::New("mscorlib", "System.IO", "PathTooLongException");
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.IO", "PathTooLongException", 1, __parameter_types__, __parameters__);
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.IO", "PathTooLongException", 2, __parameter_types__, __parameters__);
				};
			
				PathTooLongException(mscorlib::NativeTypeInfo *nativeTypeInfo)
				...
				PathTooLongException(MonoObject *nativeObject)
				...
				PathTooLongException & operator=(PathTooLongException &value) { __native_object__ = value.GetNativeObject(); return value; };
				bool operator==(PathTooLongException &value) { return mscorlib::System::Object::Equals(value); };
