...
namespace mscorlib
{
	namespace System
	{
		namespace IO
		{
			...
			//	Get:CanRead
			mscorlib::System::Boolean  Stream::get_CanRead()
			{
			...
			//	Get:CanSeek
			mscorlib::System::Boolean  Stream::get_CanSeek()
			{
			...
			//	Get:CanWrite
			mscorlib::System::Boolean  Stream::get_CanWrite()
			{
			...
			//	Get:CanTimeout
			mscorlib::System::Boolean  Stream::get_CanTimeout()
			{
			...
			//	Get:Length
			mscorlib::System::Int64  Stream::get_Length()
			{
			...
			//	Get/Set:Position
			mscorlib::System::Int64  Stream::get_Position()
			{
			...
			//	Get/Set:ReadTimeout
			mscorlib::System::Int32  Stream::get_ReadTimeout()
			{
			...
			mscorlib::System::Int32  Stream::get_WriteTimeout()
			{
