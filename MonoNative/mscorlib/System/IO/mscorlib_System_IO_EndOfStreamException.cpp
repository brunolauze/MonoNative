...
namespace mscorlib
{
	namespace System
	{
		namespace IO
		{
			...
			//	Get:InnerException
			mscorlib::System::Exception  EndOfStreamException::get_InnerException()
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  EndOfStreamException::get_HelpLink()
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  EndOfStreamException::get_HResult()
			{
			...
			//	Get:Message
			mscorlib::System::String  EndOfStreamException::get_Message()
			{
			...
			//	Get/Set:Source
			mscorlib::System::String  EndOfStreamException::get_Source()
			{
			...
			//	Get:StackTrace
			mscorlib::System::String  EndOfStreamException::get_StackTrace()
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  EndOfStreamException::get_TargetSite()
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  EndOfStreamException::get_Data()
			{
