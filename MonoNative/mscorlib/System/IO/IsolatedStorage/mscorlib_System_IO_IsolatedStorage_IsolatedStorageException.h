#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_IO_ISOLATEDSTORAGE_ISOLATEDSTORAGEEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_IO_ISOLATEDSTORAGE_ISOLATEDSTORAGEEXCEPTION_H
		...
		namespace IO
		{
			namespace IsolatedStorage
			{
				...
				public:
					...
					: mscorlib::System::Exception(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.IO.IsolatedStorage.IsolatedStorageException"))
					, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						__native_object__ = Global::New("mscorlib", "System.IO.IsolatedStorage", "IsolatedStorageException");
					};
					...
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.IO.IsolatedStorage", "IsolatedStorageException", 1, __parameter_types__, __parameters__);
					};
					...
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.IO.IsolatedStorage", "IsolatedStorageException", 2, __parameter_types__, __parameters__);
					};
				
					IsolatedStorageException(mscorlib::NativeTypeInfo *nativeTypeInfo)
					...
					IsolatedStorageException(MonoObject *nativeObject)
