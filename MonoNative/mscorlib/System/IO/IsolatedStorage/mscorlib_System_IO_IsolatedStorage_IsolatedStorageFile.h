		...
		namespace IO
		{
			namespace IsolatedStorage
			{
				...
				public:
					...
					bool operator==(IsolatedStorageFile &value) { return mscorlib::System::Object::Equals(value); };
					...
					void  CopyFile(const char *sourceFileName, const char *destinationFileName, mscorlib::System::Boolean overwrite);
					mscorlib::System::IO::IsolatedStorage::IsolatedStorageFileStream  CreateFile(mscorlib::System::String path);
					mscorlib::System::IO::IsolatedStorage::IsolatedStorageFileStream  CreateFile(const char *path);
					...
					std::vector<mscorlib::System::String*>  GetFileNames(const char *searchPattern);
					...
					void  MoveDirectory(const char *sourceDirectoryName, const char *destinationDirectoryName);
					...
					mscorlib::System::IO::IsolatedStorage::IsolatedStorageFileStream  OpenFile(const char *path, mscorlib::System::IO::FileMode::__ENUM__ mode);
					...
					mscorlib::System::IO::IsolatedStorage::IsolatedStorageFileStream  OpenFile(const char *path, mscorlib::System::IO::FileMode::__ENUM__ mode, mscorlib::System::IO::FileAccess::__ENUM__ access);
					...
					mscorlib::System::IO::IsolatedStorage::IsolatedStorageFileStream  OpenFile(const char *path, mscorlib::System::IO::FileMode::__ENUM__ mode, mscorlib::System::IO::FileAccess::__ENUM__ access, mscorlib::System::IO::FileShare::__ENUM__ share);
