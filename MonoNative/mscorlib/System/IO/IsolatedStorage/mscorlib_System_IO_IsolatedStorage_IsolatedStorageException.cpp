	...
	namespace System
	{
		namespace IO
		{
			namespace IsolatedStorage
			{
				...
				//	Get:InnerException
				mscorlib::System::Exception  IsolatedStorageException::get_InnerException()
				{
				...
				//	Get/Set:HelpLink
				mscorlib::System::String  IsolatedStorageException::get_HelpLink()
				{
				...
				//	Get/Set:HResult
				mscorlib::System::Int32  IsolatedStorageException::get_HResult()
				{
				...
				//	Get:Message
				mscorlib::System::String  IsolatedStorageException::get_Message()
				{
				...
				//	Get/Set:Source
				mscorlib::System::String  IsolatedStorageException::get_Source()
				{
				...
				//	Get:StackTrace
				mscorlib::System::String  IsolatedStorageException::get_StackTrace()
				{
				...
				//	Get:TargetSite
				mscorlib::System::Reflection::MethodBase  IsolatedStorageException::get_TargetSite()
				{
				...
				//	Get:Data
				mscorlib::System::Collections::IDictionary  IsolatedStorageException::get_Data()
				{
