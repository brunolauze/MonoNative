...
namespace mscorlib
{
	namespace System
	{
		namespace IO
		{
			...
			//	Get:InnerException
			mscorlib::System::Exception  DriveNotFoundException::get_InnerException()
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  DriveNotFoundException::get_HelpLink()
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  DriveNotFoundException::get_HResult()
			{
			...
			//	Get:Message
			mscorlib::System::String  DriveNotFoundException::get_Message()
			{
			...
			//	Get/Set:Source
			mscorlib::System::String  DriveNotFoundException::get_Source()
			{
			...
			//	Get:StackTrace
			mscorlib::System::String  DriveNotFoundException::get_StackTrace()
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  DriveNotFoundException::get_TargetSite()
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  DriveNotFoundException::get_Data()
			{
