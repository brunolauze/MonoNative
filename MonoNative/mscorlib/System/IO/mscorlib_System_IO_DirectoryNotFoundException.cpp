...
namespace mscorlib
{
	namespace System
	{
		namespace IO
		{
			...
			//	Get:InnerException
			mscorlib::System::Exception  DirectoryNotFoundException::get_InnerException()
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  DirectoryNotFoundException::get_HelpLink()
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  DirectoryNotFoundException::get_HResult()
			{
			...
			//	Get:Message
			mscorlib::System::String  DirectoryNotFoundException::get_Message()
			{
			...
			//	Get/Set:Source
			mscorlib::System::String  DirectoryNotFoundException::get_Source()
			{
			...
			//	Get:StackTrace
			mscorlib::System::String  DirectoryNotFoundException::get_StackTrace()
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  DirectoryNotFoundException::get_TargetSite()
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  DirectoryNotFoundException::get_Data()
			{
