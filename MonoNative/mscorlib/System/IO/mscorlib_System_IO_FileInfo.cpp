	...
	namespace System
	{
		namespace IO
		{
			...
			mscorlib::System::IO::FileStream FileInfo::Open(mscorlib::System::IO::FileMode::__ENUM__ mode, mscorlib::System::IO::FileAccess::__ENUM__ access, mscorlib::System::IO::FileShare::__ENUM__ share)
			{
					...
					__parameters__[2] = &__param_share__;
			...
			void FileInfo::MoveTo(mscorlib::System::String destFileName)
			{
					...
					__parameters__[0] = mono_string_new(Global::GetDomain(), destFileName);
			...
			void FileInfo::MoveTo(const char *destFileName)
			{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
					__parameter_types__[0] = Global::GetType(typeid(destFileName).name());
			...
			mscorlib::System::IO::FileInfo FileInfo::CopyTo(const char *destFileName)
			{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
					__parameter_types__[0] = Global::GetType(typeid(destFileName).name());
			...
			mscorlib::System::IO::FileInfo FileInfo::CopyTo(const char *destFileName, mscorlib::System::Boolean overwrite)
			{
					MonoType *__parameter_types__[2];
					void *__parameters__[2];
					__parameter_types__[0] = Global::GetType(typeid(destFileName).name());
			...
			mscorlib::System::IO::FileInfo FileInfo::Replace(mscorlib::System::String destinationFileName, mscorlib::System::String destinationBackupFileName)
			{
					...
					__parameters__[0] = mono_string_new(Global::GetDomain(), destinationFileName);
					__parameters__[1] = mono_string_new(Global::GetDomain(), destinationBackupFileName);
			...
			mscorlib::System::IO::FileInfo FileInfo::Replace(const char *destinationFileName, const char *destinationBackupFileName)
			{
					MonoType *__parameter_types__[2];
					void *__parameters__[2];
					__parameter_types__[0] = Global::GetType(typeid(destinationFileName).name());
			...
			mscorlib::System::IO::FileInfo FileInfo::Replace(const char *destinationFileName, const char *destinationBackupFileName, mscorlib::System::Boolean ignoreMetadataErrors)
			{
					MonoType *__parameter_types__[3];
					void *__parameters__[3];
					__parameter_types__[0] = Global::GetType(typeid(destinationFileName).name());
			...
			//	Get:Exists
			mscorlib::System::Boolean  FileInfo::get_Exists() const
			{
			...
			//	Get:Name
			mscorlib::System::String  FileInfo::get_Name() const
			{
			...
			//	Get/Set:IsReadOnly
			mscorlib::System::Boolean  FileInfo::get_IsReadOnly() const
			{
			...
			//	Get:Length
			mscorlib::System::Int64  FileInfo::get_Length() const
			{
			...
			//	Get:DirectoryName
			mscorlib::System::String  FileInfo::get_DirectoryName() const
			{
			...
			//	Get:Directory
			mscorlib::System::IO::DirectoryInfo  FileInfo::get_Directory() const
			{
			...
			//	Get:FullName
			mscorlib::System::String  FileInfo::get_FullName() const
			{
			...
			//	Get:Extension
			mscorlib::System::String  FileInfo::get_Extension() const
			{
			...
			//	Get/Set:Attributes
			mscorlib::System::IO::FileAttributes::__ENUM__  FileInfo::get_Attributes() const
			{
			...
			mscorlib::System::DateTime  FileInfo::get_CreationTime() const
			{
			...
			mscorlib::System::DateTime  FileInfo::get_CreationTimeUtc() const
			{
			...
			mscorlib::System::DateTime  FileInfo::get_LastAccessTime() const
			{
			...
			mscorlib::System::DateTime  FileInfo::get_LastAccessTimeUtc() const
			{
			...
			mscorlib::System::DateTime  FileInfo::get_LastWriteTime() const
			{
			...
			mscorlib::System::DateTime  FileInfo::get_LastWriteTimeUtc() const
			{
