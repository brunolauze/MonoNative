...
namespace mscorlib
{
	namespace System
	{
		namespace IO
		{
			...
			//	Get:InnerException
			mscorlib::System::Exception  IOException::get_InnerException() const
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  IOException::get_HelpLink() const
			{
			...
			void IOException::set_HelpLink(mscorlib::System::String  value)
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  IOException::get_HResult() const
			{
			...
			void IOException::set_HResult(mscorlib::System::Int32  value)
			{
				MonoType *__parameter_types__[1];
				void *__parameters__[1];
				__parameter_types__[0] = Global::GetType(typeid(value).name());
			...
			//	Get:Message
			mscorlib::System::String  IOException::get_Message() const
			{
			...
			//	Get:StackTrace
			mscorlib::System::String  IOException::get_StackTrace() const
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  IOException::get_TargetSite() const
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  IOException::get_Data() const
			{
