...
namespace mscorlib
{
	namespace System
	{
		namespace IO
		{
			...
			//	Get:InnerException
			mscorlib::System::Exception  IOException::get_InnerException()
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  IOException::get_HelpLink()
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  IOException::get_HResult()
			{
			...
			//	Get:Message
			mscorlib::System::String  IOException::get_Message()
			{
			...
			//	Get/Set:Source
			mscorlib::System::String  IOException::get_Source()
			{
			...
			//	Get:StackTrace
			mscorlib::System::String  IOException::get_StackTrace()
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  IOException::get_TargetSite()
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  IOException::get_Data()
			{
