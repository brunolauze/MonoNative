...
namespace mscorlib
{
	namespace System
	{
		namespace IO
		{
			...
			//	Get:InnerException
			mscorlib::System::Exception  PathTooLongException::get_InnerException()
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  PathTooLongException::get_HelpLink()
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  PathTooLongException::get_HResult()
			{
			...
			//	Get:Message
			mscorlib::System::String  PathTooLongException::get_Message()
			{
			...
			//	Get/Set:Source
			mscorlib::System::String  PathTooLongException::get_Source()
			{
			...
			//	Get:StackTrace
			mscorlib::System::String  PathTooLongException::get_StackTrace()
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  PathTooLongException::get_TargetSite()
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  PathTooLongException::get_Data()
			{
