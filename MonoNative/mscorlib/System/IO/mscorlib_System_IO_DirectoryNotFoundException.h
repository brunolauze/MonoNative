#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_IO_DIRECTORYNOTFOUNDEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_IO_DIRECTORYNOTFOUNDEXCEPTION_H
	...
	namespace System
	{
		namespace IO
		{
			...
			public:
				...
				: mscorlib::System::IO::IOException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.IO.DirectoryNotFoundException"))
				, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					__native_object__ = Global::New("mscorlib", "System.IO", "DirectoryNotFoundException");
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.IO", "DirectoryNotFoundException", 1, __parameter_types__, __parameters__);
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.IO", "DirectoryNotFoundException", 2, __parameter_types__, __parameters__);
				};
			
				DirectoryNotFoundException(mscorlib::NativeTypeInfo *nativeTypeInfo)
				...
				DirectoryNotFoundException(MonoObject *nativeObject)
				...
				DirectoryNotFoundException & operator=(DirectoryNotFoundException &value) { __native_object__ = value.GetNativeObject(); return value; };
				bool operator==(DirectoryNotFoundException &value) { return mscorlib::System::Object::Equals(value); };
