#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_IO_IOEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_IO_IOEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		namespace IO
		{
			...
			public:
				IOException()
				: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.IO.IOException"))
				, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					__native_object__ = Global::New("mscorlib", "System.IO", "IOException");
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.IO", "IOException", 1, __parameter_types__, __parameters__);
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.IO", "IOException", 2, __parameter_types__, __parameters__);
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__parameters__[0] = (MonoObject*)message;
					__parameters__[1] = &hresult;
					__native_object__ = Global::New("mscorlib", "System.IO", "IOException", 2, __parameter_types__, __parameters__);
				};
			
				IOException(mscorlib::NativeTypeInfo *nativeTypeInfo)
				...
				IOException(MonoObject *nativeObject)
				...
				IOException & operator=(IOException &value) { __native_object__ = value.GetNativeObject(); return value; };
				bool operator==(IOException &value) { return mscorlib::System::Object::Equals(value); };
