...
namespace mscorlib
{
	namespace System
	{
		namespace IO
		{
			...
			//	Get:Message
			mscorlib::System::String  FileLoadException::get_Message()
			{
			...
			//	Get:FileName
			mscorlib::System::String  FileLoadException::get_FileName()
			{
			...
			//	Get:FusionLog
			mscorlib::System::String  FileLoadException::get_FusionLog()
			{
			...
			//	Get:InnerException
			mscorlib::System::Exception  FileLoadException::get_InnerException()
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  FileLoadException::get_HelpLink()
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  FileLoadException::get_HResult()
			{
			...
			//	Get/Set:Source
			mscorlib::System::String  FileLoadException::get_Source()
			{
			...
			//	Get:StackTrace
			mscorlib::System::String  FileLoadException::get_StackTrace()
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  FileLoadException::get_TargetSite()
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  FileLoadException::get_Data()
			{
