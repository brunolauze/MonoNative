...
namespace mscorlib
{
	namespace System
	{
		namespace IO
		{
			...
			//	Get:FileName
			mscorlib::System::String  FileNotFoundException::get_FileName() const
			{
			...
			//	Get:FusionLog
			mscorlib::System::String  FileNotFoundException::get_FusionLog() const
			{
			...
			//	Get:Message
			mscorlib::System::String  FileNotFoundException::get_Message() const
			{
			...
			//	Get:InnerException
			mscorlib::System::Exception  FileNotFoundException::get_InnerException() const
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  FileNotFoundException::get_HelpLink() const
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  FileNotFoundException::get_HResult() const
			{
			...
			//	Get/Set:Source
			mscorlib::System::String  FileNotFoundException::get_Source() const
			{
			...
			//	Get:StackTrace
			mscorlib::System::String  FileNotFoundException::get_StackTrace() const
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  FileNotFoundException::get_TargetSite() const
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  FileNotFoundException::get_Data() const
			{
