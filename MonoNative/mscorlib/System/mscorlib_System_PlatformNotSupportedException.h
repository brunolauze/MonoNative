#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_PLATFORMNOTSUPPORTEDEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_PLATFORMNOTSUPPORTEDEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		class PlatformNotSupportedException
			: public mscorlib::System::NotSupportedException
			, public virtual mscorlib::System::Runtime::InteropServices::_Exception
			, public virtual mscorlib::System::Runtime::Serialization::ISerializable
		{
		public:
			PlatformNotSupportedException()
			: mscorlib::System::NotSupportedException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.PlatformNotSupportedException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "PlatformNotSupportedException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "PlatformNotSupportedException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "PlatformNotSupportedException", 2, __parameter_types__, __parameters__);
			};
		
			PlatformNotSupportedException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			: mscorlib::System::NotSupportedException(nativeTypeInfo)
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
			};
		
			PlatformNotSupportedException(MonoObject *nativeObject)
			: mscorlib::System::NotSupportedException(nativeObject)
			...
			PlatformNotSupportedException & operator=(PlatformNotSupportedException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(PlatformNotSupportedException &value) { return mscorlib::System::Object::Equals(value); };
