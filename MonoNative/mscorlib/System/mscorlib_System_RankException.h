#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_RANKEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_RANKEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			RankException()
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.RankException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "RankException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "RankException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "RankException", 2, __parameter_types__, __parameters__);
			};
		
			RankException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			RankException(MonoObject *nativeObject)
			...
			RankException & operator=(RankException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(RankException &value) { return mscorlib::System::Object::Equals(value); };
