...
namespace mscorlib
{
	namespace System
	{
		...
		//	Get:InnerException
		mscorlib::System::Exception  Exception::get_InnerException()
		{
		...
		//	Get/Set:HelpLink
		mscorlib::System::String  Exception::get_HelpLink()
		{
		...
		//	Get/Set:HResult
		mscorlib::System::Int32  Exception::get_HResult()
		{
		...
		//	Get:Message
		mscorlib::System::String  Exception::get_Message()
		{
		...
		//	Get/Set:Source
		mscorlib::System::String  Exception::get_Source()
		{
		...
		//	Get:StackTrace
		mscorlib::System::String  Exception::get_StackTrace()
		{
		...
		//	Get:TargetSite
		mscorlib::System::Reflection::MethodBase  Exception::get_TargetSite()
		{
		...
		//	Get:Data
		mscorlib::System::Collections::IDictionary  Exception::get_Data()
		{
