...
namespace mscorlib
{
	namespace System
	{
		...
		//	Get:InnerException
		mscorlib::System::Exception  RankException::get_InnerException() const
		{
		...
		//	Get/Set:HelpLink
		mscorlib::System::String  RankException::get_HelpLink() const
		{
		...
		void RankException::set_HelpLink(mscorlib::System::String  value)
		{
		...
		//	Get/Set:HResult
		mscorlib::System::Int32  RankException::get_HResult() const
		{
		...
		void RankException::set_HResult(mscorlib::System::Int32  value)
		{
			MonoType *__parameter_types__[1];
			void *__parameters__[1];
			__parameter_types__[0] = Global::GetType(typeid(value).name());
		...
		//	Get:Message
		mscorlib::System::String  RankException::get_Message() const
		{
		...
		//	Get:StackTrace
		mscorlib::System::String  RankException::get_StackTrace() const
		{
		...
		//	Get:TargetSite
		mscorlib::System::Reflection::MethodBase  RankException::get_TargetSite() const
		{
		...
		//	Get:Data
		mscorlib::System::Collections::IDictionary  RankException::get_Data() const
		{
