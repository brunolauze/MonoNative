#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_INVALIDOPERATIONEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_INVALIDOPERATIONEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.InvalidOperationException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "InvalidOperationException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "InvalidOperationException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "InvalidOperationException", 2, __parameter_types__, __parameters__);
			};
		
			InvalidOperationException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			InvalidOperationException(MonoObject *nativeObject)
			...
			InvalidOperationException & operator=(InvalidOperationException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(InvalidOperationException &value) { return mscorlib::System::Object::Equals(value); };
