...
namespace mscorlib
{
	namespace System
	{
		...
		//	Get:ParamName
		mscorlib::System::String  DuplicateWaitObjectException::get_ParamName() const
		{
		...
		//	Get:Message
		mscorlib::System::String  DuplicateWaitObjectException::get_Message() const
		{
		...
		//	Get:InnerException
		mscorlib::System::Exception  DuplicateWaitObjectException::get_InnerException() const
		{
		...
		//	Get/Set:HelpLink
		mscorlib::System::String  DuplicateWaitObjectException::get_HelpLink() const
		{
		...
		void DuplicateWaitObjectException::set_HelpLink(mscorlib::System::String  value)
		{
		...
		//	Get/Set:HResult
		mscorlib::System::Int32  DuplicateWaitObjectException::get_HResult() const
		{
		...
		void DuplicateWaitObjectException::set_HResult(mscorlib::System::Int32  value)
		{
			MonoType *__parameter_types__[1];
			void *__parameters__[1];
			__parameter_types__[0] = Global::GetType(typeid(value).name());
		...
		//	Get/Set:Source
		mscorlib::System::String  DuplicateWaitObjectException::get_Source() const
		{
			MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System", "Exception", 0, NULL, "get_Source", __native_object__, 0, NULL, NULL, NULL);
			return mscorlib::System::String(__result__);
		}

		void DuplicateWaitObjectException::set_Source(mscorlib::System::String  value)
		{
			MonoType *__parameter_types__[1];
			void *__parameters__[1];
			__parameter_types__[0] = Global::GetType(typeid(value).name());
		...
		//	Get:StackTrace
		mscorlib::System::String  DuplicateWaitObjectException::get_StackTrace() const
		{
		...
		//	Get:TargetSite
		mscorlib::System::Reflection::MethodBase  DuplicateWaitObjectException::get_TargetSite() const
		{
		...
		//	Get:Data
		mscorlib::System::Collections::IDictionary  DuplicateWaitObjectException::get_Data() const
		{
