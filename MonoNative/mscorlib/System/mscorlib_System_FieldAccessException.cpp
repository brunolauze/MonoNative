...
namespace mscorlib
{
	namespace System
	{
		...
		//	Get:InnerException
		mscorlib::System::Exception  FieldAccessException::get_InnerException()
		{
		...
		//	Get/Set:HelpLink
		mscorlib::System::String  FieldAccessException::get_HelpLink()
		{
		...
		//	Get/Set:HResult
		mscorlib::System::Int32  FieldAccessException::get_HResult()
		{
		...
		//	Get:Message
		mscorlib::System::String  FieldAccessException::get_Message()
		{
		...
		//	Get/Set:Source
		mscorlib::System::String  FieldAccessException::get_Source()
		{
		...
		//	Get:StackTrace
		mscorlib::System::String  FieldAccessException::get_StackTrace()
		{
		...
		//	Get:TargetSite
		mscorlib::System::Reflection::MethodBase  FieldAccessException::get_TargetSite()
		{
		...
		//	Get:Data
		mscorlib::System::Collections::IDictionary  FieldAccessException::get_Data()
		{
