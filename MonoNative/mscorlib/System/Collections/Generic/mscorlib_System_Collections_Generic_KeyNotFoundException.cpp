	...
	namespace System
	{
		namespace Collections
		{
			namespace Generic
			{
				...
				//	Get:InnerException
				mscorlib::System::Exception  KeyNotFoundException::get_InnerException()
				{
				...
				//	Get/Set:HelpLink
				mscorlib::System::String  KeyNotFoundException::get_HelpLink()
				{
				...
				//	Get/Set:HResult
				mscorlib::System::Int32  KeyNotFoundException::get_HResult()
				{
				...
				//	Get:Message
				mscorlib::System::String  KeyNotFoundException::get_Message()
				{
				...
				//	Get/Set:Source
				mscorlib::System::String  KeyNotFoundException::get_Source()
				{
				...
				//	Get:StackTrace
				mscorlib::System::String  KeyNotFoundException::get_StackTrace()
				{
				...
				//	Get:TargetSite
				mscorlib::System::Reflection::MethodBase  KeyNotFoundException::get_TargetSite()
				{
				...
				//	Get:Data
				mscorlib::System::Collections::IDictionary  KeyNotFoundException::get_Data()
				{
