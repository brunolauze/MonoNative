#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_COLLECTIONS_GENERIC_KEYNOTFOUNDEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_COLLECTIONS_GENERIC_KEYNOTFOUNDEXCEPTION_H
		...
		namespace Collections
		{
			namespace Generic
			{
				...
				public:
					...
					: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Collections.Generic.KeyNotFoundException"))
					, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						__native_object__ = Global::New("mscorlib", "System.Collections.Generic", "KeyNotFoundException");
					};
					...
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Collections.Generic", "KeyNotFoundException", 1, __parameter_types__, __parameters__);
					};
					...
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Collections.Generic", "KeyNotFoundException", 2, __parameter_types__, __parameters__);
					};
				
					KeyNotFoundException(mscorlib::NativeTypeInfo *nativeTypeInfo)
					...
					KeyNotFoundException(MonoObject *nativeObject)
					...
					KeyNotFoundException & operator=(KeyNotFoundException &value) { __native_object__ = value.GetNativeObject(); return value; };
					bool operator==(KeyNotFoundException &value) { return mscorlib::System::Object::Equals(value); };
