...
namespace mscorlib
{
	namespace System
	{
		...
		mscorlib::System::Threading::CancellationToken  OperationCanceledException::get_CancellationToken()
		{
		...
		//	Get:InnerException
		mscorlib::System::Exception  OperationCanceledException::get_InnerException()
		{
		...
		//	Get/Set:HelpLink
		mscorlib::System::String  OperationCanceledException::get_HelpLink()
		{
		...
		//	Get/Set:HResult
		mscorlib::System::Int32  OperationCanceledException::get_HResult()
		{
		...
		//	Get:Message
		mscorlib::System::String  OperationCanceledException::get_Message()
		{
		...
		//	Get/Set:Source
		mscorlib::System::String  OperationCanceledException::get_Source()
		{
		...
		//	Get:StackTrace
		mscorlib::System::String  OperationCanceledException::get_StackTrace()
		{
		...
		//	Get:TargetSite
		mscorlib::System::Reflection::MethodBase  OperationCanceledException::get_TargetSite()
		{
		...
		//	Get:Data
		mscorlib::System::Collections::IDictionary  OperationCanceledException::get_Data()
		{
