#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_ARGUMENTNULLEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_ARGUMENTNULLEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::ArgumentException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.ArgumentNullException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "ArgumentNullException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "ArgumentNullException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "ArgumentNullException", 2, __parameter_types__, __parameters__);
			};
			...
			ArgumentNullException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			ArgumentNullException(MonoObject *nativeObject)
			...
			ArgumentNullException & operator=(ArgumentNullException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(ArgumentNullException &value) { return mscorlib::System::Object::Equals(value); };
