#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_ARGUMENTEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_ARGUMENTEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			ArgumentException()
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.ArgumentException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "ArgumentException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "ArgumentException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "ArgumentException", 2, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__parameters__[0] = (MonoObject*)message;
				__parameters__[1] = (MonoObject*)paramName;
				__native_object__ = Global::New("mscorlib", "System", "ArgumentException", 2, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "ArgumentException", 3, __parameter_types__, __parameters__);
			};
		
			ArgumentException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			ArgumentException(MonoObject *nativeObject)
			...
			ArgumentException & operator=(ArgumentException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(ArgumentException &value) { return mscorlib::System::Object::Equals(value); };
