...
namespace mscorlib
{
	namespace System
	{
		...
		//	Get/Set:Cancel
		mscorlib::System::Boolean  ConsoleCancelEventArgs::get_Cancel() const
		{
		...
		mscorlib::System::ConsoleSpecialKey::__ENUM__  ConsoleCancelEventArgs::get_SpecialKey() const
		{
			...
			return static_cast<mscorlib::System::ConsoleSpecialKey::__ENUM__>(*(mscorlib::System::Int32*)mono_object_unbox(__result__));
		}
