#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_NULLREFERENCEEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_NULLREFERENCEEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.NullReferenceException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "NullReferenceException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "NullReferenceException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "NullReferenceException", 2, __parameter_types__, __parameters__);
			};
		
			NullReferenceException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			NullReferenceException(MonoObject *nativeObject)
			...
			NullReferenceException & operator=(NullReferenceException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(NullReferenceException &value) { return mscorlib::System::Object::Equals(value); };
