#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_TIMEZONENOTFOUNDEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_TIMEZONENOTFOUNDEXCEPTION_H
	...
	namespace System
	{
		...
		public:
			...
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "TimeZoneNotFoundException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "TimeZoneNotFoundException", 2, __parameter_types__, __parameters__);
			};
