...
namespace mscorlib
{
	namespace System
	{
		namespace Resources
		{
			...
			//	Get:CultureName
			mscorlib::System::String  MissingSatelliteAssemblyException::get_CultureName()
			{
			...
			//	Get:InnerException
			mscorlib::System::Exception  MissingSatelliteAssemblyException::get_InnerException()
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  MissingSatelliteAssemblyException::get_HelpLink()
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  MissingSatelliteAssemblyException::get_HResult()
			{
			...
			//	Get:Message
			mscorlib::System::String  MissingSatelliteAssemblyException::get_Message()
			{
			...
			//	Get/Set:Source
			mscorlib::System::String  MissingSatelliteAssemblyException::get_Source()
			{
			...
			//	Get:StackTrace
			mscorlib::System::String  MissingSatelliteAssemblyException::get_StackTrace()
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  MissingSatelliteAssemblyException::get_TargetSite()
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  MissingSatelliteAssemblyException::get_Data()
			{
