#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_RESOURCES_MISSINGSATELLITEASSEMBLYEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_RESOURCES_MISSINGSATELLITEASSEMBLYEXCEPTION_H
	...
	namespace System
	{
		namespace Resources
		{
			...
			public:
				...
				: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Resources.MissingSatelliteAssemblyException"))
				, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					__native_object__ = Global::New("mscorlib", "System.Resources", "MissingSatelliteAssemblyException");
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.Resources", "MissingSatelliteAssemblyException", 1, __parameter_types__, __parameters__);
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__parameters__[0] = (MonoObject*)message;
					__parameters__[1] = (MonoObject*)cultureName;
					__native_object__ = Global::New("mscorlib", "System.Resources", "MissingSatelliteAssemblyException", 2, __parameter_types__, __parameters__);
				};
				...
				MissingSatelliteAssemblyException(mscorlib::NativeTypeInfo *nativeTypeInfo)
				...
				MissingSatelliteAssemblyException(MonoObject *nativeObject)
				...
				MissingSatelliteAssemblyException & operator=(MissingSatelliteAssemblyException &value) { __native_object__ = value.GetNativeObject(); return value; };
				bool operator==(MissingSatelliteAssemblyException &value) { return mscorlib::System::Object::Equals(value); };
