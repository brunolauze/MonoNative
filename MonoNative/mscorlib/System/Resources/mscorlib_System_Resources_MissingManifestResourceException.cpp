...
namespace mscorlib
{
	namespace System
	{
		namespace Resources
		{
			...
			//	Get:InnerException
			mscorlib::System::Exception  MissingManifestResourceException::get_InnerException()
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  MissingManifestResourceException::get_HelpLink()
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  MissingManifestResourceException::get_HResult()
			{
			...
			//	Get:Message
			mscorlib::System::String  MissingManifestResourceException::get_Message()
			{
			...
			//	Get/Set:Source
			mscorlib::System::String  MissingManifestResourceException::get_Source()
			{
			...
			//	Get:StackTrace
			mscorlib::System::String  MissingManifestResourceException::get_StackTrace()
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  MissingManifestResourceException::get_TargetSite()
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  MissingManifestResourceException::get_Data()
			{
