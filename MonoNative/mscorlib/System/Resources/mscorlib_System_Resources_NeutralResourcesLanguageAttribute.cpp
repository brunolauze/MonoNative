...
namespace mscorlib
{
	namespace System
	{
		namespace Resources
		{
			...
			//	Get:CultureName
			mscorlib::System::String  NeutralResourcesLanguageAttribute::get_CultureName()
			{
			...
			//	Get:Location
			mscorlib::System::Resources::UltimateResourceFallbackLocation::__ENUM__  NeutralResourcesLanguageAttribute::get_Location()
			{
				...
				return *(mscorlib::System::Resources::UltimateResourceFallbackLocation::__ENUM__*)mono_object_unbox(__result__);
			}


			//	Get:TypeId
			mscorlib::System::Object  NeutralResourcesLanguageAttribute::get_TypeId()
			{
