...
namespace mscorlib
{
	namespace System
	{
		namespace Reflection
		{
			...
			//	Get:InnerException
			mscorlib::System::Exception  CustomAttributeFormatException::get_InnerException()
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  CustomAttributeFormatException::get_HelpLink()
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  CustomAttributeFormatException::get_HResult()
			{
			...
			//	Get:Message
			mscorlib::System::String  CustomAttributeFormatException::get_Message()
			{
			...
			//	Get/Set:Source
			mscorlib::System::String  CustomAttributeFormatException::get_Source()
			{
			...
			//	Get:StackTrace
			mscorlib::System::String  CustomAttributeFormatException::get_StackTrace()
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  CustomAttributeFormatException::get_TargetSite()
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  CustomAttributeFormatException::get_Data()
			{
