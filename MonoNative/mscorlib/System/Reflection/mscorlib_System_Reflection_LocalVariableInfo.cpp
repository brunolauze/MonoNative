...
namespace mscorlib
{
	namespace System
	{
		namespace Reflection
		{
			...
			//	Get:IsPinned
			mscorlib::System::Boolean  LocalVariableInfo::get_IsPinned()
			{
			...
			//	Get:LocalIndex
			mscorlib::System::Int32  LocalVariableInfo::get_LocalIndex()
			{
			...
			//	Get:LocalType
			mscorlib::System::Type  LocalVariableInfo::get_LocalType()
			{
