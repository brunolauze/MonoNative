...
namespace mscorlib
{
	namespace System
	{
		namespace Reflection
		{
			...
			//	Get:InnerException
			mscorlib::System::Exception  TargetException::get_InnerException() const
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  TargetException::get_HelpLink() const
			{
			...
			void TargetException::set_HelpLink(mscorlib::System::String  value)
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  TargetException::get_HResult() const
			{
			...
			void TargetException::set_HResult(mscorlib::System::Int32  value)
			{
				MonoType *__parameter_types__[1];
				void *__parameters__[1];
				__parameter_types__[0] = Global::GetType(typeid(value).name());
			...
			//	Get:Message
			mscorlib::System::String  TargetException::get_Message() const
			{
			...
			//	Get:StackTrace
			mscorlib::System::String  TargetException::get_StackTrace() const
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  TargetException::get_TargetSite() const
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  TargetException::get_Data() const
			{
