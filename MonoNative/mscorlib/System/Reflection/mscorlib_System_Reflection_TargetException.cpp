...
namespace mscorlib
{
	namespace System
	{
		namespace Reflection
		{
			...
			//	Get:InnerException
			mscorlib::System::Exception  TargetException::get_InnerException()
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  TargetException::get_HelpLink()
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  TargetException::get_HResult()
			{
			...
			//	Get:Message
			mscorlib::System::String  TargetException::get_Message()
			{
			...
			//	Get/Set:Source
			mscorlib::System::String  TargetException::get_Source()
			{
			...
			//	Get:StackTrace
			mscorlib::System::String  TargetException::get_StackTrace()
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  TargetException::get_TargetSite()
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  TargetException::get_Data()
			{
