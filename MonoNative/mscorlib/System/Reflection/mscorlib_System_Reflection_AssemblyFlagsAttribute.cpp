...
namespace mscorlib
{
	namespace System
	{
		namespace Reflection
		{
			...
			//	Get:Flags
			mscorlib::System::UInt32  AssemblyFlagsAttribute::get_Flags() const
			{
			...
			//	Get:AssemblyFlags
			mscorlib::System::Int32  AssemblyFlagsAttribute::get_AssemblyFlags() const
			{
			...
			//	Get:TypeId
			mscorlib::System::Object  AssemblyFlagsAttribute::get_TypeId() const
			{
