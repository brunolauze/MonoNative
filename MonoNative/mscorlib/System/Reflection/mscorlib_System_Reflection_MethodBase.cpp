...
namespace mscorlib
{
	namespace System
	{
		namespace Reflection
		{
			...
			//	Get:MethodHandle
			mscorlib::System::RuntimeMethodHandle  MethodBase::get_MethodHandle()
			{
			...
			//	Get:Attributes
			mscorlib::System::Reflection::MethodAttributes::__ENUM__  MethodBase::get_Attributes()
			{
			...
			mscorlib::System::Reflection::CallingConventions::__ENUM__  MethodBase::get_CallingConvention()
			{
			...
			//	Get:IsPublic
			mscorlib::System::Boolean  MethodBase::get_IsPublic()
			{
			...
			//	Get:IsPrivate
			mscorlib::System::Boolean  MethodBase::get_IsPrivate()
			{
			...
			//	Get:IsFamily
			mscorlib::System::Boolean  MethodBase::get_IsFamily()
			{
			...
			//	Get:IsAssembly
			mscorlib::System::Boolean  MethodBase::get_IsAssembly()
			{
			...
			mscorlib::System::Boolean  MethodBase::get_IsFamilyAndAssembly()
			{
			...
			mscorlib::System::Boolean  MethodBase::get_IsFamilyOrAssembly()
			{
			...
			//	Get:IsStatic
			mscorlib::System::Boolean  MethodBase::get_IsStatic()
			{
			...
			//	Get:IsFinal
			mscorlib::System::Boolean  MethodBase::get_IsFinal()
			{
			...
			//	Get:IsVirtual
			mscorlib::System::Boolean  MethodBase::get_IsVirtual()
			{
			...
			//	Get:IsHideBySig
			mscorlib::System::Boolean  MethodBase::get_IsHideBySig()
			{
			...
			//	Get:IsAbstract
			mscorlib::System::Boolean  MethodBase::get_IsAbstract()
			{
			...
			//	Get:IsSpecialName
			mscorlib::System::Boolean  MethodBase::get_IsSpecialName()
			{
			...
			//	Get:IsConstructor
			mscorlib::System::Boolean  MethodBase::get_IsConstructor()
			{
			...
			mscorlib::System::Boolean  MethodBase::get_ContainsGenericParameters()
			{
			...
			mscorlib::System::Boolean  MethodBase::get_IsGenericMethodDefinition()
			{
			...
			//	Get:IsGenericMethod
			mscorlib::System::Boolean  MethodBase::get_IsGenericMethod()
			{
			...
			mscorlib::System::Boolean  MethodBase::get_IsSecurityCritical()
			{
			...
			mscorlib::System::Boolean  MethodBase::get_IsSecuritySafeCritical()
			{
			...
			mscorlib::System::Boolean  MethodBase::get_IsSecurityTransparent()
			{
			...
			mscorlib::System::Reflection::MethodImplAttributes::__ENUM__  MethodBase::get_MethodImplementationFlags()
			{
			...
			//	Get:DeclaringType
			mscorlib::System::Type  MethodBase::get_DeclaringType()
			{
			...
			//	Get:MemberType
			mscorlib::System::Reflection::MemberTypes::__ENUM__  MethodBase::get_MemberType()
			{
			...
			//	Get:Name
			mscorlib::System::String  MethodBase::get_Name()
			{
			...
			//	Get:ReflectedType
			mscorlib::System::Type  MethodBase::get_ReflectedType()
			{
			...
			//	Get:Module
			mscorlib::System::Reflection::Module  MethodBase::get_Module()
			{
			...
			//	Get:MetadataToken
			mscorlib::System::Int32  MethodBase::get_MetadataToken()
			{
			...
			mscorlib::System::Collections::Generic::IEnumerable<mscorlib::System::Reflection::CustomAttributeData>  MethodBase::get_CustomAttributes()
			{
