		...
		namespace Reflection
		{
			namespace Emit
			{
				...
				mscorlib::System::Reflection::Emit::MethodBuilder ModuleBuilder::DefineGlobalMethod(mscorlib::System::String name, mscorlib::System::Reflection::MethodAttributes::__ENUM__ attributes, mscorlib::System::Reflection::CallingConventions::__ENUM__ callingConvention, mscorlib::System::Type returnType, std::vector<mscorlib::System::Type*> requiredReturnTypeCustomModifiers, std::vector<mscorlib::System::Type*> optionalReturnTypeCustomModifiers, std::vector<mscorlib::System::Type*> parameterTypes, std::vector<mscorlib::System::Type**> requiredParameterTypeCustomModifiers, std::vector<mscorlib::System::Type**> optionalParameterTypeCustomModifiers)
				{
						...
						__parameter_types__[2] = Global::GetType(typeid(callingConvention).name());
						__parameter_types__[3] = Global::GetType(typeid(returnType).name());
						__parameter_types__[4] = mono_class_get_type(mono_type_get_array_type(Global::GetType(typeid(requiredReturnTypeCustomModifiers).name()))->eklass);
						__parameter_types__[5] = mono_class_get_type(mono_type_get_array_type(Global::GetType(typeid(optionalReturnTypeCustomModifiers).name()))->eklass);
						__parameter_types__[6] = mono_class_get_type(mono_type_get_array_type(Global::GetType(typeid(parameterTypes).name()))->eklass);
						__parameter_types__[7] = mono_class_get_type(mono_type_get_array_type(Global::GetType(typeid(requiredParameterTypeCustomModifiers).name()))->eklass);
						__parameter_types__[8] = mono_class_get_type(mono_type_get_array_type(Global::GetType(typeid(optionalParameterTypeCustomModifiers).name()))->eklass);
						__parameters__[0] = (MonoObject*)name;
						__parameters__[1] = reinterpret_cast<void*>(attributes);
						__parameters__[2] = reinterpret_cast<void*>(callingConvention);
						__parameters__[3] = (MonoObject*)returnType;
				...
				mscorlib::System::Reflection::Emit::TypeBuilder ModuleBuilder::DefineType(mscorlib::System::String name, mscorlib::System::Reflection::TypeAttributes::__ENUM__ attr, mscorlib::System::Type parent, mscorlib::System::Reflection::Emit::PackingSize::__ENUM__ packingSize, mscorlib::System::Int32 typesize)
				{
						...
						__parameters__[1] = reinterpret_cast<void*>(attr);
						__parameters__[2] = (MonoObject*)parent;
						__parameters__[3] = reinterpret_cast<void*>(packingSize);
				...
				mscorlib::System::Reflection::Emit::EnumBuilder ModuleBuilder::DefineEnum(mscorlib::System::String name, mscorlib::System::Reflection::TypeAttributes::__ENUM__ visibility, mscorlib::System::Type underlyingType)
				{
						...
						__parameters__[0] = (MonoObject*)name;
						__parameters__[1] = reinterpret_cast<void*>(visibility);
				...
				mscorlib::System::Reflection::Emit::SignatureToken ModuleBuilder::GetSignatureToken(std::vector<mscorlib::System::Byte*> sigBytes, mscorlib::System::Int32 sigLength)
				{
						MonoType *__parameter_types__[2];
						void *__parameters__[2];
						__parameter_types__[0] = mono_class_get_type(mono_type_get_array_type(Global::GetType(typeid(sigBytes).name()))->eklass);
				...
				mscorlib::System::Reflection::FieldInfo ModuleBuilder::ResolveField(mscorlib::System::Int32 metadataToken, std::vector<mscorlib::System::Type*> genericTypeArguments, std::vector<mscorlib::System::Type*> genericMethodArguments)
				{
						...
						__parameter_types__[1] = mono_class_get_type(mono_type_get_array_type(Global::GetType(typeid(genericTypeArguments).name()))->eklass);
						__parameter_types__[2] = mono_class_get_type(mono_type_get_array_type(Global::GetType(typeid(genericMethodArguments).name()))->eklass);
				...
				std::vector<mscorlib::System::Reflection::FieldInfo*> ModuleBuilder::GetFields(mscorlib::System::Reflection::BindingFlags::__ENUM__ bindingFlags)
				{
						...
						__parameters__[0] = reinterpret_cast<void*>(bindingFlags);
				...
				mscorlib::System::String  ModuleBuilder::get_FullyQualifiedName()
				{
				...
				//	Get:Assembly
				mscorlib::System::Reflection::Assembly  ModuleBuilder::get_Assembly()
				{
				...
				//	Get:Name
				mscorlib::System::String  ModuleBuilder::get_Name()
				{
				...
				//	Get:ScopeName
				mscorlib::System::String  ModuleBuilder::get_ScopeName()
				{
				...
				//	Get:ModuleVersionId
				mscorlib::System::Guid  ModuleBuilder::get_ModuleVersionId()
				{
				...
				//	Get:MetadataToken
				mscorlib::System::Int32  ModuleBuilder::get_MetadataToken()
				{
				...
				//	Get:ModuleHandle
				mscorlib::System::ModuleHandle  ModuleBuilder::get_ModuleHandle()
				{
				...
				//	Get:MDStreamVersion
				mscorlib::System::Int32  ModuleBuilder::get_MDStreamVersion()
				{
				...
				mscorlib::System::Collections::Generic::IEnumerable<mscorlib::System::Reflection::CustomAttributeData>  ModuleBuilder::get_CustomAttributes()
				{
