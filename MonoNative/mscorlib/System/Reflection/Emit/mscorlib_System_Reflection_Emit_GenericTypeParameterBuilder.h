#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_REFLECTION_EMIT_GENERICTYPEPARAMETERBUILDER_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_REFLECTION_EMIT_GENERICTYPEPARAMETERBUILDER_H
	...
	namespace System
	{
		namespace Reflection
		{
			namespace Emit
			{
				...
				{
				public:
					GenericTypeParameterBuilder(mscorlib::NativeTypeInfo *nativeTypeInfo)
					...
					GenericTypeParameterBuilder(MonoObject *nativeObject)
					...
					GenericTypeParameterBuilder & operator=(GenericTypeParameterBuilder &value) { __native_object__ = value.GetNativeObject(); return value; };
					bool operator==(GenericTypeParameterBuilder &value) { return mscorlib::System::Object::Equals(value); };
					operator MonoObject*() { return __native_object__; };
					MonoObject* operator=(MonoObject* value) { return __native_object__ = value; };


					void  SetBaseTypeConstraint(mscorlib::System::Type baseTypeConstraint);
					void  SetInterfaceConstraints(std::vector<mscorlib::System::Type*> interfaceConstraints);
					void  SetGenericParameterAttributes(mscorlib::System::Reflection::GenericParameterAttributes::__ENUM__ genericParameterAttributes);
					...
					virtual mscorlib::System::Boolean  IsInstanceOfType(mscorlib::System::Object o) override;
					...
					virtual std::vector<mscorlib::System::Type*>  GetGenericParameterConstraints() override;
