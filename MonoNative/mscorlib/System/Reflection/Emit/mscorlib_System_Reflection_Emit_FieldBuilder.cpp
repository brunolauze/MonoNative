	...
	namespace System
	{
		namespace Reflection
		{
			namespace Emit
			{
				...
				//	Get:Attributes
				mscorlib::System::Reflection::FieldAttributes::__ENUM__  FieldBuilder::get_Attributes()
				{
				...
				//	Get:DeclaringType
				mscorlib::System::Type  FieldBuilder::get_DeclaringType()
				{
				...
				//	Get:FieldHandle
				mscorlib::System::RuntimeFieldHandle  FieldBuilder::get_FieldHandle()
				{
				...
				//	Get:FieldType
				mscorlib::System::Type  FieldBuilder::get_FieldType()
				{
				...
				//	Get:Name
				mscorlib::System::String  FieldBuilder::get_Name()
				{
				...
				//	Get:ReflectedType
				mscorlib::System::Type  FieldBuilder::get_ReflectedType()
				{
				...
				//	Get:Module
				mscorlib::System::Reflection::Module  FieldBuilder::get_Module()
				{
				...
				//	Get:MemberType
				mscorlib::System::Reflection::MemberTypes::__ENUM__  FieldBuilder::get_MemberType()
				{
				...
				//	Get:IsLiteral
				mscorlib::System::Boolean  FieldBuilder::get_IsLiteral()
				{
				...
				//	Get:IsStatic
				mscorlib::System::Boolean  FieldBuilder::get_IsStatic()
				{
				...
				//	Get:IsInitOnly
				mscorlib::System::Boolean  FieldBuilder::get_IsInitOnly()
				{
				...
				//	Get:IsPublic
				mscorlib::System::Boolean  FieldBuilder::get_IsPublic()
				{
				...
				//	Get:IsPrivate
				mscorlib::System::Boolean  FieldBuilder::get_IsPrivate()
				{
				...
				//	Get:IsFamily
				mscorlib::System::Boolean  FieldBuilder::get_IsFamily()
				{
				...
				//	Get:IsAssembly
				mscorlib::System::Boolean  FieldBuilder::get_IsAssembly()
				{
				...
				mscorlib::System::Boolean  FieldBuilder::get_IsFamilyAndAssembly()
				{
				...
				mscorlib::System::Boolean  FieldBuilder::get_IsFamilyOrAssembly()
				{
				...
				//	Get:IsPinvokeImpl
				mscorlib::System::Boolean  FieldBuilder::get_IsPinvokeImpl()
				{
				...
				//	Get:IsSpecialName
				mscorlib::System::Boolean  FieldBuilder::get_IsSpecialName()
				{
				...
				//	Get:IsNotSerialized
				mscorlib::System::Boolean  FieldBuilder::get_IsNotSerialized()
				{
				...
				mscorlib::System::Boolean  FieldBuilder::get_IsSecurityCritical()
				{
				...
				mscorlib::System::Boolean  FieldBuilder::get_IsSecuritySafeCritical()
				{
				...
				mscorlib::System::Boolean  FieldBuilder::get_IsSecurityTransparent()
				{
				...
				//	Get:MetadataToken
				mscorlib::System::Int32  FieldBuilder::get_MetadataToken()
				{
				...
				mscorlib::System::Collections::Generic::IEnumerable<mscorlib::System::Reflection::CustomAttributeData>  FieldBuilder::get_CustomAttributes()
				{
