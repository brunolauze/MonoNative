...
namespace mscorlib
{
	namespace System
	{
		namespace Reflection
		{
			...
			//	Get:FileName
			mscorlib::System::String  ManifestResourceInfo::get_FileName()
			{
			...
			mscorlib::System::Reflection::Assembly  ManifestResourceInfo::get_ReferencedAssembly()
			{
			...
			mscorlib::System::Reflection::ResourceLocation::__ENUM__  ManifestResourceInfo::get_ResourceLocation()
			{
				...
				return *(mscorlib::System::Reflection::ResourceLocation::__ENUM__*)mono_object_unbox(__result__);
			}
