...
namespace mscorlib
{
	namespace System
	{
		namespace Reflection
		{
			...
			//	Get:InnerException
			mscorlib::System::Exception  TargetInvocationException::get_InnerException()
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  TargetInvocationException::get_HelpLink()
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  TargetInvocationException::get_HResult()
			{
			...
			//	Get:Message
			mscorlib::System::String  TargetInvocationException::get_Message()
			{
			...
			//	Get/Set:Source
			mscorlib::System::String  TargetInvocationException::get_Source()
			{
			...
			//	Get:StackTrace
			mscorlib::System::String  TargetInvocationException::get_StackTrace()
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  TargetInvocationException::get_TargetSite()
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  TargetInvocationException::get_Data()
			{
