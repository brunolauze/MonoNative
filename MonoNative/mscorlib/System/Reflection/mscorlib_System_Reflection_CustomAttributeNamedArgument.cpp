...
namespace mscorlib
{
	namespace System
	{
		namespace Reflection
		{
			...
			//	Get:MemberInfo
			mscorlib::System::Reflection::MemberInfo  CustomAttributeNamedArgument::get_MemberInfo()
			{
			...
			//	Get:TypedValue
			mscorlib::System::Reflection::CustomAttributeTypedArgument  CustomAttributeNamedArgument::get_TypedValue()
			{
			...
			//	Get:IsField
			mscorlib::System::Boolean  CustomAttributeNamedArgument::get_IsField()
			{
			...
			//	Get:MemberName
			mscorlib::System::String  CustomAttributeNamedArgument::get_MemberName()
			{
