#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_REFLECTION_AMBIGUOUSMATCHEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_REFLECTION_AMBIGUOUSMATCHEXCEPTION_H
	...
	namespace System
	{
		namespace Reflection
		{
			...
			public:
				...
				: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Reflection.AmbiguousMatchException"))
				, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					__native_object__ = Global::New("mscorlib", "System.Reflection", "AmbiguousMatchException");
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.Reflection", "AmbiguousMatchException", 1, __parameter_types__, __parameters__);
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.Reflection", "AmbiguousMatchException", 2, __parameter_types__, __parameters__);
				};
			
				AmbiguousMatchException(mscorlib::NativeTypeInfo *nativeTypeInfo)
				...
				AmbiguousMatchException(MonoObject *nativeObject)
				...
				AmbiguousMatchException & operator=(AmbiguousMatchException &value) { __native_object__ = value.GetNativeObject(); return value; };
				bool operator==(AmbiguousMatchException &value) { return mscorlib::System::Object::Equals(value); };
