...
namespace mscorlib
{
	namespace System
	{
		namespace Reflection
		{
			...
			//	Get/Set:Key
			mscorlib::System::String  AssemblyMetadataAttribute::get_Key()
			{
			...
			//	Get/Set:Value
			mscorlib::System::String  AssemblyMetadataAttribute::get_Value()
			{
			...
			//	Get:TypeId
			mscorlib::System::Object  AssemblyMetadataAttribute::get_TypeId()
			{
