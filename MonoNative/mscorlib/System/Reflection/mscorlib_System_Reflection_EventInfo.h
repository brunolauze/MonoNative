	...
	namespace System
	{
		namespace Reflection
		{
			...
			public:
				...
				//	Get:AddMethod
				mscorlib::System::Reflection::MethodInfo  get_AddMethod();

				//	Get:RaiseMethod
				mscorlib::System::Reflection::MethodInfo  get_RaiseMethod();

				//	Get:RemoveMethod
				mscorlib::System::Reflection::MethodInfo  get_RemoveMethod();
