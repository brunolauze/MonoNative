...
namespace mscorlib
{
	namespace System
	{
		namespace Reflection
		{
			...
			//	Get:MemberType
			mscorlib::System::Reflection::MemberTypes::__ENUM__  MethodInfo::get_MemberType()
			{
			...
			//	Get:ReturnType
			mscorlib::System::Type  MethodInfo::get_ReturnType()
			{
			...
			mscorlib::System::Reflection::ICustomAttributeProvider  MethodInfo::get_ReturnTypeCustomAttributes()
			{
			...
			//	Get:ReturnParameter
			mscorlib::System::Reflection::ParameterInfo  MethodInfo::get_ReturnParameter()
			{
			...
			//	Get:MethodHandle
			mscorlib::System::RuntimeMethodHandle  MethodInfo::get_MethodHandle()
			{
			...
			//	Get:Attributes
			mscorlib::System::Reflection::MethodAttributes::__ENUM__  MethodInfo::get_Attributes()
			{
			...
			mscorlib::System::Reflection::CallingConventions::__ENUM__  MethodInfo::get_CallingConvention()
			{
			...
			//	Get:IsPublic
			mscorlib::System::Boolean  MethodInfo::get_IsPublic()
			{
			...
			//	Get:IsPrivate
			mscorlib::System::Boolean  MethodInfo::get_IsPrivate()
			{
			...
			//	Get:IsFamily
			mscorlib::System::Boolean  MethodInfo::get_IsFamily()
			{
			...
			//	Get:IsAssembly
			mscorlib::System::Boolean  MethodInfo::get_IsAssembly()
			{
			...
			mscorlib::System::Boolean  MethodInfo::get_IsFamilyAndAssembly()
			{
			...
			mscorlib::System::Boolean  MethodInfo::get_IsFamilyOrAssembly()
			{
			...
			//	Get:IsStatic
			mscorlib::System::Boolean  MethodInfo::get_IsStatic()
			{
			...
			//	Get:IsFinal
			mscorlib::System::Boolean  MethodInfo::get_IsFinal()
			{
			...
			//	Get:IsVirtual
			mscorlib::System::Boolean  MethodInfo::get_IsVirtual()
			{
			...
			//	Get:IsHideBySig
			mscorlib::System::Boolean  MethodInfo::get_IsHideBySig()
			{
			...
			//	Get:IsAbstract
			mscorlib::System::Boolean  MethodInfo::get_IsAbstract()
			{
			...
			//	Get:IsSpecialName
			mscorlib::System::Boolean  MethodInfo::get_IsSpecialName()
			{
			...
			//	Get:IsConstructor
			mscorlib::System::Boolean  MethodInfo::get_IsConstructor()
			{
			...
			mscorlib::System::Boolean  MethodInfo::get_ContainsGenericParameters()
			{
			...
			mscorlib::System::Boolean  MethodInfo::get_IsGenericMethodDefinition()
			{
			...
			//	Get:IsGenericMethod
			mscorlib::System::Boolean  MethodInfo::get_IsGenericMethod()
			{
			...
			mscorlib::System::Boolean  MethodInfo::get_IsSecurityCritical()
			{
			...
			mscorlib::System::Boolean  MethodInfo::get_IsSecuritySafeCritical()
			{
			...
			mscorlib::System::Boolean  MethodInfo::get_IsSecurityTransparent()
			{
			...
			mscorlib::System::Reflection::MethodImplAttributes::__ENUM__  MethodInfo::get_MethodImplementationFlags()
			{
			...
			//	Get:DeclaringType
			mscorlib::System::Type  MethodInfo::get_DeclaringType()
			{
			...
			//	Get:Name
			mscorlib::System::String  MethodInfo::get_Name()
			{
			...
			//	Get:ReflectedType
			mscorlib::System::Type  MethodInfo::get_ReflectedType()
			{
			...
			//	Get:Module
			mscorlib::System::Reflection::Module  MethodInfo::get_Module()
			{
			...
			//	Get:MetadataToken
			mscorlib::System::Int32  MethodInfo::get_MetadataToken()
			{
			...
			mscorlib::System::Collections::Generic::IEnumerable<mscorlib::System::Reflection::CustomAttributeData>  MethodInfo::get_CustomAttributes()
			{
