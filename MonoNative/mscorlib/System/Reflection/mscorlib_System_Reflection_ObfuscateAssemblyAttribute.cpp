...
namespace mscorlib
{
	namespace System
	{
		namespace Reflection
		{
			...
			mscorlib::System::Boolean  ObfuscateAssemblyAttribute::get_AssemblyIsPrivate()
			{
			...
			mscorlib::System::Boolean  ObfuscateAssemblyAttribute::get_StripAfterObfuscation()
			{
			...
			//	Get:TypeId
			mscorlib::System::Object  ObfuscateAssemblyAttribute::get_TypeId()
			{
