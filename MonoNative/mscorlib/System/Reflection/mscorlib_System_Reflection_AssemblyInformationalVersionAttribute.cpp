...
namespace mscorlib
{
	namespace System
	{
		namespace Reflection
		{
			...
			mscorlib::System::String  AssemblyInformationalVersionAttribute::get_InformationalVersion() const
			{
			...
			//	Get:TypeId
			mscorlib::System::Object  AssemblyInformationalVersionAttribute::get_TypeId() const
			{
