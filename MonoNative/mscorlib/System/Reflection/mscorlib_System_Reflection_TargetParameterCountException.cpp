...
namespace mscorlib
{
	namespace System
	{
		namespace Reflection
		{
			...
			//	Get:InnerException
			mscorlib::System::Exception  TargetParameterCountException::get_InnerException() const
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  TargetParameterCountException::get_HelpLink() const
			{
			...
			void TargetParameterCountException::set_HelpLink(mscorlib::System::String  value)
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  TargetParameterCountException::get_HResult() const
			{
			...
			void TargetParameterCountException::set_HResult(mscorlib::System::Int32  value)
			{
				MonoType *__parameter_types__[1];
				void *__parameters__[1];
				__parameter_types__[0] = Global::GetType(typeid(value).name());
			...
			//	Get:Message
			mscorlib::System::String  TargetParameterCountException::get_Message() const
			{
			...
			//	Get/Set:Source
			mscorlib::System::String  TargetParameterCountException::get_Source() const
			{
				MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System", "Exception", 0, NULL, "get_Source", __native_object__, 0, NULL, NULL, NULL);
				return mscorlib::System::String(__result__);
			}

			void TargetParameterCountException::set_Source(mscorlib::System::String  value)
			{
				MonoType *__parameter_types__[1];
				void *__parameters__[1];
				__parameter_types__[0] = Global::GetType(typeid(value).name());
			...
			//	Get:StackTrace
			mscorlib::System::String  TargetParameterCountException::get_StackTrace() const
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  TargetParameterCountException::get_TargetSite() const
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  TargetParameterCountException::get_Data() const
			{
