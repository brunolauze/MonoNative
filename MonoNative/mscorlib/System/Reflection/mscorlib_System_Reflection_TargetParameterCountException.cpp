...
namespace mscorlib
{
	namespace System
	{
		namespace Reflection
		{
			...
			//	Get:InnerException
			mscorlib::System::Exception  TargetParameterCountException::get_InnerException()
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  TargetParameterCountException::get_HelpLink()
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  TargetParameterCountException::get_HResult()
			{
			...
			//	Get:Message
			mscorlib::System::String  TargetParameterCountException::get_Message()
			{
			...
			//	Get/Set:Source
			mscorlib::System::String  TargetParameterCountException::get_Source()
			{
			...
			//	Get:StackTrace
			mscorlib::System::String  TargetParameterCountException::get_StackTrace()
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  TargetParameterCountException::get_TargetSite()
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  TargetParameterCountException::get_Data()
			{
