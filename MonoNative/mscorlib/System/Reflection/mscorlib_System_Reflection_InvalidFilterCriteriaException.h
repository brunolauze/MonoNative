#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_REFLECTION_INVALIDFILTERCRITERIAEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_REFLECTION_INVALIDFILTERCRITERIAEXCEPTION_H
	...
	namespace System
	{
		namespace Reflection
		{
			...
			public:
				...
				: mscorlib::System::ApplicationException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Reflection.InvalidFilterCriteriaException"))
				, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					__native_object__ = Global::New("mscorlib", "System.Reflection", "InvalidFilterCriteriaException");
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.Reflection", "InvalidFilterCriteriaException", 1, __parameter_types__, __parameters__);
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.Reflection", "InvalidFilterCriteriaException", 2, __parameter_types__, __parameters__);
				};
			
				InvalidFilterCriteriaException(mscorlib::NativeTypeInfo *nativeTypeInfo)
				...
				InvalidFilterCriteriaException(MonoObject *nativeObject)
				...
				InvalidFilterCriteriaException & operator=(InvalidFilterCriteriaException &value) { __native_object__ = value.GetNativeObject(); return value; };
				bool operator==(InvalidFilterCriteriaException &value) { return mscorlib::System::Object::Equals(value); };
