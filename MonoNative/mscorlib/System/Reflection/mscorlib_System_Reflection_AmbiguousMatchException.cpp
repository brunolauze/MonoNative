...
namespace mscorlib
{
	namespace System
	{
		namespace Reflection
		{
			...
			//	Get:InnerException
			mscorlib::System::Exception  AmbiguousMatchException::get_InnerException()
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  AmbiguousMatchException::get_HelpLink()
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  AmbiguousMatchException::get_HResult()
			{
			...
			//	Get:Message
			mscorlib::System::String  AmbiguousMatchException::get_Message()
			{
			...
			//	Get/Set:Source
			mscorlib::System::String  AmbiguousMatchException::get_Source()
			{
			...
			//	Get:StackTrace
			mscorlib::System::String  AmbiguousMatchException::get_StackTrace()
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  AmbiguousMatchException::get_TargetSite()
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  AmbiguousMatchException::get_Data()
			{
