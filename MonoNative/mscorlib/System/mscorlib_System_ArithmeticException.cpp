...
namespace mscorlib
{
	namespace System
	{
		...
		//	Get:InnerException
		mscorlib::System::Exception  ArithmeticException::get_InnerException()
		{
		...
		//	Get/Set:HelpLink
		mscorlib::System::String  ArithmeticException::get_HelpLink()
		{
		...
		//	Get/Set:HResult
		mscorlib::System::Int32  ArithmeticException::get_HResult()
		{
		...
		//	Get:Message
		mscorlib::System::String  ArithmeticException::get_Message()
		{
		...
		//	Get/Set:Source
		mscorlib::System::String  ArithmeticException::get_Source()
		{
		...
		//	Get:StackTrace
		mscorlib::System::String  ArithmeticException::get_StackTrace()
		{
		...
		//	Get:TargetSite
		mscorlib::System::Reflection::MethodBase  ArithmeticException::get_TargetSite()
		{
		...
		//	Get:Data
		mscorlib::System::Collections::IDictionary  ArithmeticException::get_Data()
		{
