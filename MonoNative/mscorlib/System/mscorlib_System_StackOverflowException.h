#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_STACKOVERFLOWEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_STACKOVERFLOWEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.StackOverflowException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "StackOverflowException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "StackOverflowException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "StackOverflowException", 2, __parameter_types__, __parameters__);
			};
		
			StackOverflowException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			StackOverflowException(MonoObject *nativeObject)
