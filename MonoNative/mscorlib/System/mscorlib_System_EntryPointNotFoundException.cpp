...
namespace mscorlib
{
	namespace System
	{
		...
		//	Get:Message
		mscorlib::System::String  EntryPointNotFoundException::get_Message() const
		{
		...
		//	Get:TypeName
		mscorlib::System::String  EntryPointNotFoundException::get_TypeName() const
		{
		...
		//	Get:InnerException
		mscorlib::System::Exception  EntryPointNotFoundException::get_InnerException() const
		{
		...
		//	Get/Set:HelpLink
		mscorlib::System::String  EntryPointNotFoundException::get_HelpLink() const
		{
		...
		void EntryPointNotFoundException::set_HelpLink(mscorlib::System::String  value)
		{
		...
		//	Get/Set:HResult
		mscorlib::System::Int32  EntryPointNotFoundException::get_HResult() const
		{
		...
		void EntryPointNotFoundException::set_HResult(mscorlib::System::Int32  value)
		{
			MonoType *__parameter_types__[1];
			void *__parameters__[1];
			__parameter_types__[0] = Global::GetType(typeid(value).name());
		...
		//	Get/Set:Source
		mscorlib::System::String  EntryPointNotFoundException::get_Source() const
		{
			MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System", "Exception", 0, NULL, "get_Source", __native_object__, 0, NULL, NULL, NULL);
			return mscorlib::System::String(__result__);
		}

		void EntryPointNotFoundException::set_Source(mscorlib::System::String  value)
		{
			MonoType *__parameter_types__[1];
			void *__parameters__[1];
			__parameter_types__[0] = Global::GetType(typeid(value).name());
		...
		//	Get:StackTrace
		mscorlib::System::String  EntryPointNotFoundException::get_StackTrace() const
		{
		...
		//	Get:TargetSite
		mscorlib::System::Reflection::MethodBase  EntryPointNotFoundException::get_TargetSite() const
		{
		...
		//	Get:Data
		mscorlib::System::Collections::IDictionary  EntryPointNotFoundException::get_Data() const
		{
