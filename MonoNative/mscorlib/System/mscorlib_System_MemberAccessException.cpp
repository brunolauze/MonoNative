...
namespace mscorlib
{
	namespace System
	{
		...
		//	Get:InnerException
		mscorlib::System::Exception  MemberAccessException::get_InnerException()
		{
		...
		//	Get/Set:HelpLink
		mscorlib::System::String  MemberAccessException::get_HelpLink()
		{
		...
		//	Get/Set:HResult
		mscorlib::System::Int32  MemberAccessException::get_HResult()
		{
		...
		//	Get:Message
		mscorlib::System::String  MemberAccessException::get_Message()
		{
		...
		//	Get/Set:Source
		mscorlib::System::String  MemberAccessException::get_Source()
		{
		...
		//	Get:StackTrace
		mscorlib::System::String  MemberAccessException::get_StackTrace()
		{
		...
		//	Get:TargetSite
		mscorlib::System::Reflection::MethodBase  MemberAccessException::get_TargetSite()
		{
		...
		//	Get:Data
		mscorlib::System::Collections::IDictionary  MemberAccessException::get_Data()
		{
