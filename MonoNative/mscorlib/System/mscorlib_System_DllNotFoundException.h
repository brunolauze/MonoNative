#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_DLLNOTFOUNDEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_DLLNOTFOUNDEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::TypeLoadException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.DllNotFoundException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "DllNotFoundException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "DllNotFoundException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "DllNotFoundException", 2, __parameter_types__, __parameters__);
			};
		
			DllNotFoundException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			DllNotFoundException(MonoObject *nativeObject)
			...
			DllNotFoundException & operator=(DllNotFoundException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(DllNotFoundException &value) { return mscorlib::System::Object::Equals(value); };
