...
namespace mscorlib
{
	namespace System
	{
		...
		//	Get:Message
		mscorlib::System::String  ObjectDisposedException::get_Message() const
		{
		...
		//	Get:ObjectName
		mscorlib::System::String  ObjectDisposedException::get_ObjectName() const
		{
		...
		//	Get:InnerException
		mscorlib::System::Exception  ObjectDisposedException::get_InnerException() const
		{
		...
		//	Get/Set:HelpLink
		mscorlib::System::String  ObjectDisposedException::get_HelpLink() const
		{
		...
		//	Get/Set:HResult
		mscorlib::System::Int32  ObjectDisposedException::get_HResult() const
		{
		...
		//	Get/Set:Source
		mscorlib::System::String  ObjectDisposedException::get_Source() const
		{
		...
		//	Get:StackTrace
		mscorlib::System::String  ObjectDisposedException::get_StackTrace() const
		{
		...
		//	Get:TargetSite
		mscorlib::System::Reflection::MethodBase  ObjectDisposedException::get_TargetSite() const
		{
		...
		//	Get:Data
		mscorlib::System::Collections::IDictionary  ObjectDisposedException::get_Data() const
		{
