#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_ARRAYTYPEMISMATCHEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_ARRAYTYPEMISMATCHEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.ArrayTypeMismatchException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "ArrayTypeMismatchException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "ArrayTypeMismatchException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "ArrayTypeMismatchException", 2, __parameter_types__, __parameters__);
			};
		
			ArrayTypeMismatchException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			ArrayTypeMismatchException(MonoObject *nativeObject)
			...
			ArrayTypeMismatchException & operator=(ArrayTypeMismatchException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(ArrayTypeMismatchException &value) { return mscorlib::System::Object::Equals(value); };
