#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_INVALIDCASTEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_INVALIDCASTEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.InvalidCastException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "InvalidCastException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "InvalidCastException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "InvalidCastException", 2, __parameter_types__, __parameters__);
			};
			...
			InvalidCastException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			InvalidCastException(MonoObject *nativeObject)
			...
			InvalidCastException & operator=(InvalidCastException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(InvalidCastException &value) { return mscorlib::System::Object::Equals(value); };
