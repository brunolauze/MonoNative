#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_ACCESSVIOLATIONEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_ACCESSVIOLATIONEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.AccessViolationException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "AccessViolationException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "AccessViolationException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "AccessViolationException", 2, __parameter_types__, __parameters__);
			};
		
			AccessViolationException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			AccessViolationException(MonoObject *nativeObject)
			...
			AccessViolationException & operator=(AccessViolationException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(AccessViolationException &value) { return mscorlib::System::Object::Equals(value); };
