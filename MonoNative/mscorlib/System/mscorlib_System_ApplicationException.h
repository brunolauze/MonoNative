#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_APPLICATIONEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_APPLICATIONEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::Exception(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.ApplicationException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "ApplicationException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "ApplicationException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "ApplicationException", 2, __parameter_types__, __parameters__);
			};
		
			ApplicationException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			ApplicationException(MonoObject *nativeObject)
			...
			ApplicationException & operator=(ApplicationException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(ApplicationException &value) { return mscorlib::System::Object::Equals(value); };
