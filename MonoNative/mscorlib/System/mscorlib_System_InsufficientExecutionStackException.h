#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_INSUFFICIENTEXECUTIONSTACKEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_INSUFFICIENTEXECUTIONSTACKEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.InsufficientExecutionStackException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "InsufficientExecutionStackException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "InsufficientExecutionStackException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "InsufficientExecutionStackException", 2, __parameter_types__, __parameters__);
			};
		
			InsufficientExecutionStackException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			InsufficientExecutionStackException(MonoObject *nativeObject)
			...
			InsufficientExecutionStackException & operator=(InsufficientExecutionStackException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(InsufficientExecutionStackException &value) { return mscorlib::System::Object::Equals(value); };
