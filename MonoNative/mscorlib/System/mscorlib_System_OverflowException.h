#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_OVERFLOWEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_OVERFLOWEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			OverflowException()
			: mscorlib::System::ArithmeticException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.OverflowException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "OverflowException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "OverflowException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "OverflowException", 2, __parameter_types__, __parameters__);
			};
		
			OverflowException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			OverflowException(MonoObject *nativeObject)
			...
			OverflowException & operator=(OverflowException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(OverflowException &value) { return mscorlib::System::Object::Equals(value); };
