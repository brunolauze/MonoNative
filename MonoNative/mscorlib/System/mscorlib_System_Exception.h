#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_EXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_EXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			Exception()
			: mscorlib::System::Object(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Exception"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "Exception");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "Exception", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "Exception", 2, __parameter_types__, __parameters__);
			};
		
			Exception(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			Exception(MonoObject *nativeObject)
			...
			Exception & operator=(Exception &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(Exception &value) { return mscorlib::System::Object::Equals(value); };
