#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_MULTICASTNOTSUPPORTEDEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_MULTICASTNOTSUPPORTEDEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.MulticastNotSupportedException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "MulticastNotSupportedException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "MulticastNotSupportedException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "MulticastNotSupportedException", 2, __parameter_types__, __parameters__);
			};
		
			MulticastNotSupportedException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			MulticastNotSupportedException(MonoObject *nativeObject)
			...
			MulticastNotSupportedException & operator=(MulticastNotSupportedException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(MulticastNotSupportedException &value) { return mscorlib::System::Object::Equals(value); };
