#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_SYSTEMEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_SYSTEMEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			SystemException()
			: mscorlib::System::Exception(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.SystemException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "SystemException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "SystemException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "SystemException", 2, __parameter_types__, __parameters__);
			};
		
			SystemException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			SystemException(MonoObject *nativeObject)
			...
			SystemException & operator=(SystemException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(SystemException &value) { return mscorlib::System::Object::Equals(value); };
