#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_TYPEUNLOADEDEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_TYPEUNLOADEDEXCEPTION_H
	...
	namespace System
	{
		...
		public:
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "TypeUnloadedException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "TypeUnloadedException", 2, __parameter_types__, __parameters__);
			};
			...
			TypeUnloadedException & operator=(TypeUnloadedException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(TypeUnloadedException &value) { return mscorlib::System::Object::Equals(value); };
