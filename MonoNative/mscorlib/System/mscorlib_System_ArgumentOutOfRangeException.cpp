...
namespace mscorlib
{
	namespace System
	{
		...
		//Public Methods
		void ArgumentOutOfRangeException::GetObjectData(mscorlib::System::Runtime::Serialization::SerializationInfo info, mscorlib::System::Runtime::Serialization::StreamingContext context)
		{
				...
				Global::InvokeMethod("mscorlib", "System", "ArgumentOutOfRangeException", 0, NULL, "GetObjectData", __native_object__, 2, __parameter_types__, __parameters__, NULL);
		}
		...
		void ArgumentOutOfRangeException::set_HelpLink(mscorlib::System::String  value)
		{
		...
		void ArgumentOutOfRangeException::set_HResult(mscorlib::System::Int32  value)
		{
			MonoType *__parameter_types__[1];
			void *__parameters__[1];
			__parameter_types__[0] = Global::GetType(typeid(value).name());
		...
		void ArgumentOutOfRangeException::set_Source(mscorlib::System::String  value)
		{
			MonoType *__parameter_types__[1];
			void *__parameters__[1];
			__parameter_types__[0] = Global::GetType(typeid(value).name());
