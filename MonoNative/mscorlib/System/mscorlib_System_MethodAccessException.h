#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_METHODACCESSEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_METHODACCESSEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		class MethodAccessException
			: public mscorlib::System::MemberAccessException
			, public virtual mscorlib::System::Runtime::InteropServices::_Exception
			, public virtual mscorlib::System::Runtime::Serialization::ISerializable
		{
		public:
			MethodAccessException()
			: mscorlib::System::MemberAccessException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.MethodAccessException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "MethodAccessException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "MethodAccessException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "MethodAccessException", 2, __parameter_types__, __parameters__);
			};
		
			MethodAccessException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			: mscorlib::System::MemberAccessException(nativeTypeInfo)
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
			};
		
			MethodAccessException(MonoObject *nativeObject)
			: mscorlib::System::MemberAccessException(nativeObject)
			...
			MethodAccessException & operator=(MethodAccessException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(MethodAccessException &value) { return mscorlib::System::Object::Equals(value); };
