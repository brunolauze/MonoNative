#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_MISSINGFIELDEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_MISSINGFIELDEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::MissingMemberException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.MissingFieldException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "MissingFieldException");
			};
		
			MissingFieldException(mscorlib::System::String message)
			: mscorlib::System::MissingMemberException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.MissingFieldException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "MissingFieldException", 1, __parameter_types__, __parameters__);
			};
		
			MissingFieldException(mscorlib::System::String message, mscorlib::System::Exception inner)
			: mscorlib::System::MissingMemberException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.MissingFieldException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "MissingFieldException", 2, __parameter_types__, __parameters__);
			};
		
			MissingFieldException(mscorlib::System::String className, mscorlib::System::String fieldName)
			: mscorlib::System::MissingMemberException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.MissingFieldException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
			...
			MissingFieldException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			MissingFieldException(MonoObject *nativeObject)
