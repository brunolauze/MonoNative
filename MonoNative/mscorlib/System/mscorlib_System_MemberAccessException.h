#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_MEMBERACCESSEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_MEMBERACCESSEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.MemberAccessException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "MemberAccessException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "MemberAccessException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "MemberAccessException", 2, __parameter_types__, __parameters__);
			};
		
			MemberAccessException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			MemberAccessException(MonoObject *nativeObject)
			...
			MemberAccessException & operator=(MemberAccessException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(MemberAccessException &value) { return mscorlib::System::Object::Equals(value); };
