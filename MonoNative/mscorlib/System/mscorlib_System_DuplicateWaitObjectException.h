#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_DUPLICATEWAITOBJECTEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_DUPLICATEWAITOBJECTEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::ArgumentException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.DuplicateWaitObjectException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "DuplicateWaitObjectException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__parameters__[0] = (MonoObject*)parameterName;
				__native_object__ = Global::New("mscorlib", "System", "DuplicateWaitObjectException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "DuplicateWaitObjectException", 2, __parameter_types__, __parameters__);
			};
			...
			DuplicateWaitObjectException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			DuplicateWaitObjectException(MonoObject *nativeObject)
			...
			DuplicateWaitObjectException & operator=(DuplicateWaitObjectException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(DuplicateWaitObjectException &value) { return mscorlib::System::Object::Equals(value); };
