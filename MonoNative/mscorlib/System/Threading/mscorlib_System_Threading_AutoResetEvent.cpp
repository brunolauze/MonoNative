...
namespace mscorlib
{
	namespace System
	{
		namespace Threading
		{
			...
			//	Get/Set:Handle
			mscorlib::System::IntPtr  AutoResetEvent::get_Handle() const
			{
			...
			void AutoResetEvent::set_Handle(mscorlib::System::IntPtr  value)
			{
			...
			mscorlib::Microsoft::Win32::SafeHandles::SafeWaitHandle  AutoResetEvent::get_SafeWaitHandle() const
			{
			...
			void AutoResetEvent::set_SafeWaitHandle(mscorlib::Microsoft::Win32::SafeHandles::SafeWaitHandle  value)
			{
				MonoType *__parameter_types__[1];
				void *__parameters__[1];
				__parameter_types__[0] = Global::GetType(typeid(value).name());
