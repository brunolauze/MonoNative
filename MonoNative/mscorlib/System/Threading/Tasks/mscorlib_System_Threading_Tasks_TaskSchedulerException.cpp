	...
	namespace System
	{
		namespace Threading
		{
			namespace Tasks
			{
				...
				//	Get:InnerException
				mscorlib::System::Exception  TaskSchedulerException::get_InnerException() const
				{
				...
				//	Get/Set:HelpLink
				mscorlib::System::String  TaskSchedulerException::get_HelpLink() const
				{
				...
				void TaskSchedulerException::set_HelpLink(mscorlib::System::String  value)
				{
				...
				//	Get/Set:HResult
				mscorlib::System::Int32  TaskSchedulerException::get_HResult() const
				{
				...
				void TaskSchedulerException::set_HResult(mscorlib::System::Int32  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
					__parameter_types__[0] = Global::GetType(typeid(value).name());
				...
				//	Get:Message
				mscorlib::System::String  TaskSchedulerException::get_Message() const
				{
				...
				//	Get/Set:Source
				mscorlib::System::String  TaskSchedulerException::get_Source() const
				{
					MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System", "Exception", 0, NULL, "get_Source", __native_object__, 0, NULL, NULL, NULL);
					return mscorlib::System::String(__result__);
				}

				void TaskSchedulerException::set_Source(mscorlib::System::String  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
					__parameter_types__[0] = Global::GetType(typeid(value).name());
				...
				//	Get:StackTrace
				mscorlib::System::String  TaskSchedulerException::get_StackTrace() const
				{
				...
				//	Get:TargetSite
				mscorlib::System::Reflection::MethodBase  TaskSchedulerException::get_TargetSite() const
				{
				...
				//	Get:Data
				mscorlib::System::Collections::IDictionary  TaskSchedulerException::get_Data() const
				{
