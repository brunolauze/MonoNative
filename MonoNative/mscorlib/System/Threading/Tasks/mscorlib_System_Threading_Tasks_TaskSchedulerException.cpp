	...
	namespace System
	{
		namespace Threading
		{
			namespace Tasks
			{
				...
				//	Get:InnerException
				mscorlib::System::Exception  TaskSchedulerException::get_InnerException()
				{
				...
				//	Get/Set:HelpLink
				mscorlib::System::String  TaskSchedulerException::get_HelpLink()
				{
				...
				//	Get/Set:HResult
				mscorlib::System::Int32  TaskSchedulerException::get_HResult()
				{
				...
				//	Get:Message
				mscorlib::System::String  TaskSchedulerException::get_Message()
				{
				...
				//	Get/Set:Source
				mscorlib::System::String  TaskSchedulerException::get_Source()
				{
				...
				//	Get:StackTrace
				mscorlib::System::String  TaskSchedulerException::get_StackTrace()
				{
				...
				//	Get:TargetSite
				mscorlib::System::Reflection::MethodBase  TaskSchedulerException::get_TargetSite()
				{
				...
				//	Get:Data
				mscorlib::System::Collections::IDictionary  TaskSchedulerException::get_Data()
				{
