	...
	namespace System
	{
		namespace Threading
		{
			namespace Tasks
			{
				...
				void TaskCanceledException::set_HelpLink(mscorlib::System::String  value)
				{
				...
				void TaskCanceledException::set_HResult(mscorlib::System::Int32  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
					__parameter_types__[0] = Global::GetType(typeid(value).name());
				...
				void TaskCanceledException::set_Source(mscorlib::System::String  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
					__parameter_types__[0] = Global::GetType(typeid(value).name());
