		...
		namespace Threading
		{
			namespace Tasks
			{
				...
				void Parallel::Invoke(std::vector<mscorlib::Callback<void  ()> *> actions)
				{
						...
						__parameter_types__[0] = mono_class_get_type(mono_type_get_array_type(Global::GetType(typeid(actions).name()))->eklass);
				...
				void Parallel::Invoke(mscorlib::System::Threading::Tasks::ParallelOptions parallelOptions, std::vector<mscorlib::Callback<void  ()> *> actions)
				{
						...
						__parameter_types__[1] = mono_class_get_type(mono_type_get_array_type(Global::GetType(typeid(actions).name()))->eklass);
