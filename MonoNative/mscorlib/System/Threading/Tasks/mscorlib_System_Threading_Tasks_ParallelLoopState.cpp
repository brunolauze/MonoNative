	...
	namespace System
	{
		namespace Threading
		{
			namespace Tasks
			{
				...
				//	Get:IsStopped
				mscorlib::System::Boolean  ParallelLoopState::get_IsStopped()
				{
				...
				//	Get:IsExceptional
				mscorlib::System::Boolean  ParallelLoopState::get_IsExceptional()
				{
				...
				mscorlib::System::Nullable<mscorlib::System::Int64>  ParallelLoopState::get_LowestBreakIteration()
				{
				...
				mscorlib::System::Boolean  ParallelLoopState::get_ShouldExitCurrentIteration()
				{
