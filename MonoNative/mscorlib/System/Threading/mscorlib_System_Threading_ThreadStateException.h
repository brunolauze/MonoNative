#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_THREADING_THREADSTATEEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_THREADING_THREADSTATEEXCEPTION_H
	...
	namespace System
	{
		namespace Threading
		{
			...
			public:
				...
				: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Threading.ThreadStateException"))
				, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					__native_object__ = Global::New("mscorlib", "System.Threading", "ThreadStateException");
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.Threading", "ThreadStateException", 1, __parameter_types__, __parameters__);
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.Threading", "ThreadStateException", 2, __parameter_types__, __parameters__);
				};
			
				ThreadStateException(mscorlib::NativeTypeInfo *nativeTypeInfo)
				...
				ThreadStateException(MonoObject *nativeObject)
