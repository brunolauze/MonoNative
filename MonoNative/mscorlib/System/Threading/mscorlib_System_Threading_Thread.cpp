	...
	namespace System
	{
		namespace Threading
		{
			...
			mscorlib::System::Threading::ApartmentState::__ENUM__ Thread::GetApartmentState()
			{
					...
					return static_cast<mscorlib::System::Threading::ApartmentState::__ENUM__>(*(mscorlib::System::Int32*)mono_object_unbox(__result__));
			}
			...
			mscorlib::System::Threading::ThreadPriority::__ENUM__  Thread::get_Priority() const
			{
				...
				return static_cast<mscorlib::System::Threading::ThreadPriority::__ENUM__>(*(mscorlib::System::Int32*)mono_object_unbox(__result__));
			}
			...
			mscorlib::System::Threading::ThreadState::__ENUM__  Thread::get_ThreadState() const
			{
				...
				return static_cast<mscorlib::System::Threading::ThreadState::__ENUM__>(*(mscorlib::System::Int32*)mono_object_unbox(__result__));
			}
