#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_THREADING_THREADINTERRUPTEDEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_THREADING_THREADINTERRUPTEDEXCEPTION_H
	...
	namespace System
	{
		namespace Threading
		{
			...
			public:
				...
				: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Threading.ThreadInterruptedException"))
				, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					__native_object__ = Global::New("mscorlib", "System.Threading", "ThreadInterruptedException");
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.Threading", "ThreadInterruptedException", 1, __parameter_types__, __parameters__);
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.Threading", "ThreadInterruptedException", 2, __parameter_types__, __parameters__);
				};
			
				ThreadInterruptedException(mscorlib::NativeTypeInfo *nativeTypeInfo)
				...
				ThreadInterruptedException(MonoObject *nativeObject)
				...
				ThreadInterruptedException & operator=(ThreadInterruptedException &value) { __native_object__ = value.GetNativeObject(); return value; };
				bool operator==(ThreadInterruptedException &value) { return mscorlib::System::Object::Equals(value); };
