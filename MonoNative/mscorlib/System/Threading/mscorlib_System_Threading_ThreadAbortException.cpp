...
namespace mscorlib
{
	namespace System
	{
		namespace Threading
		{
			...
			//	Get:ExceptionState
			mscorlib::System::Object  ThreadAbortException::get_ExceptionState() const
			{
				MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Threading", "ThreadAbortException", 0, NULL, "get_ExceptionState", __native_object__, 0, NULL, NULL, NULL);
				return mscorlib::System::Object(__result__);
			}


			//	Get:InnerException
			mscorlib::System::Exception  ThreadAbortException::get_InnerException() const
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  ThreadAbortException::get_HelpLink() const
			{
			...
			void ThreadAbortException::set_HelpLink(mscorlib::System::String  value)
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  ThreadAbortException::get_HResult() const
			{
			...
			void ThreadAbortException::set_HResult(mscorlib::System::Int32  value)
			{
				MonoType *__parameter_types__[1];
				void *__parameters__[1];
				__parameter_types__[0] = Global::GetType(typeid(value).name());
			...
			//	Get:Message
			mscorlib::System::String  ThreadAbortException::get_Message() const
			{
			...
			//	Get/Set:Source
			mscorlib::System::String  ThreadAbortException::get_Source() const
			{
				MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System", "Exception", 0, NULL, "get_Source", __native_object__, 0, NULL, NULL, NULL);
				return mscorlib::System::String(__result__);
			}

			void ThreadAbortException::set_Source(mscorlib::System::String  value)
			{
				MonoType *__parameter_types__[1];
				void *__parameters__[1];
				__parameter_types__[0] = Global::GetType(typeid(value).name());
			...
			//	Get:StackTrace
			mscorlib::System::String  ThreadAbortException::get_StackTrace() const
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  ThreadAbortException::get_TargetSite() const
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  ThreadAbortException::get_Data() const
			{
