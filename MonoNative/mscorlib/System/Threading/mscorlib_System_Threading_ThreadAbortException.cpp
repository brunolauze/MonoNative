...
namespace mscorlib
{
	namespace System
	{
		namespace Threading
		{
			...
			//	Get:ExceptionState
			mscorlib::System::Object  ThreadAbortException::get_ExceptionState()
			{
			...
			//	Get:InnerException
			mscorlib::System::Exception  ThreadAbortException::get_InnerException()
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  ThreadAbortException::get_HelpLink()
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  ThreadAbortException::get_HResult()
			{
			...
			//	Get:Message
			mscorlib::System::String  ThreadAbortException::get_Message()
			{
			...
			//	Get/Set:Source
			mscorlib::System::String  ThreadAbortException::get_Source()
			{
			...
			//	Get:StackTrace
			mscorlib::System::String  ThreadAbortException::get_StackTrace()
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  ThreadAbortException::get_TargetSite()
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  ThreadAbortException::get_Data()
			{
