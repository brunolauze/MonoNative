...
namespace mscorlib
{
	namespace System
	{
		namespace Threading
		{
			...
			//	Get:InnerException
			mscorlib::System::Exception  SynchronizationLockException::get_InnerException()
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  SynchronizationLockException::get_HelpLink()
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  SynchronizationLockException::get_HResult()
			{
			...
			//	Get:Message
			mscorlib::System::String  SynchronizationLockException::get_Message()
			{
			...
			//	Get/Set:Source
			mscorlib::System::String  SynchronizationLockException::get_Source()
			{
			...
			//	Get:StackTrace
			mscorlib::System::String  SynchronizationLockException::get_StackTrace()
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  SynchronizationLockException::get_TargetSite()
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  SynchronizationLockException::get_Data()
			{
