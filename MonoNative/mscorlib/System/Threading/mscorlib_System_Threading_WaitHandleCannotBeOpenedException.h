#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_THREADING_WAITHANDLECANNOTBEOPENEDEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_THREADING_WAITHANDLECANNOTBEOPENEDEXCEPTION_H
	...
	namespace System
	{
		namespace Threading
		{
			...
			public:
				...
				: mscorlib::System::ApplicationException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Threading.WaitHandleCannotBeOpenedException"))
				, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					__native_object__ = Global::New("mscorlib", "System.Threading", "WaitHandleCannotBeOpenedException");
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.Threading", "WaitHandleCannotBeOpenedException", 1, __parameter_types__, __parameters__);
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.Threading", "WaitHandleCannotBeOpenedException", 2, __parameter_types__, __parameters__);
				};
			
				WaitHandleCannotBeOpenedException(mscorlib::NativeTypeInfo *nativeTypeInfo)
				...
				WaitHandleCannotBeOpenedException(MonoObject *nativeObject)
				...
				WaitHandleCannotBeOpenedException & operator=(WaitHandleCannotBeOpenedException &value) { __native_object__ = value.GetNativeObject(); return value; };
				bool operator==(WaitHandleCannotBeOpenedException &value) { return mscorlib::System::Object::Equals(value); };
