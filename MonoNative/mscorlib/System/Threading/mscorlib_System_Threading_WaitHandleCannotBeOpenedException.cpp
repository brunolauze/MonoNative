...
namespace mscorlib
{
	namespace System
	{
		namespace Threading
		{
			...
			//	Get:InnerException
			mscorlib::System::Exception  WaitHandleCannotBeOpenedException::get_InnerException()
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  WaitHandleCannotBeOpenedException::get_HelpLink()
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  WaitHandleCannotBeOpenedException::get_HResult()
			{
			...
			//	Get:Message
			mscorlib::System::String  WaitHandleCannotBeOpenedException::get_Message()
			{
			...
			//	Get/Set:Source
			mscorlib::System::String  WaitHandleCannotBeOpenedException::get_Source()
			{
			...
			//	Get:StackTrace
			mscorlib::System::String  WaitHandleCannotBeOpenedException::get_StackTrace()
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  WaitHandleCannotBeOpenedException::get_TargetSite()
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  WaitHandleCannotBeOpenedException::get_Data()
			{
