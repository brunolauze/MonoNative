...
namespace mscorlib
{
	namespace System
	{
		namespace Threading
		{
			...
			//	Get:InnerException
			mscorlib::System::Exception  LockRecursionException::get_InnerException()
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  LockRecursionException::get_HelpLink()
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  LockRecursionException::get_HResult()
			{
			...
			//	Get:Message
			mscorlib::System::String  LockRecursionException::get_Message()
			{
			...
			//	Get/Set:Source
			mscorlib::System::String  LockRecursionException::get_Source()
			{
			...
			//	Get:StackTrace
			mscorlib::System::String  LockRecursionException::get_StackTrace()
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  LockRecursionException::get_TargetSite()
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  LockRecursionException::get_Data()
			{
