#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_THREADING_LOCKRECURSIONEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_THREADING_LOCKRECURSIONEXCEPTION_H
	...
	namespace System
	{
		namespace Threading
		{
			...
			public:
				...
				: mscorlib::System::Exception(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Threading.LockRecursionException"))
				, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					__native_object__ = Global::New("mscorlib", "System.Threading", "LockRecursionException");
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.Threading", "LockRecursionException", 1, __parameter_types__, __parameters__);
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.Threading", "LockRecursionException", 2, __parameter_types__, __parameters__);
				};
			
				LockRecursionException(mscorlib::NativeTypeInfo *nativeTypeInfo)
				...
				LockRecursionException(MonoObject *nativeObject)
				...
				LockRecursionException & operator=(LockRecursionException &value) { __native_object__ = value.GetNativeObject(); return value; };
				bool operator==(LockRecursionException &value) { return mscorlib::System::Object::Equals(value); };
