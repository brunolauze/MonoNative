#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_THREADING_SEMAPHOREFULLEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_THREADING_SEMAPHOREFULLEXCEPTION_H
	...
	namespace System
	{
		namespace Threading
		{
			...
			public:
				...
				: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Threading.SemaphoreFullException"))
				, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					__native_object__ = Global::New("mscorlib", "System.Threading", "SemaphoreFullException");
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.Threading", "SemaphoreFullException", 1, __parameter_types__, __parameters__);
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.Threading", "SemaphoreFullException", 2, __parameter_types__, __parameters__);
				};
			
				SemaphoreFullException(mscorlib::NativeTypeInfo *nativeTypeInfo)
				...
				SemaphoreFullException(MonoObject *nativeObject)
				...
				SemaphoreFullException & operator=(SemaphoreFullException &value) { __native_object__ = value.GetNativeObject(); return value; };
				bool operator==(SemaphoreFullException &value) { return mscorlib::System::Object::Equals(value); };
