...
namespace mscorlib
{
	namespace System
	{
		namespace Threading
		{
			...
			//	Get:InnerException
			mscorlib::System::Exception  SemaphoreFullException::get_InnerException()
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  SemaphoreFullException::get_HelpLink()
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  SemaphoreFullException::get_HResult()
			{
			...
			//	Get:Message
			mscorlib::System::String  SemaphoreFullException::get_Message()
			{
			...
			//	Get/Set:Source
			mscorlib::System::String  SemaphoreFullException::get_Source()
			{
			...
			//	Get:StackTrace
			mscorlib::System::String  SemaphoreFullException::get_StackTrace()
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  SemaphoreFullException::get_TargetSite()
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  SemaphoreFullException::get_Data()
			{
