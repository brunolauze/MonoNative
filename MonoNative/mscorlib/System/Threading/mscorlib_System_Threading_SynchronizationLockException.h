#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_THREADING_SYNCHRONIZATIONLOCKEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_THREADING_SYNCHRONIZATIONLOCKEXCEPTION_H
	...
	namespace System
	{
		namespace Threading
		{
			...
			public:
				...
				: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Threading.SynchronizationLockException"))
				, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					__native_object__ = Global::New("mscorlib", "System.Threading", "SynchronizationLockException");
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.Threading", "SynchronizationLockException", 1, __parameter_types__, __parameters__);
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.Threading", "SynchronizationLockException", 2, __parameter_types__, __parameters__);
				};
			
				SynchronizationLockException(mscorlib::NativeTypeInfo *nativeTypeInfo)
				...
				SynchronizationLockException(MonoObject *nativeObject)
				...
				SynchronizationLockException & operator=(SynchronizationLockException &value) { __native_object__ = value.GetNativeObject(); return value; };
				bool operator==(SynchronizationLockException &value) { return mscorlib::System::Object::Equals(value); };
