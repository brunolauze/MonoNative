#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_THREADING_THREADABORTEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_THREADING_THREADABORTEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		namespace Threading
		{
			...
			{
			public:
				ThreadAbortException(mscorlib::NativeTypeInfo *nativeTypeInfo)
				...
				ThreadAbortException(MonoObject *nativeObject)
				...
				ThreadAbortException & operator=(ThreadAbortException &value) { __native_object__ = value.GetNativeObject(); return value; };
				bool operator==(ThreadAbortException &value) { return mscorlib::System::Object::Equals(value); };
				...
				//Public Properties
				__declspec(property(get=get_ExceptionState)) mscorlib::System::Object  ExceptionState;
				...
				//	Get:ExceptionState
				mscorlib::System::Object  get_ExceptionState() const;
