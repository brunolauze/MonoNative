...
namespace mscorlib
{
	namespace System
	{
		namespace Threading
		{
			...
			//	Get:InnerException
			mscorlib::System::Exception  ThreadInterruptedException::get_InnerException()
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  ThreadInterruptedException::get_HelpLink()
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  ThreadInterruptedException::get_HResult()
			{
			...
			//	Get:Message
			mscorlib::System::String  ThreadInterruptedException::get_Message()
			{
			...
			//	Get/Set:Source
			mscorlib::System::String  ThreadInterruptedException::get_Source()
			{
			...
			//	Get:StackTrace
			mscorlib::System::String  ThreadInterruptedException::get_StackTrace()
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  ThreadInterruptedException::get_TargetSite()
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  ThreadInterruptedException::get_Data()
			{
