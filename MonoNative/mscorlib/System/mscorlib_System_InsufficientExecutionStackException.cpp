...
namespace mscorlib
{
	namespace System
	{
		...
		//	Get:InnerException
		mscorlib::System::Exception  InsufficientExecutionStackException::get_InnerException()
		{
		...
		//	Get/Set:HelpLink
		mscorlib::System::String  InsufficientExecutionStackException::get_HelpLink()
		{
		...
		//	Get/Set:HResult
		mscorlib::System::Int32  InsufficientExecutionStackException::get_HResult()
		{
		...
		//	Get:Message
		mscorlib::System::String  InsufficientExecutionStackException::get_Message()
		{
		...
		//	Get/Set:Source
		mscorlib::System::String  InsufficientExecutionStackException::get_Source()
		{
		...
		//	Get:StackTrace
		mscorlib::System::String  InsufficientExecutionStackException::get_StackTrace()
		{
		...
		//	Get:TargetSite
		mscorlib::System::Reflection::MethodBase  InsufficientExecutionStackException::get_TargetSite()
		{
		...
		//	Get:Data
		mscorlib::System::Collections::IDictionary  InsufficientExecutionStackException::get_Data()
		{
