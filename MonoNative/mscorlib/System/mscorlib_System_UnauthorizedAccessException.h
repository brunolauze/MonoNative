#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_UNAUTHORIZEDACCESSEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_UNAUTHORIZEDACCESSEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.UnauthorizedAccessException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "UnauthorizedAccessException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "UnauthorizedAccessException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "UnauthorizedAccessException", 2, __parameter_types__, __parameters__);
			};
		
			UnauthorizedAccessException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			UnauthorizedAccessException(MonoObject *nativeObject)
			...
			UnauthorizedAccessException & operator=(UnauthorizedAccessException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(UnauthorizedAccessException &value) { return mscorlib::System::Object::Equals(value); };
