...
namespace mscorlib
{
	namespace System
	{
		namespace Diagnostics
		{
			...
			//	Get:State
			mscorlib::System::Diagnostics::DebuggerBrowsableState::__ENUM__  DebuggerBrowsableAttribute::get_State()
			{
			...
			//	Get:TypeId
			mscorlib::System::Object  DebuggerBrowsableAttribute::get_TypeId()
			{
