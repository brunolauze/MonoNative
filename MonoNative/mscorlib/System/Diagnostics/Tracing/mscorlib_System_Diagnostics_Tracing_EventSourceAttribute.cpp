	...
	namespace System
	{
		namespace Diagnostics
		{
			namespace Tracing
			{
				...
				//	Get/Set:Guid
				mscorlib::System::String  EventSourceAttribute::get_Guid()
				{
				...
				mscorlib::System::String  EventSourceAttribute::get_LocalizationResources()
				{
				...
				//	Get/Set:Name
				mscorlib::System::String  EventSourceAttribute::get_Name()
				{
				...
				//	Get:TypeId
				mscorlib::System::Object  EventSourceAttribute::get_TypeId()
				{
