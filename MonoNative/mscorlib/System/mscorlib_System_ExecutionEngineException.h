#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_EXECUTIONENGINEEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_EXECUTIONENGINEEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.ExecutionEngineException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "ExecutionEngineException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "ExecutionEngineException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "ExecutionEngineException", 2, __parameter_types__, __parameters__);
			};
		
			ExecutionEngineException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			ExecutionEngineException(MonoObject *nativeObject)
			...
			ExecutionEngineException & operator=(ExecutionEngineException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(ExecutionEngineException &value) { return mscorlib::System::Object::Equals(value); };
