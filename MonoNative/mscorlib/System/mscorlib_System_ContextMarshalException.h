#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_CONTEXTMARSHALEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_CONTEXTMARSHALEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.ContextMarshalException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "ContextMarshalException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "ContextMarshalException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "ContextMarshalException", 2, __parameter_types__, __parameters__);
			};
		
			ContextMarshalException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			ContextMarshalException(MonoObject *nativeObject)
			...
			ContextMarshalException & operator=(ContextMarshalException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(ContextMarshalException &value) { return mscorlib::System::Object::Equals(value); };
