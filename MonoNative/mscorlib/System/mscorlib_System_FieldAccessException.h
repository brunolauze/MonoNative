#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_FIELDACCESSEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_FIELDACCESSEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::MemberAccessException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.FieldAccessException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "FieldAccessException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "FieldAccessException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "FieldAccessException", 2, __parameter_types__, __parameters__);
			};
		
			FieldAccessException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			FieldAccessException(MonoObject *nativeObject)
			...
			FieldAccessException & operator=(FieldAccessException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(FieldAccessException &value) { return mscorlib::System::Object::Equals(value); };
