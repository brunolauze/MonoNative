...
namespace mscorlib
{
	namespace System
	{
		...
		//	Get:InnerException
		mscorlib::System::Exception  CannotUnloadAppDomainException::get_InnerException() const
		{
		...
		//	Get/Set:HelpLink
		mscorlib::System::String  CannotUnloadAppDomainException::get_HelpLink() const
		{
		...
		void CannotUnloadAppDomainException::set_HelpLink(mscorlib::System::String  value)
		{
		...
		//	Get/Set:HResult
		mscorlib::System::Int32  CannotUnloadAppDomainException::get_HResult() const
		{
		...
		void CannotUnloadAppDomainException::set_HResult(mscorlib::System::Int32  value)
		{
			MonoType *__parameter_types__[1];
			void *__parameters__[1];
			__parameter_types__[0] = Global::GetType(typeid(value).name());
		...
		//	Get:Message
		mscorlib::System::String  CannotUnloadAppDomainException::get_Message() const
		{
		...
		//	Get/Set:Source
		mscorlib::System::String  CannotUnloadAppDomainException::get_Source() const
		{
			MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System", "Exception", 0, NULL, "get_Source", __native_object__, 0, NULL, NULL, NULL);
			return mscorlib::System::String(__result__);
		}

		void CannotUnloadAppDomainException::set_Source(mscorlib::System::String  value)
		{
			MonoType *__parameter_types__[1];
			void *__parameters__[1];
			__parameter_types__[0] = Global::GetType(typeid(value).name());
		...
		//	Get:StackTrace
		mscorlib::System::String  CannotUnloadAppDomainException::get_StackTrace() const
		{
		...
		//	Get:TargetSite
		mscorlib::System::Reflection::MethodBase  CannotUnloadAppDomainException::get_TargetSite() const
		{
		...
		//	Get:Data
		mscorlib::System::Collections::IDictionary  CannotUnloadAppDomainException::get_Data() const
		{
