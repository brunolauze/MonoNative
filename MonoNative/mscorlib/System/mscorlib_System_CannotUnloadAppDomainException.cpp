...
namespace mscorlib
{
	namespace System
	{
		...
		//	Get:InnerException
		mscorlib::System::Exception  CannotUnloadAppDomainException::get_InnerException()
		{
		...
		//	Get/Set:HelpLink
		mscorlib::System::String  CannotUnloadAppDomainException::get_HelpLink()
		{
		...
		//	Get/Set:HResult
		mscorlib::System::Int32  CannotUnloadAppDomainException::get_HResult()
		{
		...
		//	Get:Message
		mscorlib::System::String  CannotUnloadAppDomainException::get_Message()
		{
		...
		//	Get/Set:Source
		mscorlib::System::String  CannotUnloadAppDomainException::get_Source()
		{
		...
		//	Get:StackTrace
		mscorlib::System::String  CannotUnloadAppDomainException::get_StackTrace()
		{
		...
		//	Get:TargetSite
		mscorlib::System::Reflection::MethodBase  CannotUnloadAppDomainException::get_TargetSite()
		{
		...
		//	Get:Data
		mscorlib::System::Collections::IDictionary  CannotUnloadAppDomainException::get_Data()
		{
