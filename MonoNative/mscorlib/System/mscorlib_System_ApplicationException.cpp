...
namespace mscorlib
{
	namespace System
	{
		...
		//	Get:InnerException
		mscorlib::System::Exception  ApplicationException::get_InnerException()
		{
		...
		//	Get/Set:HelpLink
		mscorlib::System::String  ApplicationException::get_HelpLink()
		{
		...
		//	Get/Set:HResult
		mscorlib::System::Int32  ApplicationException::get_HResult()
		{
		...
		//	Get:Message
		mscorlib::System::String  ApplicationException::get_Message()
		{
		...
		//	Get/Set:Source
		mscorlib::System::String  ApplicationException::get_Source()
		{
		...
		//	Get:StackTrace
		mscorlib::System::String  ApplicationException::get_StackTrace()
		{
		...
		//	Get:TargetSite
		mscorlib::System::Reflection::MethodBase  ApplicationException::get_TargetSite()
		{
		...
		//	Get:Data
		mscorlib::System::Collections::IDictionary  ApplicationException::get_Data()
		{
