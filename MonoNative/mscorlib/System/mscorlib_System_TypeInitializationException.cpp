...
namespace mscorlib
{
	namespace System
	{
		...
		//	Get:TypeName
		mscorlib::System::String  TypeInitializationException::get_TypeName() const
		{
		...
		//	Get:InnerException
		mscorlib::System::Exception  TypeInitializationException::get_InnerException() const
		{
		...
		//	Get/Set:HelpLink
		mscorlib::System::String  TypeInitializationException::get_HelpLink() const
		{
		...
		//	Get/Set:HResult
		mscorlib::System::Int32  TypeInitializationException::get_HResult() const
		{
		...
		//	Get:Message
		mscorlib::System::String  TypeInitializationException::get_Message() const
		{
		...
		//	Get/Set:Source
		mscorlib::System::String  TypeInitializationException::get_Source() const
		{
		...
		//	Get:StackTrace
		mscorlib::System::String  TypeInitializationException::get_StackTrace() const
		{
		...
		//	Get:TargetSite
		mscorlib::System::Reflection::MethodBase  TypeInitializationException::get_TargetSite() const
		{
		...
		//	Get:Data
		mscorlib::System::Collections::IDictionary  TypeInitializationException::get_Data() const
		{
