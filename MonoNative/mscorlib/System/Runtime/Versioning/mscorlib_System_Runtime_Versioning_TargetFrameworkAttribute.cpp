	...
	namespace System
	{
		namespace Runtime
		{
			namespace Versioning
			{
				...
				mscorlib::System::String  TargetFrameworkAttribute::get_FrameworkName()
				{
				...
				mscorlib::System::String  TargetFrameworkAttribute::get_FrameworkDisplayName()
				{
				...
				//	Get:TypeId
				mscorlib::System::Object  TargetFrameworkAttribute::get_TypeId()
				{
