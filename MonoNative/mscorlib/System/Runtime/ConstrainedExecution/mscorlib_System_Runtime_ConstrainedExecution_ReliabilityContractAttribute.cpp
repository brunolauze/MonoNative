		...
		namespace Runtime
		{
			namespace ConstrainedExecution
			{
				...
				mscorlib::System::Runtime::ConstrainedExecution::Cer::__ENUM__  ReliabilityContractAttribute::get_Cer() const
				{
					...
					return static_cast<mscorlib::System::Runtime::ConstrainedExecution::Cer::__ENUM__>(*(mscorlib::System::Int32*)mono_object_unbox(__result__));
				}
				...
				mscorlib::System::Runtime::ConstrainedExecution::Consistency::__ENUM__  ReliabilityContractAttribute::get_ConsistencyGuarantee() const
				{
					...
					return static_cast<mscorlib::System::Runtime::ConstrainedExecution::Consistency::__ENUM__>(*(mscorlib::System::Int32*)mono_object_unbox(__result__));
				}
