	...
	namespace System
	{
		namespace Runtime
		{
			namespace CompilerServices
			{
				...
				//	Get:PropertyName
				mscorlib::System::String  AccessedThroughPropertyAttribute::get_PropertyName() const
				{
				...
				//	Get:TypeId
				mscorlib::System::Object  AccessedThroughPropertyAttribute::get_TypeId() const
				{
