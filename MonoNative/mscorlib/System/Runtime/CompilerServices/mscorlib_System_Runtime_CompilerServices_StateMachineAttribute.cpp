	...
	namespace System
	{
		namespace Runtime
		{
			namespace CompilerServices
			{
				...
				mscorlib::System::Type  StateMachineAttribute::get_StateMachineType() const
				{
				...
				void StateMachineAttribute::set_StateMachineType(mscorlib::System::Type  value)
				{
				...
				//	Get:TypeId
				mscorlib::System::Object  StateMachineAttribute::get_TypeId() const
				{
