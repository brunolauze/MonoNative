		...
		namespace Runtime
		{
			namespace CompilerServices
			{
				...
				public:
					...
					bool operator==(AsyncTaskMethodBuilderBase &value) { return mscorlib::System::Object::Equals(value); };
					...
					void  AwaitOnCompleted(TAwaiter awaiter, TStateMachine stateMachine)
					{
						...
						Global::InvokeMethod("mscorlib", "System.Runtime.CompilerServices", "AsyncTaskMethodBuilder", 0, NULL, "AwaitOnCompleted", __native_object__, 2, __generic_types__, 2, __parameter_types__, __parameters__, NULL);
					};
					...
					void  AwaitUnsafeOnCompleted(TAwaiter awaiter, TStateMachine stateMachine)
					{
						...
						__generic_types__[0] = Global::GetType(typeid(TAwaiter).name());
						__generic_types__[1] = Global::GetType(typeid(TStateMachine).name());
						Global::InvokeMethod("mscorlib", "System.Runtime.CompilerServices", "AsyncTaskMethodBuilder", 0, NULL, "AwaitUnsafeOnCompleted", __native_object__, 2, __generic_types__, 2, __parameter_types__, __parameters__, NULL);
					};
					...
					void  Start(TStateMachine stateMachine)
					{
						...
						Global::InvokeMethod("mscorlib", "System.Runtime.CompilerServices", "AsyncTaskMethodBuilder", 0, NULL, "Start", __native_object__, 1, __generic_types__, 1, __parameter_types__, __parameters__, NULL);
					};
