	...
	namespace System
	{
		namespace Runtime
		{
			namespace CompilerServices
			{
				...
				mscorlib::System::Int32  CompilationRelaxationsAttribute::get_CompilationRelaxations() const
				{
				...
				//	Get:TypeId
				mscorlib::System::Object  CompilationRelaxationsAttribute::get_TypeId() const
				{
