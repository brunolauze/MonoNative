...
namespace mscorlib
{
	namespace System
	{
		namespace Runtime
		{
			...
			mscorlib::System::String  AssemblyTargetedPatchBandAttribute::get_TargetedPatchBand() const
			{
			...
			//	Get:TypeId
			mscorlib::System::Object  AssemblyTargetedPatchBandAttribute::get_TypeId() const
			{
