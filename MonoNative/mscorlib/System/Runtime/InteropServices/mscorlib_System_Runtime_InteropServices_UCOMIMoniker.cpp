	...
	namespace System
	{
		namespace Runtime
		{
			namespace InteropServices
			{
				...
				void UCOMIMoniker::ParseDisplayName(mscorlib::System::Runtime::InteropServices::UCOMIBindCtx pbc, mscorlib::System::Runtime::InteropServices::UCOMIMoniker pmkToLeft, const char *pszDisplayName, mscorlib::System::Int32 pchEaten, mscorlib::System::Runtime::InteropServices::UCOMIMoniker ppmkOut)
				{
						MonoType *__parameter_types__[5];
						void *__parameters__[5];
						__parameter_types__[0] = Global::GetType(typeid(pbc).name());
