	...
	namespace System
	{
		namespace Runtime
		{
			namespace InteropServices
			{
				...
				//	Get:ErrorCode
				mscorlib::System::Int32  COMException::get_ErrorCode()
				{
				...
				//	Get:InnerException
				mscorlib::System::Exception  COMException::get_InnerException()
				{
				...
				//	Get/Set:HelpLink
				mscorlib::System::String  COMException::get_HelpLink()
				{
				...
				//	Get/Set:HResult
				mscorlib::System::Int32  COMException::get_HResult()
				{
				...
				//	Get:Message
				mscorlib::System::String  COMException::get_Message()
				{
				...
				//	Get/Set:Source
				mscorlib::System::String  COMException::get_Source()
				{
				...
				//	Get:StackTrace
				mscorlib::System::String  COMException::get_StackTrace()
				{
				...
				//	Get:TargetSite
				mscorlib::System::Reflection::MethodBase  COMException::get_TargetSite()
				{
				...
				//	Get:Data
				mscorlib::System::Collections::IDictionary  COMException::get_Data()
				{
