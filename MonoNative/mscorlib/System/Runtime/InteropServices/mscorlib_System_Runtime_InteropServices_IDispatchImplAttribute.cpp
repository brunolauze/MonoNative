		...
		namespace Runtime
		{
			namespace InteropServices
			{
				...
				mscorlib::System::Runtime::InteropServices::IDispatchImplType::__ENUM__  IDispatchImplAttribute::get_Value() const
				{
					...
					return static_cast<mscorlib::System::Runtime::InteropServices::IDispatchImplType::__ENUM__>(*(mscorlib::System::Runtime::InteropServices::IDispatchImplType::__ENUM__*)mono_object_unbox(__result__));
				}
