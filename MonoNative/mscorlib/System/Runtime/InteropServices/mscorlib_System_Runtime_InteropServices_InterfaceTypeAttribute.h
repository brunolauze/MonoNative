		...
		namespace Runtime
		{
			namespace InteropServices
			{
				...
				public:
					...
					bool operator==(InterfaceTypeAttribute &value) { return mscorlib::System::Object::Equals(value); };
					...
					//	Get:Value
					mscorlib::System::Runtime::InteropServices::ComInterfaceType::__ENUM__  get_Value() const;
