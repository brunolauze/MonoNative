	...
	namespace System
	{
		namespace Runtime
		{
			namespace InteropServices
			{
				...
				//	Get:InnerException
				mscorlib::System::Exception  InvalidComObjectException::get_InnerException()
				{
				...
				//	Get/Set:HelpLink
				mscorlib::System::String  InvalidComObjectException::get_HelpLink()
				{
				...
				//	Get/Set:HResult
				mscorlib::System::Int32  InvalidComObjectException::get_HResult()
				{
				...
				//	Get:Message
				mscorlib::System::String  InvalidComObjectException::get_Message()
				{
				...
				//	Get/Set:Source
				mscorlib::System::String  InvalidComObjectException::get_Source()
				{
				...
				//	Get:StackTrace
				mscorlib::System::String  InvalidComObjectException::get_StackTrace()
				{
				...
				//	Get:TargetSite
				mscorlib::System::Reflection::MethodBase  InvalidComObjectException::get_TargetSite()
				{
				...
				//	Get:Data
				mscorlib::System::Collections::IDictionary  InvalidComObjectException::get_Data()
				{
