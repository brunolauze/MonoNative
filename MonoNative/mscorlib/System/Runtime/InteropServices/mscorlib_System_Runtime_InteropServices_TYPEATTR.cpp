	...
	namespace System
	{
		namespace Runtime
		{
			namespace InteropServices
			{
				...
				void TYPEATTR::set_typekind(mscorlib::System::Runtime::InteropServices::TYPEKIND::__ENUM__  value)
				{
				}
				...
				void TYPEATTR::set_wTypeFlags(mscorlib::System::Runtime::InteropServices::TYPEFLAGS::__ENUM__  value)
				{
				}
				...
				void TYPEATTR::set_tdescAlias(mscorlib::System::Runtime::InteropServices::TYPEDESC  value)
				{
				}
				...
				void TYPEATTR::set_idldescType(mscorlib::System::Runtime::InteropServices::IDLDESC  value)
				{
				}
				...
				{
					return Global::GetFieldInt32Value("mscorlib", "System.Runtime.InteropServices", "TYPEATTR", 0, NULL, "MEMBER_ID_NIL");
				}
