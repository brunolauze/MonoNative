	...
	namespace System
	{
		namespace Runtime
		{
			namespace InteropServices
			{
				...
				//	Get:Scope
				mscorlib::System::String  TypeIdentifierAttribute::get_Scope() const
				{
				...
				//	Get:Identifier
				mscorlib::System::String  TypeIdentifierAttribute::get_Identifier() const
				{
				...
				//	Get:TypeId
				mscorlib::System::Object  TypeIdentifierAttribute::get_TypeId() const
				{
