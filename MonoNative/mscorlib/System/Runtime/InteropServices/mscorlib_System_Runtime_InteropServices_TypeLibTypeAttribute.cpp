	...
	namespace System
	{
		namespace Runtime
		{
			namespace InteropServices
			{
				...
				//	Get:Value
				mscorlib::System::Runtime::InteropServices::TypeLibTypeFlags::__ENUM__  TypeLibTypeAttribute::get_Value()
				{
				...
				//	Get:TypeId
				mscorlib::System::Object  TypeLibTypeAttribute::get_TypeId()
				{
