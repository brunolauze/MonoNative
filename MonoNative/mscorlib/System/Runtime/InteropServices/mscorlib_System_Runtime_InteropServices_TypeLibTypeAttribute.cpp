		...
		namespace Runtime
		{
			namespace InteropServices
			{
				...
				mscorlib::System::Runtime::InteropServices::TypeLibTypeFlags::__ENUM__  TypeLibTypeAttribute::get_Value() const
				{
					...
					return static_cast<mscorlib::System::Runtime::InteropServices::TypeLibTypeFlags::__ENUM__>(*(mscorlib::System::Runtime::InteropServices::TypeLibTypeFlags::__ENUM__*)mono_object_unbox(__result__));
				}
