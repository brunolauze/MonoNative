	...
	namespace System
	{
		namespace Runtime
		{
			namespace InteropServices
			{
				...
				//	Get:InnerException
				mscorlib::System::Exception  SafeArrayRankMismatchException::get_InnerException()
				{
				...
				//	Get/Set:HelpLink
				mscorlib::System::String  SafeArrayRankMismatchException::get_HelpLink()
				{
				...
				//	Get/Set:HResult
				mscorlib::System::Int32  SafeArrayRankMismatchException::get_HResult()
				{
				...
				//	Get:Message
				mscorlib::System::String  SafeArrayRankMismatchException::get_Message()
				{
				...
				//	Get/Set:Source
				mscorlib::System::String  SafeArrayRankMismatchException::get_Source()
				{
				...
				//	Get:StackTrace
				mscorlib::System::String  SafeArrayRankMismatchException::get_StackTrace()
				{
				...
				//	Get:TargetSite
				mscorlib::System::Reflection::MethodBase  SafeArrayRankMismatchException::get_TargetSite()
				{
				...
				//	Get:Data
				mscorlib::System::Collections::IDictionary  SafeArrayRankMismatchException::get_Data()
				{
