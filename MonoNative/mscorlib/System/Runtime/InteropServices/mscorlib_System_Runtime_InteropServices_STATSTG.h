		...
		namespace Runtime
		{
			namespace InteropServices
			{
				...
				public:
					...
					//	Get/Set:mtime
					mscorlib::System::Runtime::InteropServices::FILETIME  get_mtime();
					void set_mtime(mscorlib::System::Runtime::InteropServices::FILETIME  value);

					//	Get/Set:ctime
					mscorlib::System::Runtime::InteropServices::FILETIME  get_ctime();
					void set_ctime(mscorlib::System::Runtime::InteropServices::FILETIME  value);

					//	Get/Set:atime
					mscorlib::System::Runtime::InteropServices::FILETIME  get_atime();
