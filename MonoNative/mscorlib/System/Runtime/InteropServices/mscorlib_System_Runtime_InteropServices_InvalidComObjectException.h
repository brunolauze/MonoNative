#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_RUNTIME_INTEROPSERVICES_INVALIDCOMOBJECTEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_RUNTIME_INTEROPSERVICES_INVALIDCOMOBJECTEXCEPTION_H
		...
		namespace Runtime
		{
			namespace InteropServices
			{
				...
				public:
					...
					: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Runtime.InteropServices.InvalidComObjectException"))
					, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						__native_object__ = Global::New("mscorlib", "System.Runtime.InteropServices", "InvalidComObjectException");
					};
					...
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Runtime.InteropServices", "InvalidComObjectException", 1, __parameter_types__, __parameters__);
					};
					...
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Runtime.InteropServices", "InvalidComObjectException", 2, __parameter_types__, __parameters__);
					};
				
					InvalidComObjectException(mscorlib::NativeTypeInfo *nativeTypeInfo)
					...
					InvalidComObjectException(MonoObject *nativeObject)
					...
					InvalidComObjectException & operator=(InvalidComObjectException &value) { __native_object__ = value.GetNativeObject(); return value; };
					bool operator==(InvalidComObjectException &value) { return mscorlib::System::Object::Equals(value); };
