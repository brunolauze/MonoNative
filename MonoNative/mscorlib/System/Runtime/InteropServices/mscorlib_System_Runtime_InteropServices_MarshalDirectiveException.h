#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_RUNTIME_INTEROPSERVICES_MARSHALDIRECTIVEEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_RUNTIME_INTEROPSERVICES_MARSHALDIRECTIVEEXCEPTION_H
		...
		namespace Runtime
		{
			namespace InteropServices
			{
				...
				public:
					...
					: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Runtime.InteropServices.MarshalDirectiveException"))
					, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						__native_object__ = Global::New("mscorlib", "System.Runtime.InteropServices", "MarshalDirectiveException");
					};
					...
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Runtime.InteropServices", "MarshalDirectiveException", 1, __parameter_types__, __parameters__);
					};
					...
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Runtime.InteropServices", "MarshalDirectiveException", 2, __parameter_types__, __parameters__);
					};
				
					MarshalDirectiveException(mscorlib::NativeTypeInfo *nativeTypeInfo)
					...
					MarshalDirectiveException(MonoObject *nativeObject)
					...
					MarshalDirectiveException & operator=(MarshalDirectiveException &value) { __native_object__ = value.GetNativeObject(); return value; };
					bool operator==(MarshalDirectiveException &value) { return mscorlib::System::Object::Equals(value); };
