	...
	namespace System
	{
		namespace Runtime
		{
			namespace InteropServices
			{
				...
				//	Get:InnerException
				mscorlib::System::Exception  SafeArrayTypeMismatchException::get_InnerException()
				{
				...
				//	Get/Set:HelpLink
				mscorlib::System::String  SafeArrayTypeMismatchException::get_HelpLink()
				{
				...
				//	Get/Set:HResult
				mscorlib::System::Int32  SafeArrayTypeMismatchException::get_HResult()
				{
				...
				//	Get:Message
				mscorlib::System::String  SafeArrayTypeMismatchException::get_Message()
				{
				...
				//	Get/Set:Source
				mscorlib::System::String  SafeArrayTypeMismatchException::get_Source()
				{
				...
				//	Get:StackTrace
				mscorlib::System::String  SafeArrayTypeMismatchException::get_StackTrace()
				{
				...
				//	Get:TargetSite
				mscorlib::System::Reflection::MethodBase  SafeArrayTypeMismatchException::get_TargetSite()
				{
				...
				//	Get:Data
				mscorlib::System::Collections::IDictionary  SafeArrayTypeMismatchException::get_Data()
				{
