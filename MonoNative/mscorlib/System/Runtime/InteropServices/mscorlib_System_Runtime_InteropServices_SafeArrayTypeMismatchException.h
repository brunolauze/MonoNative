#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_RUNTIME_INTEROPSERVICES_SAFEARRAYTYPEMISMATCHEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_RUNTIME_INTEROPSERVICES_SAFEARRAYTYPEMISMATCHEXCEPTION_H
		...
		namespace Runtime
		{
			namespace InteropServices
			{
				...
				public:
					...
					: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Runtime.InteropServices.SafeArrayTypeMismatchException"))
					, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						__native_object__ = Global::New("mscorlib", "System.Runtime.InteropServices", "SafeArrayTypeMismatchException");
					};
					...
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Runtime.InteropServices", "SafeArrayTypeMismatchException", 1, __parameter_types__, __parameters__);
					};
					...
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Runtime.InteropServices", "SafeArrayTypeMismatchException", 2, __parameter_types__, __parameters__);
					};
				
					SafeArrayTypeMismatchException(mscorlib::NativeTypeInfo *nativeTypeInfo)
					...
					SafeArrayTypeMismatchException(MonoObject *nativeObject)
					...
					SafeArrayTypeMismatchException & operator=(SafeArrayTypeMismatchException &value) { __native_object__ = value.GetNativeObject(); return value; };
					bool operator==(SafeArrayTypeMismatchException &value) { return mscorlib::System::Object::Equals(value); };
