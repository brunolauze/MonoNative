#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_RUNTIME_INTEROPSERVICES__METHODBASE_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_RUNTIME_INTEROPSERVICES__METHODBASE_H
	...
	namespace System
	{
		namespace Runtime
		{
			namespace InteropServices
			{
				...
				{
				public:
					_MethodBase(MonoObject *nativeObject)
					{
						__mscorlib_System_Runtime_InteropServices__MethodBase = nativeObject;
					};
					...
					_MethodBase & operator=(_MethodBase &value) { __mscorlib_System_Runtime_InteropServices__MethodBase = value.__mscorlib_System_Runtime_InteropServices__MethodBase; return value; };
					operator MonoObject*() { return __mscorlib_System_Runtime_InteropServices__MethodBase; };
					MonoObject* operator=(MonoObject* value) { __mscorlib_System_Runtime_InteropServices__MethodBase = value; return value; };
				...
				protected:
					MonoObject *__mscorlib_System_Runtime_InteropServices__MethodBase;
