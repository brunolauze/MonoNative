	...
	namespace System
	{
		namespace Runtime
		{
			namespace InteropServices
			{
				...
				//	Get:Value
				mscorlib::System::Runtime::InteropServices::ComInterfaceType::__ENUM__  InterfaceTypeAttribute::get_Value()
				{
					...
					return *(mscorlib::System::Runtime::InteropServices::ComInterfaceType::__ENUM__*)mono_object_unbox(__result__);
				}


				//	Get:TypeId
				mscorlib::System::Object  InterfaceTypeAttribute::get_TypeId()
				{
