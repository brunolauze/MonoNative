	...
	namespace System
	{
		namespace Runtime
		{
			namespace InteropServices
			{
				...
				//	Get:MajorVersion
				mscorlib::System::Int32  PrimaryInteropAssemblyAttribute::get_MajorVersion()
				{
				...
				//	Get:MinorVersion
				mscorlib::System::Int32  PrimaryInteropAssemblyAttribute::get_MinorVersion()
				{
				...
				//	Get:TypeId
				mscorlib::System::Object  PrimaryInteropAssemblyAttribute::get_TypeId()
				{
