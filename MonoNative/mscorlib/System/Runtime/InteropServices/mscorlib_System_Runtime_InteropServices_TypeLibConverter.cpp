	...
	namespace System
	{
		namespace Runtime
		{
			namespace InteropServices
			{
				...
				//Public Methods
				mscorlib::System::Object TypeLibConverter::ConvertAssemblyToTypeLib(mscorlib::System::Reflection::Assembly assembly, mscorlib::System::String strTypeLibName, mscorlib::System::Runtime::InteropServices::TypeLibExporterFlags::__ENUM__ flags, mscorlib::System::Runtime::InteropServices::ITypeLibExporterNotifySink notifySink)
				{
						MonoType *__parameter_types__[4];
						void *__parameters__[4];
						__parameter_types__[0] = Global::GetType(typeid(assembly).name());
						__parameter_types__[1] = Global::GetType(typeid(strTypeLibName).name());
						...
						__parameters__[1] = (MonoObject*)strTypeLibName;
						mscorlib::System::Int32 __param_flags__ = flags;
						__parameters__[2] = &__param_flags__;
						__parameters__[3] = (MonoObject*)notifySink;
						MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Runtime.InteropServices", "TypeLibConverter", 0, NULL, "ConvertAssemblyToTypeLib", __native_object__, 4, __parameter_types__, __parameters__, NULL);
						return mscorlib::System::Object(__result__);
				}

				mscorlib::System::Object TypeLibConverter::ConvertAssemblyToTypeLib(mscorlib::System::Reflection::Assembly assembly, const char *strTypeLibName, mscorlib::System::Runtime::InteropServices::TypeLibExporterFlags::__ENUM__ flags, mscorlib::System::Runtime::InteropServices::ITypeLibExporterNotifySink notifySink)
				{
						MonoType *__parameter_types__[4];
						void *__parameters__[4];
						__parameter_types__[0] = Global::GetType(typeid(assembly).name());
						...
						__parameter_types__[3] = Global::GetType(typeid(notifySink).name());
						__parameters__[0] = (MonoObject*)assembly;
						__parameters__[1] = mono_string_new(Global::GetDomain(), strTypeLibName);
						mscorlib::System::Int32 __param_flags__ = flags;
						__parameters__[2] = &__param_flags__;
						__parameters__[3] = (MonoObject*)notifySink;
						MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Runtime.InteropServices", "TypeLibConverter", 0, NULL, "ConvertAssemblyToTypeLib", __native_object__, 4, __parameter_types__, __parameters__, NULL);
				...
				mscorlib::System::Reflection::Emit::AssemblyBuilder TypeLibConverter::ConvertTypeLibToAssembly(mscorlib::System::Object typeLib, mscorlib::System::String asmFileName, mscorlib::System::Int32 flags, mscorlib::System::Runtime::InteropServices::ITypeLibImporterNotifySink notifySink, std::vector<mscorlib::System::Byte*> publicKey, mscorlib::System::Reflection::StrongNameKeyPair keyPair, mscorlib::System::Boolean unsafeInterfaces)
				{
						...
						__parameter_types__[2] = Global::GetType(typeid(flags).name());
						__parameter_types__[3] = Global::GetType(typeid(notifySink).name());
						__parameter_types__[4] = mono_class_get_type(mono_array_class_get(mono_class_from_mono_type(Global::GetType("mscorlib", "System", "Byte")), 1));
						...
						__parameters__[1] = (MonoObject*)asmFileName;
						...
						MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Runtime.InteropServices", "TypeLibConverter", 0, NULL, "ConvertTypeLibToAssembly", __native_object__, 7, __parameter_types__, __parameters__, NULL);
				...
				mscorlib::System::Reflection::Emit::AssemblyBuilder TypeLibConverter::ConvertTypeLibToAssembly(mscorlib::System::Object typeLib, mscorlib::System::String asmFileName, mscorlib::System::Runtime::InteropServices::TypeLibImporterFlags::__ENUM__ flags, mscorlib::System::Runtime::InteropServices::ITypeLibImporterNotifySink notifySink, std::vector<mscorlib::System::Byte*> publicKey, mscorlib::System::Reflection::StrongNameKeyPair keyPair, mscorlib::System::String asmNamespace, mscorlib::System::Version asmVersion)
				{
						...
						__parameters__[4] = Global::FromArray<mscorlib::System::Byte*>(publicKey, typeid(mscorlib::System::Byte).name());
						__parameters__[5] = (MonoObject*)keyPair;
						__parameters__[6] = (MonoObject*)asmNamespace;
						__parameters__[7] = (MonoObject*)asmVersion;
						MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Runtime.InteropServices", "TypeLibConverter", 0, NULL, "ConvertTypeLibToAssembly", __native_object__, 8, __parameter_types__, __parameters__, NULL);
						return mscorlib::System::Reflection::Emit::AssemblyBuilder(__result__);
				}
				...
				mscorlib::System::Reflection::Emit::AssemblyBuilder TypeLibConverter::ConvertTypeLibToAssembly(mscorlib::System::Object typeLib, const char *asmFileName, mscorlib::System::Runtime::InteropServices::TypeLibImporterFlags::__ENUM__ flags, mscorlib::System::Runtime::InteropServices::ITypeLibImporterNotifySink notifySink, std::vector<mscorlib::System::Byte*> publicKey, mscorlib::System::Reflection::StrongNameKeyPair keyPair, const char *asmNamespace, mscorlib::System::Version asmVersion)
				{
						...
						__parameter_types__[4] = mono_class_get_type(mono_array_class_get(mono_class_from_mono_type(Global::GetType("mscorlib", "System", "Byte")), 1));
						__parameter_types__[5] = Global::GetType(typeid(keyPair).name());
						__parameter_types__[6] = Global::GetType("mscorlib", "System", "String");
						__parameter_types__[7] = Global::GetType(typeid(asmVersion).name());
						__parameters__[0] = (MonoObject*)typeLib;
						__parameters__[1] = mono_string_new(Global::GetDomain(), asmFileName);
						mscorlib::System::Int32 __param_flags__ = flags;
				...
				mscorlib::System::Boolean TypeLibConverter::GetPrimaryInteropAssembly(mscorlib::System::Guid g, mscorlib::System::Int32 major, mscorlib::System::Int32 minor, mscorlib::System::Int32 lcid, mscorlib::System::String asmName, mscorlib::System::String asmCodeBase)
				{
						...
						MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Runtime.InteropServices", "TypeLibConverter", 0, NULL, "GetPrimaryInteropAssembly", __native_object__, 6, __parameter_types__, __parameters__, NULL);
