	...
	namespace System
	{
		namespace Runtime
		{
			namespace InteropServices
			{
				...
				//	Get:Value
				mscorlib::System::Runtime::InteropServices::ClassInterfaceType::__ENUM__  ClassInterfaceAttribute::get_Value()
				{
					...
					return *(mscorlib::System::Runtime::InteropServices::ClassInterfaceType::__ENUM__*)mono_object_unbox(__result__);
				}


				//	Get:TypeId
				mscorlib::System::Object  ClassInterfaceAttribute::get_TypeId()
				{
