#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_FILETIME_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_FILETIME_H
			...
			namespace InteropServices
			{
				namespace ComTypes
				{
					...
					public:
						...
						bool operator==(FILETIME &value) { return mscorlib::System::Object::Equals(value); };
