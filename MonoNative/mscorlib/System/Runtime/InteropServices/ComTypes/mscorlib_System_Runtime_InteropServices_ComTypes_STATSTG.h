			...
			namespace InteropServices
			{
				namespace ComTypes
				{
					...
					public:
						...
						//	Get/Set:mtime
						mscorlib::System::Runtime::InteropServices::ComTypes::FILETIME  get_mtime() const;
						void set_mtime(mscorlib::System::Runtime::InteropServices::ComTypes::FILETIME  value);

						//	Get/Set:ctime
						mscorlib::System::Runtime::InteropServices::ComTypes::FILETIME  get_ctime() const;
						void set_ctime(mscorlib::System::Runtime::InteropServices::ComTypes::FILETIME  value);

						//	Get/Set:atime
						mscorlib::System::Runtime::InteropServices::ComTypes::FILETIME  get_atime() const;
