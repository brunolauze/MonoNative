			...
			namespace InteropServices
			{
				namespace ComTypes
				{
					...
					public:
						...
						//	Get/Set:funckind
						mscorlib::System::Runtime::InteropServices::ComTypes::FUNCKIND::__ENUM__  get_funckind() const;
						void set_funckind(mscorlib::System::Runtime::InteropServices::ComTypes::FUNCKIND::__ENUM__  value);

						//	Get/Set:invkind
						mscorlib::System::Runtime::InteropServices::ComTypes::INVOKEKIND::__ENUM__  get_invkind() const;
						void set_invkind(mscorlib::System::Runtime::InteropServices::ComTypes::INVOKEKIND::__ENUM__  value);

						//	Get/Set:callconv
						mscorlib::System::Runtime::InteropServices::ComTypes::CALLCONV::__ENUM__  get_callconv() const;
						...
						mscorlib::System::Runtime::InteropServices::ComTypes::ELEMDESC  get_elemdescFunc() const;
