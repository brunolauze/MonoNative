			...
			namespace InteropServices
			{
				namespace ComTypes
				{
					...
					public:
						...
						//	Get/Set:syskind
						mscorlib::System::Runtime::InteropServices::ComTypes::SYSKIND::__ENUM__  get_syskind() const;
						...
						//	Get/Set:wLibFlags
						mscorlib::System::Runtime::InteropServices::ComTypes::LIBFLAGS::__ENUM__  get_wLibFlags() const;
