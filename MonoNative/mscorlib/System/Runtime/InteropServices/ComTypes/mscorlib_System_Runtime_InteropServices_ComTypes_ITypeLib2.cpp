		...
		namespace Runtime
		{
			namespace InteropServices
			{
				namespace ComTypes
				{
					...
					void ITypeLib2::FindName(const char *szNameBuf, mscorlib::System::Int32 lHashVal, std::vector<mscorlib::System::Runtime::InteropServices::ComTypes::ITypeInfo*> ppTInfo, std::vector<mscorlib::System::Int32*> rgMemId, mscorlib::System::Int16 pcFound)
					{
							MonoType *__parameter_types__[5];
							void *__parameters__[5];
					...
					mscorlib::System::Boolean ITypeLib2::IsName(const char *szNameBuf, mscorlib::System::Int32 lHashVal)
					{
							MonoType *__parameter_types__[2];
							void *__parameters__[2];
							__parameter_types__[0] = Global::GetType("mscorlib", "System", "String");
