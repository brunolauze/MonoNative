		...
		namespace Runtime
		{
			namespace InteropServices
			{
				...
				public:
					...
					bool operator==(ComCompatibleVersionAttribute &value) { return mscorlib::System::Object::Equals(value); };
					...
					//	Get:BuildNumber
					mscorlib::System::Int32  get_BuildNumber() const;

					//	Get:RevisionNumber
					mscorlib::System::Int32  get_RevisionNumber() const;
