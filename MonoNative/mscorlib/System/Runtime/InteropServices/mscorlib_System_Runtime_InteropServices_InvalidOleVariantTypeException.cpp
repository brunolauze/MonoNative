	...
	namespace System
	{
		namespace Runtime
		{
			namespace InteropServices
			{
				...
				//	Get:InnerException
				mscorlib::System::Exception  InvalidOleVariantTypeException::get_InnerException()
				{
				...
				//	Get/Set:HelpLink
				mscorlib::System::String  InvalidOleVariantTypeException::get_HelpLink()
				{
				...
				//	Get/Set:HResult
				mscorlib::System::Int32  InvalidOleVariantTypeException::get_HResult()
				{
				...
				//	Get:Message
				mscorlib::System::String  InvalidOleVariantTypeException::get_Message()
				{
				...
				//	Get/Set:Source
				mscorlib::System::String  InvalidOleVariantTypeException::get_Source()
				{
				...
				//	Get:StackTrace
				mscorlib::System::String  InvalidOleVariantTypeException::get_StackTrace()
				{
				...
				//	Get:TargetSite
				mscorlib::System::Reflection::MethodBase  InvalidOleVariantTypeException::get_TargetSite()
				{
				...
				//	Get:Data
				mscorlib::System::Collections::IDictionary  InvalidOleVariantTypeException::get_Data()
				{
