#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_RUNTIME_INTEROPSERVICES_EXTERNALEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_RUNTIME_INTEROPSERVICES_EXTERNALEXCEPTION_H
	...
	namespace System
	{
		namespace Runtime
		{
			namespace InteropServices
			{
				...
				public:
					ExternalException()
					: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Runtime.InteropServices.ExternalException"))
					, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						__native_object__ = Global::New("mscorlib", "System.Runtime.InteropServices", "ExternalException");
					};
					...
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Runtime.InteropServices", "ExternalException", 1, __parameter_types__, __parameters__);
					};
					...
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Runtime.InteropServices", "ExternalException", 2, __parameter_types__, __parameters__);
					};
					...
					ExternalException(mscorlib::NativeTypeInfo *nativeTypeInfo)
					...
					ExternalException(MonoObject *nativeObject)
					...
					ExternalException & operator=(ExternalException &value) { __native_object__ = value.GetNativeObject(); return value; };
					bool operator==(ExternalException &value) { return mscorlib::System::Object::Equals(value); };
