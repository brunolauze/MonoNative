#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_RUNTIME_SERIALIZATION_SERIALIZATIONEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_RUNTIME_SERIALIZATION_SERIALIZATIONEXCEPTION_H
		...
		namespace Runtime
		{
			namespace Serialization
			{
				...
				public:
					...
					: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Runtime.Serialization.SerializationException"))
					, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						__native_object__ = Global::New("mscorlib", "System.Runtime.Serialization", "SerializationException");
					};
					...
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Runtime.Serialization", "SerializationException", 1, __parameter_types__, __parameters__);
					};
					...
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Runtime.Serialization", "SerializationException", 2, __parameter_types__, __parameters__);
					};
				
					SerializationException(mscorlib::NativeTypeInfo *nativeTypeInfo)
					...
					SerializationException(MonoObject *nativeObject)
					...
					SerializationException & operator=(SerializationException &value) { __native_object__ = value.GetNativeObject(); return value; };
					bool operator==(SerializationException &value) { return mscorlib::System::Object::Equals(value); };
