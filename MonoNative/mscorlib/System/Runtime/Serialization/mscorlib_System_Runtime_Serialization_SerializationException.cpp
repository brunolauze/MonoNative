	...
	namespace System
	{
		namespace Runtime
		{
			namespace Serialization
			{
				...
				//	Get:InnerException
				mscorlib::System::Exception  SerializationException::get_InnerException()
				{
				...
				//	Get/Set:HelpLink
				mscorlib::System::String  SerializationException::get_HelpLink()
				{
				...
				//	Get/Set:HResult
				mscorlib::System::Int32  SerializationException::get_HResult()
				{
				...
				//	Get:Message
				mscorlib::System::String  SerializationException::get_Message()
				{
				...
				//	Get/Set:Source
				mscorlib::System::String  SerializationException::get_Source()
				{
				...
				//	Get:StackTrace
				mscorlib::System::String  SerializationException::get_StackTrace()
				{
				...
				//	Get:TargetSite
				mscorlib::System::Reflection::MethodBase  SerializationException::get_TargetSite()
				{
				...
				//	Get:Data
				mscorlib::System::Collections::IDictionary  SerializationException::get_Data()
				{
