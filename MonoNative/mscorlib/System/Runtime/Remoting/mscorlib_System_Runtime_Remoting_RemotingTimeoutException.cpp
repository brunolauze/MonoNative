	...
	namespace System
	{
		namespace Runtime
		{
			namespace Remoting
			{
				...
				//	Get:InnerException
				mscorlib::System::Exception  RemotingTimeoutException::get_InnerException()
				{
				...
				//	Get/Set:HelpLink
				mscorlib::System::String  RemotingTimeoutException::get_HelpLink()
				{
				...
				//	Get/Set:HResult
				mscorlib::System::Int32  RemotingTimeoutException::get_HResult()
				{
				...
				//	Get:Message
				mscorlib::System::String  RemotingTimeoutException::get_Message()
				{
				...
				//	Get/Set:Source
				mscorlib::System::String  RemotingTimeoutException::get_Source()
				{
				...
				//	Get:StackTrace
				mscorlib::System::String  RemotingTimeoutException::get_StackTrace()
				{
				...
				//	Get:TargetSite
				mscorlib::System::Reflection::MethodBase  RemotingTimeoutException::get_TargetSite()
				{
				...
				//	Get:Data
				mscorlib::System::Collections::IDictionary  RemotingTimeoutException::get_Data()
				{
