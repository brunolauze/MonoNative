#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_RUNTIME_REMOTING_SERVEREXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_RUNTIME_REMOTING_SERVEREXCEPTION_H
	...
	namespace System
	{
		namespace Runtime
		{
			namespace Remoting
			{
				...
				public:
					ServerException()
					: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Runtime.Remoting.ServerException"))
					, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						__native_object__ = Global::New("mscorlib", "System.Runtime.Remoting", "ServerException");
					};
					...
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Runtime.Remoting", "ServerException", 1, __parameter_types__, __parameters__);
					};
					...
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Runtime.Remoting", "ServerException", 2, __parameter_types__, __parameters__);
					};
				
					ServerException(mscorlib::NativeTypeInfo *nativeTypeInfo)
					...
					ServerException(MonoObject *nativeObject)
					...
					ServerException & operator=(ServerException &value) { __native_object__ = value.GetNativeObject(); return value; };
					bool operator==(ServerException &value) { return mscorlib::System::Object::Equals(value); };
