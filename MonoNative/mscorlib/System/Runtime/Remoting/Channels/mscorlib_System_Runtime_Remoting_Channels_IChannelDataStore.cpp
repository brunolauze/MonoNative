		...
		namespace Runtime
		{
			namespace Remoting
			{
				namespace Channels
				{
					...
					//	Get:ChannelUris
					std::vector<mscorlib::System::String*>  IChannelDataStore::get_ChannelUris() const
					{
					...
					//	Get/Set:Item
					mscorlib::System::Object  IChannelDataStore::get_Item(mscorlib::System::Object key) const
					{
