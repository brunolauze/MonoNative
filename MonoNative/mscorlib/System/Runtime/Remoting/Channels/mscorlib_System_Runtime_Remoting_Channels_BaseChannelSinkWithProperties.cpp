		...
		namespace Runtime
		{
			namespace Remoting
			{
				namespace Channels
				{
					...
					//	Get:Count
					mscorlib::System::Int32  BaseChannelSinkWithProperties::get_Count()
					{
					...
					//	Get:IsFixedSize
					mscorlib::System::Boolean  BaseChannelSinkWithProperties::get_IsFixedSize()
					{
					...
					//	Get:IsReadOnly
					mscorlib::System::Boolean  BaseChannelSinkWithProperties::get_IsReadOnly()
					{
					...
					//	Get:IsSynchronized
					mscorlib::System::Boolean  BaseChannelSinkWithProperties::get_IsSynchronized()
					{
					...
					//	Get/Set:Item
					mscorlib::System::Object  BaseChannelSinkWithProperties::get_Item(mscorlib::System::Object key)
					{
					...
					//	Get:Keys
					mscorlib::System::Collections::ICollection  BaseChannelSinkWithProperties::get_Keys()
					{
					...
					//	Get:Properties
					mscorlib::System::Collections::IDictionary  BaseChannelSinkWithProperties::get_Properties()
					{
					...
					//	Get:SyncRoot
					mscorlib::System::Object  BaseChannelSinkWithProperties::get_SyncRoot()
					{
					...
					//	Get:Values
					mscorlib::System::Collections::ICollection  BaseChannelSinkWithProperties::get_Values()
					{
