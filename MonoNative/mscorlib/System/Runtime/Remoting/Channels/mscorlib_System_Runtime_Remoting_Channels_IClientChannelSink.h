			...
			namespace Remoting
			{
				namespace Channels
				{
					...
					public:
						...
						MonoObject* get___mscorlib_System_Runtime_Remoting_Channels_IClientChannelSink() const
						{
						...
						//	Get:NextChannelSink
						mscorlib::System::Runtime::Remoting::Channels::IClientChannelSink  get_NextChannelSink() const;
