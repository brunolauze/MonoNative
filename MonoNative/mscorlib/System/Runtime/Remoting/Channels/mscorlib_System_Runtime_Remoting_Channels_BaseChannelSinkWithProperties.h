#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_RUNTIME_REMOTING_CHANNELS_BASECHANNELSINKWITHPROPERTIES_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_RUNTIME_REMOTING_CHANNELS_BASECHANNELSINKWITHPROPERTIES_H
		...
		namespace Runtime
		{
			namespace Remoting
			{
				namespace Channels
				{
					...
					{
					public:
						BaseChannelSinkWithProperties(mscorlib::NativeTypeInfo *nativeTypeInfo)
						...
						BaseChannelSinkWithProperties(MonoObject *nativeObject)
						...
						BaseChannelSinkWithProperties & operator=(BaseChannelSinkWithProperties &value) { __native_object__ = value.GetNativeObject(); return value; };
						bool operator==(BaseChannelSinkWithProperties &value) { return mscorlib::System::Object::Equals(value); };
