		...
		namespace Runtime
		{
			namespace Remoting
			{
				namespace Messaging
				{
					...
					//	Get:ArgCount
					mscorlib::System::Int32  MethodResponse::get_ArgCount()
					{
					...
					//	Get:Args
					std::vector<mscorlib::System::Object*>  MethodResponse::get_Args()
					{
					...
					//	Get:Exception
					mscorlib::System::Exception  MethodResponse::get_Exception()
					{
					...
					//	Get:HasVarArgs
					mscorlib::System::Boolean  MethodResponse::get_HasVarArgs()
					{
					...
					mscorlib::System::Runtime::Remoting::Messaging::LogicalCallContext  MethodResponse::get_LogicalCallContext()
					{
					...
					//	Get:MethodBase
					mscorlib::System::Reflection::MethodBase  MethodResponse::get_MethodBase()
					{
					...
					//	Get:MethodName
					mscorlib::System::String  MethodResponse::get_MethodName()
					{
					...
					//	Get:MethodSignature
					mscorlib::System::Object  MethodResponse::get_MethodSignature()
					{
					...
					//	Get:OutArgCount
					mscorlib::System::Int32  MethodResponse::get_OutArgCount()
					{
					...
					//	Get:OutArgs
					std::vector<mscorlib::System::Object*>  MethodResponse::get_OutArgs()
					{
					...
					//	Get:Properties
					mscorlib::System::Collections::IDictionary  MethodResponse::get_Properties()
					{
					...
					//	Get:ReturnValue
					mscorlib::System::Object  MethodResponse::get_ReturnValue()
					{
					...
					//	Get:TypeName
					mscorlib::System::String  MethodResponse::get_TypeName()
					{
					...
					//	Get/Set:Uri
					mscorlib::System::String  MethodResponse::get_Uri()
					{
