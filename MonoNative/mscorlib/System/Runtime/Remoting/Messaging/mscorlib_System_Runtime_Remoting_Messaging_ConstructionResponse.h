				...
				namespace Messaging
				{
					...
					public:
						...
						, mscorlib::System::Runtime::Remoting::Messaging::IMessage(NULL)
						{
							...
							__parameters__[0] = Global::FromArray<mscorlib::System::Runtime::Remoting::Messaging::Header*>(h, "mscorlib", "System.Runtime.Remoting.Messaging", "Header");
						...
						bool operator==(ConstructionResponse &value) { return mscorlib::System::Object::Equals(value); };
