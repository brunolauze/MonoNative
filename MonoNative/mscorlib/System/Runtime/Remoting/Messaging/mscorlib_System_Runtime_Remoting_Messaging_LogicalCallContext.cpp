		...
		namespace Runtime
		{
			namespace Remoting
			{
				namespace Messaging
				{
					...
					void LogicalCallContext::FreeNamedDataSlot(const char *name)
					{
							MonoType *__parameter_types__[1];
							void *__parameters__[1];
							__parameter_types__[0] = Global::GetType(typeid(name).name());
					...
					mscorlib::System::Object LogicalCallContext::GetData(const char *name)
					{
							MonoType *__parameter_types__[1];
							void *__parameters__[1];
							__parameter_types__[0] = Global::GetType(typeid(name).name());
					...
					void LogicalCallContext::SetData(const char *name, mscorlib::System::Object data)
					{
							MonoType *__parameter_types__[2];
							void *__parameters__[2];
							__parameter_types__[0] = Global::GetType(typeid(name).name());
