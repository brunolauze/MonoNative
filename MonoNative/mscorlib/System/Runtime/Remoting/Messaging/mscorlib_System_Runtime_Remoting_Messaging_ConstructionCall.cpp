		...
		namespace Runtime
		{
			namespace Remoting
			{
				namespace Messaging
				{
					...
					//	Get:ActivationType
					mscorlib::System::Type  ConstructionCall::get_ActivationType()
					{
					...
					mscorlib::System::String  ConstructionCall::get_ActivationTypeName()
					{
					...
					//	Get/Set:Activator
					mscorlib::System::Runtime::Remoting::Activation::IActivator  ConstructionCall::get_Activator()
					{
					...
					std::vector<mscorlib::System::Object*>  ConstructionCall::get_CallSiteActivationAttributes()
					{
					...
					mscorlib::System::Collections::IList  ConstructionCall::get_ContextProperties()
					{
					...
					//	Get:Properties
					mscorlib::System::Collections::IDictionary  ConstructionCall::get_Properties()
					{
					...
					//	Get:ArgCount
					mscorlib::System::Int32  ConstructionCall::get_ArgCount()
					{
					...
					//	Get:Args
					std::vector<mscorlib::System::Object*>  ConstructionCall::get_Args()
					{
					...
					//	Get:HasVarArgs
					mscorlib::System::Boolean  ConstructionCall::get_HasVarArgs()
					{
					...
					//	Get:InArgCount
					mscorlib::System::Int32  ConstructionCall::get_InArgCount()
					{
					...
					//	Get:InArgs
					std::vector<mscorlib::System::Object*>  ConstructionCall::get_InArgs()
					{
					...
					mscorlib::System::Runtime::Remoting::Messaging::LogicalCallContext  ConstructionCall::get_LogicalCallContext()
					{
					...
					//	Get:MethodBase
					mscorlib::System::Reflection::MethodBase  ConstructionCall::get_MethodBase()
					{
					...
					//	Get:MethodName
					mscorlib::System::String  ConstructionCall::get_MethodName()
					{
					...
					//	Get:MethodSignature
					mscorlib::System::Object  ConstructionCall::get_MethodSignature()
					{
					...
					//	Get:TypeName
					mscorlib::System::String  ConstructionCall::get_TypeName()
					{
					...
					//	Get/Set:Uri
					mscorlib::System::String  ConstructionCall::get_Uri()
					{
