	...
	namespace System
	{
		namespace Runtime
		{
			namespace Remoting
			{
				...
				//	Get:InnerException
				mscorlib::System::Exception  RemotingException::get_InnerException()
				{
				...
				//	Get/Set:HelpLink
				mscorlib::System::String  RemotingException::get_HelpLink()
				{
				...
				//	Get/Set:HResult
				mscorlib::System::Int32  RemotingException::get_HResult()
				{
				...
				//	Get:Message
				mscorlib::System::String  RemotingException::get_Message()
				{
				...
				//	Get/Set:Source
				mscorlib::System::String  RemotingException::get_Source()
				{
				...
				//	Get:StackTrace
				mscorlib::System::String  RemotingException::get_StackTrace()
				{
				...
				//	Get:TargetSite
				mscorlib::System::Reflection::MethodBase  RemotingException::get_TargetSite()
				{
				...
				//	Get:Data
				mscorlib::System::Collections::IDictionary  RemotingException::get_Data()
				{
