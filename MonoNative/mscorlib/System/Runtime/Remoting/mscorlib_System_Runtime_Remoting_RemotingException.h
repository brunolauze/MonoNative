#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_RUNTIME_REMOTING_REMOTINGEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_RUNTIME_REMOTING_REMOTINGEXCEPTION_H
	...
	namespace System
	{
		namespace Runtime
		{
			namespace Remoting
			{
				...
				public:
					RemotingException()
					: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Runtime.Remoting.RemotingException"))
					, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						__native_object__ = Global::New("mscorlib", "System.Runtime.Remoting", "RemotingException");
					};
					...
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Runtime.Remoting", "RemotingException", 1, __parameter_types__, __parameters__);
					};
					...
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Runtime.Remoting", "RemotingException", 2, __parameter_types__, __parameters__);
					};
				
					RemotingException(mscorlib::NativeTypeInfo *nativeTypeInfo)
					...
					RemotingException(MonoObject *nativeObject)
					...
					RemotingException & operator=(RemotingException &value) { __native_object__ = value.GetNativeObject(); return value; };
					bool operator==(RemotingException &value) { return mscorlib::System::Object::Equals(value); };
