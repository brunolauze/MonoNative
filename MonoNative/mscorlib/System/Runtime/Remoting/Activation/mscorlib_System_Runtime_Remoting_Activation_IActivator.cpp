			...
			namespace Remoting
			{
				namespace Activation
				{
					...
					mscorlib::System::Runtime::Remoting::Activation::ActivatorLevel::__ENUM__  IActivator::get_Level() const
					{
						...
						return static_cast<mscorlib::System::Runtime::Remoting::Activation::ActivatorLevel::__ENUM__>(*(mscorlib::System::Runtime::Remoting::Activation::ActivatorLevel::__ENUM__*)mono_object_unbox(__result__));
					}
