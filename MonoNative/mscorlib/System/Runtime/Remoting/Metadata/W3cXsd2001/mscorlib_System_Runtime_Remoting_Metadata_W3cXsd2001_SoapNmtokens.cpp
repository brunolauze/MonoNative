			...
			namespace Remoting
			{
				namespace Metadata
				{
					namespace W3cXsd2001
					{
						...
						Property<mscorlib::System::String , mscorlib::System::Runtime::Remoting::Metadata::W3cXsd2001::SoapNmtokens> mscorlib::System::Runtime::Remoting::Metadata::W3cXsd2001::SoapNmtokens::XsdType(&mscorlib::System::Runtime::Remoting::Metadata::W3cXsd2001::SoapNmtokens::get_XsdType, &mscorlib::System::Runtime::Remoting::Metadata::W3cXsd2001::SoapNmtokens::set_XsdType);
						//Public Methods
						...
						mscorlib::System::Runtime::Remoting::Metadata::W3cXsd2001::SoapNmtokens SoapNmtokens::Parse(const char *value)
						{
								MonoType *__parameter_types__[1];
								void *__parameters__[1];
								__parameter_types__[0] = Global::GetType(typeid(value).name());
						...
						//	Get/Set:Value
						mscorlib::System::String  SoapNmtokens::get_Value() const
						{
						...
						void SoapNmtokens::set_XsdType(mscorlib::System::String  value)
						{
							throw;
						}
