			...
			namespace Remoting
			{
				namespace Metadata
				{
					...
					mscorlib::System::Runtime::Remoting::Metadata::SoapOption::__ENUM__  SoapTypeAttribute::get_SoapOptions() const
					{
						...
						return static_cast<mscorlib::System::Runtime::Remoting::Metadata::SoapOption::__ENUM__>(*(mscorlib::System::Int32*)mono_object_unbox(__result__));
					}
					...
					mscorlib::System::Runtime::Remoting::Metadata::XmlFieldOrderOption::__ENUM__  SoapTypeAttribute::get_XmlFieldOrder() const
					{
						...
						return static_cast<mscorlib::System::Runtime::Remoting::Metadata::XmlFieldOrderOption::__ENUM__>(*(mscorlib::System::Int32*)mono_object_unbox(__result__));
					}
