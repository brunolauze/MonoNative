		...
		namespace Runtime
		{
			namespace Remoting
			{
				namespace Metadata
				{
					...
					//	Get/Set:Embedded
					mscorlib::System::Boolean  SoapAttribute::get_Embedded() const
					{
					...
					void SoapAttribute::set_Embedded(mscorlib::System::Boolean  value)
					{
					...
					mscorlib::System::Boolean  SoapAttribute::get_UseAttribute() const
					{
					...
					void SoapAttribute::set_UseAttribute(mscorlib::System::Boolean  value)
					{
						MonoType *__parameter_types__[1];
						void *__parameters__[1];
						__parameter_types__[0] = Global::GetType(typeid(value).name());
					...
					mscorlib::System::String  SoapAttribute::get_XmlNamespace() const
					{
					...
					void SoapAttribute::set_XmlNamespace(mscorlib::System::String  value)
					{
						MonoType *__parameter_types__[1];
						void *__parameters__[1];
						__parameter_types__[0] = Global::GetType(typeid(value).name());
					...
					//	Get:TypeId
					mscorlib::System::Object  SoapAttribute::get_TypeId() const
					{
