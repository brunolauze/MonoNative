	...
	namespace System
	{
		namespace Runtime
		{
			namespace Remoting
			{
				...
				//	Get:InnerException
				mscorlib::System::Exception  ServerException::get_InnerException()
				{
				...
				//	Get/Set:HelpLink
				mscorlib::System::String  ServerException::get_HelpLink()
				{
				...
				//	Get/Set:HResult
				mscorlib::System::Int32  ServerException::get_HResult()
				{
				...
				//	Get:Message
				mscorlib::System::String  ServerException::get_Message()
				{
				...
				//	Get/Set:Source
				mscorlib::System::String  ServerException::get_Source()
				{
				...
				//	Get:StackTrace
				mscorlib::System::String  ServerException::get_StackTrace()
				{
				...
				//	Get:TargetSite
				mscorlib::System::Reflection::MethodBase  ServerException::get_TargetSite()
				{
				...
				//	Get:Data
				mscorlib::System::Collections::IDictionary  ServerException::get_Data()
				{
