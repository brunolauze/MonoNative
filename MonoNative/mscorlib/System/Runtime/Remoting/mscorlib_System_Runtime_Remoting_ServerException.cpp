	...
	namespace System
	{
		namespace Runtime
		{
			namespace Remoting
			{
				...
				//	Get:InnerException
				mscorlib::System::Exception  ServerException::get_InnerException() const
				{
				...
				//	Get/Set:HelpLink
				mscorlib::System::String  ServerException::get_HelpLink() const
				{
				...
				void ServerException::set_HelpLink(mscorlib::System::String  value)
				{
				...
				//	Get/Set:HResult
				mscorlib::System::Int32  ServerException::get_HResult() const
				{
				...
				void ServerException::set_HResult(mscorlib::System::Int32  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
					__parameter_types__[0] = Global::GetType(typeid(value).name());
				...
				//	Get:Message
				mscorlib::System::String  ServerException::get_Message() const
				{
				...
				//	Get:StackTrace
				mscorlib::System::String  ServerException::get_StackTrace() const
				{
				...
				//	Get:TargetSite
				mscorlib::System::Reflection::MethodBase  ServerException::get_TargetSite() const
				{
				...
				//	Get:Data
				mscorlib::System::Collections::IDictionary  ServerException::get_Data() const
				{
