#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_INDEXOUTOFRANGEEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_INDEXOUTOFRANGEEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.IndexOutOfRangeException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "IndexOutOfRangeException");
			};
		
			IndexOutOfRangeException(mscorlib::System::String message)
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.IndexOutOfRangeException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "IndexOutOfRangeException", 1, __parameter_types__, __parameters__);
			};
		
			IndexOutOfRangeException(mscorlib::System::String message, mscorlib::System::Exception innerException)
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.IndexOutOfRangeException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "IndexOutOfRangeException", 2, __parameter_types__, __parameters__);
			};
		
			IndexOutOfRangeException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			IndexOutOfRangeException(MonoObject *nativeObject)
			...
			IndexOutOfRangeException & operator=(IndexOutOfRangeException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(IndexOutOfRangeException &value) { return mscorlib::System::Object::Equals(value); };
