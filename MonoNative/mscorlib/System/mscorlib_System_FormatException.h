#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_FORMATEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_FORMATEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			FormatException()
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.FormatException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "FormatException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "FormatException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "FormatException", 2, __parameter_types__, __parameters__);
			};
		
			FormatException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			FormatException(MonoObject *nativeObject)
			...
			FormatException & operator=(FormatException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(FormatException &value) { return mscorlib::System::Object::Equals(value); };
