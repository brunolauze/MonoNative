#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_DATAMISALIGNEDEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_DATAMISALIGNEDEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.DataMisalignedException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "DataMisalignedException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "DataMisalignedException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "DataMisalignedException", 2, __parameter_types__, __parameters__);
			};
		
			DataMisalignedException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			DataMisalignedException(MonoObject *nativeObject)
			...
			DataMisalignedException & operator=(DataMisalignedException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(DataMisalignedException &value) { return mscorlib::System::Object::Equals(value); };
