#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_TYPELOADEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_TYPELOADEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			TypeLoadException()
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.TypeLoadException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "TypeLoadException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "TypeLoadException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "TypeLoadException", 2, __parameter_types__, __parameters__);
			};
		
			TypeLoadException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			TypeLoadException(MonoObject *nativeObject)
			...
			TypeLoadException & operator=(TypeLoadException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(TypeLoadException &value) { return mscorlib::System::Object::Equals(value); };
