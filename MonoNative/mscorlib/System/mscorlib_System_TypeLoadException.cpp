...
namespace mscorlib
{
	namespace System
	{
		...
		//Public Methods
		void TypeLoadException::GetObjectData(mscorlib::System::Runtime::Serialization::SerializationInfo info, mscorlib::System::Runtime::Serialization::StreamingContext context)
		{
				...
				Global::InvokeMethod("mscorlib", "System", "TypeLoadException", 0, NULL, "GetObjectData", __native_object__, 2, __parameter_types__, __parameters__, NULL);
		}

		//Get Set Properties Methods
		//	Get:Message
		mscorlib::System::String  TypeLoadException::get_Message() const
		{
		...
		//	Get:TypeName
		mscorlib::System::String  TypeLoadException::get_TypeName() const
		{
		...
		//	Get:InnerException
		mscorlib::System::Exception  TypeLoadException::get_InnerException() const
		{
		...
		//	Get/Set:HelpLink
		mscorlib::System::String  TypeLoadException::get_HelpLink() const
		{
		...
		void TypeLoadException::set_HelpLink(mscorlib::System::String  value)
		{
		...
		//	Get/Set:HResult
		mscorlib::System::Int32  TypeLoadException::get_HResult() const
		{
		...
		void TypeLoadException::set_HResult(mscorlib::System::Int32  value)
		{
			MonoType *__parameter_types__[1];
			void *__parameters__[1];
			__parameter_types__[0] = Global::GetType(typeid(value).name());
		...
		//	Get:StackTrace
		mscorlib::System::String  TypeLoadException::get_StackTrace() const
		{
		...
		//	Get:TargetSite
		mscorlib::System::Reflection::MethodBase  TypeLoadException::get_TargetSite() const
		{
		...
		//	Get:Data
		mscorlib::System::Collections::IDictionary  TypeLoadException::get_Data() const
		{
