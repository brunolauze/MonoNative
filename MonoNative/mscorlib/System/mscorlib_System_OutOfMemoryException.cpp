...
namespace mscorlib
{
	namespace System
	{
		...
		//	Get:InnerException
		mscorlib::System::Exception  OutOfMemoryException::get_InnerException()
		{
		...
		//	Get/Set:HelpLink
		mscorlib::System::String  OutOfMemoryException::get_HelpLink()
		{
		...
		//	Get/Set:HResult
		mscorlib::System::Int32  OutOfMemoryException::get_HResult()
		{
		...
		//	Get:Message
		mscorlib::System::String  OutOfMemoryException::get_Message()
		{
		...
		//	Get/Set:Source
		mscorlib::System::String  OutOfMemoryException::get_Source()
		{
		...
		//	Get:StackTrace
		mscorlib::System::String  OutOfMemoryException::get_StackTrace()
		{
		...
		//	Get:TargetSite
		mscorlib::System::Reflection::MethodBase  OutOfMemoryException::get_TargetSite()
		{
		...
		//	Get:Data
		mscorlib::System::Collections::IDictionary  OutOfMemoryException::get_Data()
		{
