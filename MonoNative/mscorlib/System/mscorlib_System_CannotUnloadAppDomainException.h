#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_CANNOTUNLOADAPPDOMAINEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_CANNOTUNLOADAPPDOMAINEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.CannotUnloadAppDomainException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "CannotUnloadAppDomainException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "CannotUnloadAppDomainException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "CannotUnloadAppDomainException", 2, __parameter_types__, __parameters__);
			};
		
			CannotUnloadAppDomainException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			CannotUnloadAppDomainException(MonoObject *nativeObject)
			...
			CannotUnloadAppDomainException & operator=(CannotUnloadAppDomainException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(CannotUnloadAppDomainException &value) { return mscorlib::System::Object::Equals(value); };
