...
namespace mscorlib
{
	namespace System
	{
		namespace Globalization
		{
			...
			//Public Methods
			mscorlib::System::Int32 TaiwanLunisolarCalendar::GetEra(mscorlib::System::DateTime time)
			{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
					__parameter_types__[0] = Global::GetType(typeid(time).name());
					__parameters__[0] = (MonoObject*)time;
					MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Globalization", "TaiwanLunisolarCalendar", 0, NULL, "GetEra", __native_object__, 1, __parameter_types__, __parameters__, NULL);
					return *(mscorlib::System::Int32*)mono_object_unbox(__result__);
			}

			//Get Set Properties Methods
			//	Get:Eras
			std::vector<mscorlib::System::Int32*>  TaiwanLunisolarCalendar::get_Eras() const
			{
				MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Globalization", "TaiwanLunisolarCalendar", 0, NULL, "get_Eras", __native_object__, 0, NULL, NULL, NULL);
			...
			mscorlib::System::DateTime  TaiwanLunisolarCalendar::get_MinSupportedDateTime() const
			{
				MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Globalization", "TaiwanLunisolarCalendar", 0, NULL, "get_MinSupportedDateTime", __native_object__, 0, NULL, NULL, NULL);
				return mscorlib::System::DateTime(__result__);
			}


			//	Get:MaxSupportedDateTime
			mscorlib::System::DateTime  TaiwanLunisolarCalendar::get_MaxSupportedDateTime() const
			{
				MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Globalization", "TaiwanLunisolarCalendar", 0, NULL, "get_MaxSupportedDateTime", __native_object__, 0, NULL, NULL, NULL);
				return mscorlib::System::DateTime(__result__);
			}


			//	Get/Set:TwoDigitYearMax
			mscorlib::System::Int32  TaiwanLunisolarCalendar::get_TwoDigitYearMax() const
			{
			...
			void TaiwanLunisolarCalendar::set_TwoDigitYearMax(mscorlib::System::Int32  value)
			{
				MonoType *__parameter_types__[1];
				void *__parameters__[1];
			...
			//	Get:AlgorithmType
			mscorlib::System::Globalization::CalendarAlgorithmType::__ENUM__  TaiwanLunisolarCalendar::get_AlgorithmType() const
			{
			...
			//	Get:IsReadOnly
			mscorlib::System::Boolean  TaiwanLunisolarCalendar::get_IsReadOnly() const
			{
