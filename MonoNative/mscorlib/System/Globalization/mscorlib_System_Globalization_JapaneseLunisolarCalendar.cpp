...
namespace mscorlib
{
	namespace System
	{
		namespace Globalization
		{
			...
			//	Get:Eras
			std::vector<mscorlib::System::Int32*>  JapaneseLunisolarCalendar::get_Eras()
			{
			...
			mscorlib::System::DateTime  JapaneseLunisolarCalendar::get_MinSupportedDateTime()
			{
			...
			mscorlib::System::DateTime  JapaneseLunisolarCalendar::get_MaxSupportedDateTime()
			{
			...
			mscorlib::System::Int32  JapaneseLunisolarCalendar::get_TwoDigitYearMax()
			{
			...
			//	Get:AlgorithmType
			mscorlib::System::Globalization::CalendarAlgorithmType::__ENUM__  JapaneseLunisolarCalendar::get_AlgorithmType()
			{
			...
			//	Get:IsReadOnly
			mscorlib::System::Boolean  JapaneseLunisolarCalendar::get_IsReadOnly()
			{
