...
namespace mscorlib
{
	namespace System
	{
		namespace Globalization
		{
			...
			//	Get:Eras
			std::vector<mscorlib::System::Int32*>  TaiwanCalendar::get_Eras()
			{
			...
			mscorlib::System::Int32  TaiwanCalendar::get_TwoDigitYearMax()
			{
			...
			//	Get:AlgorithmType
			mscorlib::System::Globalization::CalendarAlgorithmType::__ENUM__  TaiwanCalendar::get_AlgorithmType()
			{
			...
			mscorlib::System::DateTime  TaiwanCalendar::get_MinSupportedDateTime()
			{
			...
			mscorlib::System::DateTime  TaiwanCalendar::get_MaxSupportedDateTime()
			{
			...
			//	Get:IsReadOnly
			mscorlib::System::Boolean  TaiwanCalendar::get_IsReadOnly()
			{
