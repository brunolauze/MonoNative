#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_GLOBALIZATION_JAPANESECALENDAR_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_GLOBALIZATION_JAPANESECALENDAR_H
...
namespace mscorlib
{
	namespace System
	{
		namespace Globalization
		{
			...
			public:
				JapaneseCalendar()
				: mscorlib::System::Globalization::Calendar(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Globalization.JapaneseCalendar"))
				, mscorlib::System::ICloneable(NULL)
				{
					__native_object__ = Global::New("mscorlib", "System.Globalization", "JapaneseCalendar");
				};
			
				JapaneseCalendar(mscorlib::NativeTypeInfo *nativeTypeInfo)
				: mscorlib::System::Globalization::Calendar(nativeTypeInfo)
				, mscorlib::System::ICloneable(NULL)
				{
				};
			
				JapaneseCalendar(MonoObject *nativeObject)
