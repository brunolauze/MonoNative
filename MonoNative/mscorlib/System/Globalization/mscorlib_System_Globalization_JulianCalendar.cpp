...
namespace mscorlib
{
	namespace System
	{
		namespace Globalization
		{
			...
			//	Get:Eras
			std::vector<mscorlib::System::Int32*>  JulianCalendar::get_Eras() const
			{
			...
			mscorlib::System::Int32  JulianCalendar::get_TwoDigitYearMax() const
			{
			...
			//	Get:AlgorithmType
			mscorlib::System::Globalization::CalendarAlgorithmType::__ENUM__  JulianCalendar::get_AlgorithmType() const
			{
			...
			mscorlib::System::DateTime  JulianCalendar::get_MinSupportedDateTime() const
			{
			...
			mscorlib::System::DateTime  JulianCalendar::get_MaxSupportedDateTime() const
			{
			...
			//	Get:IsReadOnly
			mscorlib::System::Boolean  JulianCalendar::get_IsReadOnly() const
			{
			...
			void JulianCalendar::set_JulianEra(mscorlib::System::Int32  value)
			{
				throw;
			}
