#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_GLOBALIZATION_PERSIANCALENDAR_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_GLOBALIZATION_PERSIANCALENDAR_H
...
namespace mscorlib
{
	namespace System
	{
		namespace Globalization
		{
			...
			public:
				PersianCalendar()
				: mscorlib::System::Globalization::Calendar(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Globalization.PersianCalendar"))
				, mscorlib::System::ICloneable(NULL)
				{
					__native_object__ = Global::New("mscorlib", "System.Globalization", "PersianCalendar");
				};
			
				PersianCalendar(mscorlib::NativeTypeInfo *nativeTypeInfo)
				: mscorlib::System::Globalization::Calendar(nativeTypeInfo)
				, mscorlib::System::ICloneable(NULL)
				{
				};
			
				PersianCalendar(MonoObject *nativeObject)
				...
				PersianCalendar & operator=(PersianCalendar &value) { __native_object__ = value.GetNativeObject(); return value; };
				bool operator==(PersianCalendar &value) { return mscorlib::System::Object::Equals(value); };
				...
				static Property<mscorlib::System::Int32 , mscorlib::System::Globalization::PersianCalendar> PersianEra;
				...
				//	Get/Set:PersianEra
				static mscorlib::System::Int32  get_PersianEra();
				static void set_PersianEra(mscorlib::System::Int32  value);
