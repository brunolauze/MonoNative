#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_GLOBALIZATION_KOREANCALENDAR_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_GLOBALIZATION_KOREANCALENDAR_H
...
namespace mscorlib
{
	namespace System
	{
		namespace Globalization
		{
			...
			public:
				KoreanCalendar()
				: mscorlib::System::Globalization::Calendar(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Globalization.KoreanCalendar"))
				, mscorlib::System::ICloneable(NULL)
				{
					__native_object__ = Global::New("mscorlib", "System.Globalization", "KoreanCalendar");
				};
			
				KoreanCalendar(mscorlib::NativeTypeInfo *nativeTypeInfo)
				: mscorlib::System::Globalization::Calendar(nativeTypeInfo)
				, mscorlib::System::ICloneable(NULL)
				{
				};
			
				KoreanCalendar(MonoObject *nativeObject)
				...
				KoreanCalendar & operator=(KoreanCalendar &value) { __native_object__ = value.GetNativeObject(); return value; };
				bool operator==(KoreanCalendar &value) { return mscorlib::System::Object::Equals(value); };
				...
				static Property<mscorlib::System::Int32 , mscorlib::System::Globalization::KoreanCalendar> KoreanEra;
				...
				//	Get/Set:KoreanEra
				static mscorlib::System::Int32  get_KoreanEra();
				static void set_KoreanEra(mscorlib::System::Int32  value);
