#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_GLOBALIZATION_HIJRICALENDAR_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_GLOBALIZATION_HIJRICALENDAR_H
...
namespace mscorlib
{
	namespace System
	{
		namespace Globalization
		{
			...
			public:
				HijriCalendar()
				: mscorlib::System::Globalization::Calendar(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Globalization.HijriCalendar"))
				, mscorlib::System::ICloneable(NULL)
				{
					__native_object__ = Global::New("mscorlib", "System.Globalization", "HijriCalendar");
				};
			
				HijriCalendar(mscorlib::NativeTypeInfo *nativeTypeInfo)
				: mscorlib::System::Globalization::Calendar(nativeTypeInfo)
				, mscorlib::System::ICloneable(NULL)
				{
				};
			
				HijriCalendar(MonoObject *nativeObject)
				...
				HijriCalendar & operator=(HijriCalendar &value) { __native_object__ = value.GetNativeObject(); return value; };
				bool operator==(HijriCalendar &value) { return mscorlib::System::Object::Equals(value); };
				...
				__declspec(property(get=get_HijriAdjustment, put=set_HijriAdjustment)) mscorlib::System::Int32  HijriAdjustment;
				__declspec(property(get=get_IsReadOnly)) mscorlib::System::Boolean  IsReadOnly;

				//Public Static Fields
				static Property<mscorlib::System::Int32 , mscorlib::System::Globalization::HijriCalendar> HijriEra;
				...
				mscorlib::System::Int32  get_HijriAdjustment() const;
				void set_HijriAdjustment(mscorlib::System::Int32  value);

				//	Get:IsReadOnly
				mscorlib::System::Boolean  get_IsReadOnly() const;

				//	Get/Set:HijriEra
				static mscorlib::System::Int32  get_HijriEra();
				static void set_HijriEra(mscorlib::System::Int32  value);
