...
namespace mscorlib
{
	namespace System
	{
		namespace Globalization
		{
			...
			mscorlib::System::Int32  EastAsianLunisolarCalendar::get_TwoDigitYearMax() const
			{
			...
			//	Get:AlgorithmType
			mscorlib::System::Globalization::CalendarAlgorithmType::__ENUM__  EastAsianLunisolarCalendar::get_AlgorithmType() const
			{
			...
			mscorlib::System::DateTime  EastAsianLunisolarCalendar::get_MaxSupportedDateTime() const
			{
			...
			mscorlib::System::DateTime  EastAsianLunisolarCalendar::get_MinSupportedDateTime() const
			{
			...
			//	Get:IsReadOnly
			mscorlib::System::Boolean  EastAsianLunisolarCalendar::get_IsReadOnly() const
			{
