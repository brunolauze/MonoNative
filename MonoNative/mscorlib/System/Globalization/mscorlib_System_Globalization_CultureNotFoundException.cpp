...
namespace mscorlib
{
	namespace System
	{
		namespace Globalization
		{
			...
			//Public Methods
			void CultureNotFoundException::GetObjectData(mscorlib::System::Runtime::Serialization::SerializationInfo info, mscorlib::System::Runtime::Serialization::StreamingContext context)
			{
					...
					Global::InvokeMethod("mscorlib", "System.Globalization", "CultureNotFoundException", 0, NULL, "GetObjectData", __native_object__, 2, __parameter_types__, __parameters__, NULL);
			}
			...
			void CultureNotFoundException::set_HelpLink(mscorlib::System::String  value)
			{
			...
			void CultureNotFoundException::set_HResult(mscorlib::System::Int32  value)
			{
				MonoType *__parameter_types__[1];
				void *__parameters__[1];
				__parameter_types__[0] = Global::GetType(typeid(value).name());
			...
			void CultureNotFoundException::set_Source(mscorlib::System::String  value)
			{
				MonoType *__parameter_types__[1];
				void *__parameters__[1];
				__parameter_types__[0] = Global::GetType(typeid(value).name());
