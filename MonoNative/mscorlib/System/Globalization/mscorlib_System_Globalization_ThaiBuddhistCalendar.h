#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_GLOBALIZATION_THAIBUDDHISTCALENDAR_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_GLOBALIZATION_THAIBUDDHISTCALENDAR_H
	...
	namespace System
	{
		namespace Globalization
		{
			...
			public:
				...
				: mscorlib::System::Globalization::Calendar(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Globalization.ThaiBuddhistCalendar"))
				, mscorlib::System::ICloneable(NULL)
				{
					__native_object__ = Global::New("mscorlib", "System.Globalization", "ThaiBuddhistCalendar");
				};
			
				ThaiBuddhistCalendar(mscorlib::NativeTypeInfo *nativeTypeInfo)
				: mscorlib::System::Globalization::Calendar(nativeTypeInfo)
				, mscorlib::System::ICloneable(NULL)
				{
				};
			
				ThaiBuddhistCalendar(MonoObject *nativeObject)
				...
				ThaiBuddhistCalendar & operator=(ThaiBuddhistCalendar &value) { __native_object__ = value.GetNativeObject(); return value; };
				bool operator==(ThaiBuddhistCalendar &value) { return mscorlib::System::Object::Equals(value); };
				...
				static Property<mscorlib::System::Int32 , mscorlib::System::Globalization::ThaiBuddhistCalendar> ThaiBuddhistEra;
				...
				static mscorlib::System::Int32  get_ThaiBuddhistEra();
				static void set_ThaiBuddhistEra(mscorlib::System::Int32  value);
