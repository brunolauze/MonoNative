#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_NOTSUPPORTEDEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_NOTSUPPORTEDEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.NotSupportedException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "NotSupportedException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "NotSupportedException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "NotSupportedException", 2, __parameter_types__, __parameters__);
			};
		
			NotSupportedException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			NotSupportedException(MonoObject *nativeObject)
			...
			NotSupportedException & operator=(NotSupportedException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(NotSupportedException &value) { return mscorlib::System::Object::Equals(value); };
