#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_APPDOMAINUNLOADEDEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_APPDOMAINUNLOADEDEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.AppDomainUnloadedException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "AppDomainUnloadedException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "AppDomainUnloadedException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "AppDomainUnloadedException", 2, __parameter_types__, __parameters__);
			};
		
			AppDomainUnloadedException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			AppDomainUnloadedException(MonoObject *nativeObject)
			...
			AppDomainUnloadedException & operator=(AppDomainUnloadedException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(AppDomainUnloadedException &value) { return mscorlib::System::Object::Equals(value); };
