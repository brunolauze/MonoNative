	...
	namespace System
	{
		namespace Text
		{
			...
			mscorlib::System::Text::StringBuilder StringBuilder::Append(std::vector<mscorlib::System::Char*> value)
			{
					...
					__parameters__[0] = Global::FromPrimitiveArray<mscorlib::System::Char*>(value, typeid(mscorlib::System::Char).name());
			...
			mscorlib::System::Text::StringBuilder StringBuilder::Insert(mscorlib::System::Int32 index, std::vector<mscorlib::System::Char*> value)
			{
					...
					__parameters__[1] = Global::FromPrimitiveArray<mscorlib::System::Char*>(value, typeid(mscorlib::System::Char).name());
			...
			//	Get:MaxCapacity
			mscorlib::System::Int32  StringBuilder::get_MaxCapacity() const
			{
			...
			//	Get/Set:Capacity
			mscorlib::System::Int32  StringBuilder::get_Capacity() const
			{
			...
			//	Get/Set:Length
			mscorlib::System::Int32  StringBuilder::get_Length() const
			{
			...
			//	Get/Set:Chars
			mscorlib::System::Char  StringBuilder::get_Chars(mscorlib::System::Int32 index) const
			{
				MonoType *__parameter_types__[1];
				void *__parameters__[1];
				__parameter_types__[0] = Global::GetType(typeid(index).name());
