#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_TEXT_UTF8ENCODING_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_TEXT_UTF8ENCODING_H
...
namespace mscorlib
{
	namespace System
	{
		namespace Text
		{
			...
			public:
				UTF8Encoding()
				: mscorlib::System::Text::Encoding(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Text.UTF8Encoding"))
				, mscorlib::System::ICloneable(NULL)
				{
					__native_object__ = Global::New("mscorlib", "System.Text", "UTF8Encoding");
				};
				...
				, mscorlib::System::ICloneable(NULL)
				{
					...
					__parameters__[0] = reinterpret_cast<void*>(encoderShouldEmitUTF8Identifier);
					__native_object__ = Global::New("mscorlib", "System.Text", "UTF8Encoding", 1, __parameter_types__, __parameters__);
				};
				...
				, mscorlib::System::ICloneable(NULL)
				{
					...
					__parameters__[0] = reinterpret_cast<void*>(encoderShouldEmitUTF8Identifier);
					__parameters__[1] = reinterpret_cast<void*>(throwOnInvalidBytes);
					__native_object__ = Global::New("mscorlib", "System.Text", "UTF8Encoding", 2, __parameter_types__, __parameters__);
				};
			
				UTF8Encoding(mscorlib::NativeTypeInfo *nativeTypeInfo)
				: mscorlib::System::Text::Encoding(nativeTypeInfo)
				, mscorlib::System::ICloneable(NULL)
				{
				};
			
				UTF8Encoding(MonoObject *nativeObject)
				...
				UTF8Encoding & operator=(UTF8Encoding &value) { __native_object__ = value.GetNativeObject(); return value; };
				bool operator==(UTF8Encoding &value) { return mscorlib::System::Object::Equals(value); };
