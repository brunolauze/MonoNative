#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_ARITHMETICEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_ARITHMETICEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			ArithmeticException()
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.ArithmeticException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "ArithmeticException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "ArithmeticException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "ArithmeticException", 2, __parameter_types__, __parameters__);
			};
		
			ArithmeticException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			ArithmeticException(MonoObject *nativeObject)
			...
			ArithmeticException & operator=(ArithmeticException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(ArithmeticException &value) { return mscorlib::System::Object::Equals(value); };
