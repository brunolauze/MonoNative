#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_OUTOFMEMORYEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_OUTOFMEMORYEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.OutOfMemoryException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "OutOfMemoryException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "OutOfMemoryException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "OutOfMemoryException", 2, __parameter_types__, __parameters__);
			};
		
			OutOfMemoryException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			OutOfMemoryException(MonoObject *nativeObject)
			...
			OutOfMemoryException & operator=(OutOfMemoryException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(OutOfMemoryException &value) { return mscorlib::System::Object::Equals(value); };
