...
namespace mscorlib
{
	namespace System
	{
		...
		//	Get:InnerException
		mscorlib::System::Exception  OverflowException::get_InnerException() const
		{
		...
		//	Get/Set:HelpLink
		mscorlib::System::String  OverflowException::get_HelpLink() const
		{
		...
		void OverflowException::set_HelpLink(mscorlib::System::String  value)
		{
		...
		//	Get/Set:HResult
		mscorlib::System::Int32  OverflowException::get_HResult() const
		{
		...
		void OverflowException::set_HResult(mscorlib::System::Int32  value)
		{
			MonoType *__parameter_types__[1];
			void *__parameters__[1];
			__parameter_types__[0] = Global::GetType(typeid(value).name());
		...
		//	Get:Message
		mscorlib::System::String  OverflowException::get_Message() const
		{
		...
		//	Get:StackTrace
		mscorlib::System::String  OverflowException::get_StackTrace() const
		{
		...
		//	Get:TargetSite
		mscorlib::System::Reflection::MethodBase  OverflowException::get_TargetSite() const
		{
		...
		//	Get:Data
		mscorlib::System::Collections::IDictionary  OverflowException::get_Data() const
		{
