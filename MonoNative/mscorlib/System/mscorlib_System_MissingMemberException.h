#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_MISSINGMEMBEREXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_MISSINGMEMBEREXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::MemberAccessException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.MissingMemberException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "MissingMemberException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "MissingMemberException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "MissingMemberException", 2, __parameter_types__, __parameters__);
			};
			...
			MissingMemberException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			MissingMemberException(MonoObject *nativeObject)
