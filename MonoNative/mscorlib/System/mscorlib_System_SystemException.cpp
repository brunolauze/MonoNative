...
namespace mscorlib
{
	namespace System
	{
		...
		//	Get:InnerException
		mscorlib::System::Exception  SystemException::get_InnerException() const
		{
		...
		//	Get/Set:HelpLink
		mscorlib::System::String  SystemException::get_HelpLink() const
		{
		...
		void SystemException::set_HelpLink(mscorlib::System::String  value)
		{
		...
		//	Get/Set:HResult
		mscorlib::System::Int32  SystemException::get_HResult() const
		{
		...
		void SystemException::set_HResult(mscorlib::System::Int32  value)
		{
			MonoType *__parameter_types__[1];
			void *__parameters__[1];
			__parameter_types__[0] = Global::GetType(typeid(value).name());
		...
		//	Get:Message
		mscorlib::System::String  SystemException::get_Message() const
		{
		...
		//	Get:StackTrace
		mscorlib::System::String  SystemException::get_StackTrace() const
		{
		...
		//	Get:TargetSite
		mscorlib::System::Reflection::MethodBase  SystemException::get_TargetSite() const
		{
		...
		//	Get:Data
		mscorlib::System::Collections::IDictionary  SystemException::get_Data() const
		{
