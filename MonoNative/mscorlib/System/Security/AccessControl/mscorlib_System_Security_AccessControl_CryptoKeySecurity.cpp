	...
	namespace System
	{
		namespace Security
		{
			namespace AccessControl
			{
				...
				//	Get:AccessRightType
				mscorlib::System::Type  CryptoKeySecurity::get_AccessRightType()
				{
				...
				//	Get:AccessRuleType
				mscorlib::System::Type  CryptoKeySecurity::get_AccessRuleType()
				{
				...
				//	Get:AuditRuleType
				mscorlib::System::Type  CryptoKeySecurity::get_AuditRuleType()
				{
				...
				mscorlib::System::Boolean  CryptoKeySecurity::get_AreAccessRulesCanonical()
				{
				...
				mscorlib::System::Boolean  CryptoKeySecurity::get_AreAccessRulesProtected()
				{
				...
				mscorlib::System::Boolean  CryptoKeySecurity::get_AreAuditRulesCanonical()
				{
				...
				mscorlib::System::Boolean  CryptoKeySecurity::get_AreAuditRulesProtected()
				{
