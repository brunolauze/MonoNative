	...
	namespace System
	{
		namespace Security
		{
			namespace AccessControl
			{
				...
				//	Get:AccessRightType
				mscorlib::System::Type  EventWaitHandleSecurity::get_AccessRightType()
				{
				...
				//	Get:AccessRuleType
				mscorlib::System::Type  EventWaitHandleSecurity::get_AccessRuleType()
				{
				...
				//	Get:AuditRuleType
				mscorlib::System::Type  EventWaitHandleSecurity::get_AuditRuleType()
				{
				...
				mscorlib::System::Boolean  EventWaitHandleSecurity::get_AreAccessRulesCanonical()
				{
				...
				mscorlib::System::Boolean  EventWaitHandleSecurity::get_AreAccessRulesProtected()
				{
				...
				mscorlib::System::Boolean  EventWaitHandleSecurity::get_AreAuditRulesCanonical()
				{
				...
				mscorlib::System::Boolean  EventWaitHandleSecurity::get_AreAuditRulesProtected()
				{
