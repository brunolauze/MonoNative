#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_ACCESSCONTROL_REGISTRYSECURITY_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_ACCESSCONTROL_REGISTRYSECURITY_H
	...
	namespace System
	{
		namespace Security
		{
			namespace AccessControl
			{
				...
				public:
					RegistrySecurity()
					: mscorlib::System::Security::AccessControl::NativeObjectSecurity(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Security.AccessControl.RegistrySecurity"))
					{
						__native_object__ = Global::New("mscorlib", "System.Security.AccessControl", "RegistrySecurity");
					};
				
					RegistrySecurity(mscorlib::NativeTypeInfo *nativeTypeInfo)
					: mscorlib::System::Security::AccessControl::NativeObjectSecurity(nativeTypeInfo)
					{
					};
				
					RegistrySecurity(MonoObject *nativeObject)
					...
					void  AddAccessRule(mscorlib::System::Security::AccessControl::RegistryAccessRule rule);
					mscorlib::System::Boolean  RemoveAccessRule(mscorlib::System::Security::AccessControl::RegistryAccessRule rule);
					void  RemoveAccessRuleAll(mscorlib::System::Security::AccessControl::RegistryAccessRule rule);
					void  RemoveAccessRuleSpecific(mscorlib::System::Security::AccessControl::RegistryAccessRule rule);
					void  ResetAccessRule(mscorlib::System::Security::AccessControl::RegistryAccessRule rule);
					void  SetAccessRule(mscorlib::System::Security::AccessControl::RegistryAccessRule rule);
					virtual mscorlib::System::Security::AccessControl::AuditRuleBase  AuditRuleFactory(mscorlib::System::Security::Principal::IdentityReference identityReference, mscorlib::System::Int32 accessMask, mscorlib::System::Boolean isInherited, mscorlib::System::Security::AccessControl::InheritanceFlags::__ENUM__ inheritanceFlags, mscorlib::System::Security::AccessControl::PropagationFlags::__ENUM__ propagationFlags, mscorlib::System::Security::AccessControl::AuditFlags::__ENUM__ flags) override;
					void  AddAuditRule(mscorlib::System::Security::AccessControl::RegistryAuditRule rule);
					mscorlib::System::Boolean  RemoveAuditRule(mscorlib::System::Security::AccessControl::RegistryAuditRule rule);
					void  RemoveAuditRuleAll(mscorlib::System::Security::AccessControl::RegistryAuditRule rule);
					void  RemoveAuditRuleSpecific(mscorlib::System::Security::AccessControl::RegistryAuditRule rule);
					void  SetAuditRule(mscorlib::System::Security::AccessControl::RegistryAuditRule rule);
