	...
	namespace System
	{
		namespace Security
		{
			namespace AccessControl
			{
				...
				mscorlib::System::Security::AccessControl::FileSystemRights::__ENUM__  FileSystemAccessRule::get_FileSystemRights()
				{
				...
				mscorlib::System::Security::AccessControl::AccessControlType::__ENUM__  FileSystemAccessRule::get_AccessControlType()
				{
				...
				mscorlib::System::Security::Principal::IdentityReference  FileSystemAccessRule::get_IdentityReference()
				{
				...
				mscorlib::System::Security::AccessControl::InheritanceFlags::__ENUM__  FileSystemAccessRule::get_InheritanceFlags()
				{
				...
				//	Get:IsInherited
				mscorlib::System::Boolean  FileSystemAccessRule::get_IsInherited()
				{
				...
				mscorlib::System::Security::AccessControl::PropagationFlags::__ENUM__  FileSystemAccessRule::get_PropagationFlags()
				{
