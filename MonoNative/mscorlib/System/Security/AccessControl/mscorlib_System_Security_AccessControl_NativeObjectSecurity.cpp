	...
	namespace System
	{
		namespace Security
		{
			namespace AccessControl
			{
				...
				//	Get:AccessRightType
				mscorlib::System::Type  NativeObjectSecurity::get_AccessRightType()
				{
				...
				//	Get:AccessRuleType
				mscorlib::System::Type  NativeObjectSecurity::get_AccessRuleType()
				{
				...
				//	Get:AuditRuleType
				mscorlib::System::Type  NativeObjectSecurity::get_AuditRuleType()
				{
				...
				mscorlib::System::Boolean  NativeObjectSecurity::get_AreAccessRulesCanonical()
				{
				...
				mscorlib::System::Boolean  NativeObjectSecurity::get_AreAccessRulesProtected()
				{
				...
				mscorlib::System::Boolean  NativeObjectSecurity::get_AreAuditRulesCanonical()
				{
				...
				mscorlib::System::Boolean  NativeObjectSecurity::get_AreAuditRulesProtected()
				{
