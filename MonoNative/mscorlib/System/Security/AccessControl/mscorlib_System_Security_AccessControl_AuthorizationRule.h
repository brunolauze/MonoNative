#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_ACCESSCONTROL_AUTHORIZATIONRULE_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_ACCESSCONTROL_AUTHORIZATIONRULE_H
	...
	namespace System
	{
		namespace Security
		{
			namespace AccessControl
			{
				...
				{
				public:
					AuthorizationRule(mscorlib::NativeTypeInfo *nativeTypeInfo)
					: mscorlib::System::Object(nativeTypeInfo)
					{
					};
				
					AuthorizationRule(MonoObject *nativeObject)
					...
					AuthorizationRule & operator=(AuthorizationRule &value) { __native_object__ = value.GetNativeObject(); return value; };
