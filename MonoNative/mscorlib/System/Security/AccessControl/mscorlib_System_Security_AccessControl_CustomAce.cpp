	...
	namespace System
	{
		namespace Security
		{
			namespace AccessControl
			{
				...
				//	Get:BinaryLength
				mscorlib::System::Int32  CustomAce::get_BinaryLength()
				{
				...
				//	Get:OpaqueLength
				mscorlib::System::Int32  CustomAce::get_OpaqueLength()
				{
				...
				//	Get/Set:AceFlags
				mscorlib::System::Security::AccessControl::AceFlags::__ENUM__  CustomAce::get_AceFlags()
				{
				...
				//	Get:AceType
				mscorlib::System::Security::AccessControl::AceType::__ENUM__  CustomAce::get_AceType()
				{
				...
				//	Get:AuditFlags
				mscorlib::System::Security::AccessControl::AuditFlags::__ENUM__  CustomAce::get_AuditFlags()
				{
				...
				mscorlib::System::Security::AccessControl::InheritanceFlags::__ENUM__  CustomAce::get_InheritanceFlags()
				{
				...
				//	Get:IsInherited
				mscorlib::System::Boolean  CustomAce::get_IsInherited()
				{
				...
				mscorlib::System::Security::AccessControl::PropagationFlags::__ENUM__  CustomAce::get_PropagationFlags()
				{
