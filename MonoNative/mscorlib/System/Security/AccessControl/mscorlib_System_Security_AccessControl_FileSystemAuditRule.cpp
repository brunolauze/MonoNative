	...
	namespace System
	{
		namespace Security
		{
			namespace AccessControl
			{
				...
				mscorlib::System::Security::AccessControl::FileSystemRights::__ENUM__  FileSystemAuditRule::get_FileSystemRights()
				{
					...
					return *(mscorlib::System::Security::AccessControl::FileSystemRights::__ENUM__*)mono_object_unbox(__result__);
				}


				//	Get:AuditFlags
				mscorlib::System::Security::AccessControl::AuditFlags::__ENUM__  FileSystemAuditRule::get_AuditFlags()
				{
				...
				mscorlib::System::Security::Principal::IdentityReference  FileSystemAuditRule::get_IdentityReference()
				{
				...
				mscorlib::System::Security::AccessControl::InheritanceFlags::__ENUM__  FileSystemAuditRule::get_InheritanceFlags()
				{
				...
				//	Get:IsInherited
				mscorlib::System::Boolean  FileSystemAuditRule::get_IsInherited()
				{
				...
				mscorlib::System::Security::AccessControl::PropagationFlags::__ENUM__  FileSystemAuditRule::get_PropagationFlags()
				{
