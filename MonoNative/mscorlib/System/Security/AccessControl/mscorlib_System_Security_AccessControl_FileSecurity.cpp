	...
	namespace System
	{
		namespace Security
		{
			namespace AccessControl
			{
				...
				//	Get:AccessRightType
				mscorlib::System::Type  FileSecurity::get_AccessRightType()
				{
				...
				//	Get:AccessRuleType
				mscorlib::System::Type  FileSecurity::get_AccessRuleType()
				{
				...
				//	Get:AuditRuleType
				mscorlib::System::Type  FileSecurity::get_AuditRuleType()
				{
				...
				mscorlib::System::Boolean  FileSecurity::get_AreAccessRulesCanonical()
				{
				...
				mscorlib::System::Boolean  FileSecurity::get_AreAccessRulesProtected()
				{
				...
				mscorlib::System::Boolean  FileSecurity::get_AreAuditRulesCanonical()
				{
				...
				mscorlib::System::Boolean  FileSecurity::get_AreAuditRulesProtected()
				{
