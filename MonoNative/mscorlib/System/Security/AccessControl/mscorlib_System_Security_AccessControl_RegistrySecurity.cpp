	...
	namespace System
	{
		namespace Security
		{
			namespace AccessControl
			{
				...
				//	Get:AccessRightType
				mscorlib::System::Type  RegistrySecurity::get_AccessRightType()
				{
				...
				//	Get:AccessRuleType
				mscorlib::System::Type  RegistrySecurity::get_AccessRuleType()
				{
				...
				//	Get:AuditRuleType
				mscorlib::System::Type  RegistrySecurity::get_AuditRuleType()
				{
				...
				mscorlib::System::Boolean  RegistrySecurity::get_AreAccessRulesCanonical()
				{
				...
				mscorlib::System::Boolean  RegistrySecurity::get_AreAccessRulesProtected()
				{
				...
				mscorlib::System::Boolean  RegistrySecurity::get_AreAuditRulesCanonical()
				{
				...
				mscorlib::System::Boolean  RegistrySecurity::get_AreAuditRulesProtected()
				{
