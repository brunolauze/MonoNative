	...
	namespace System
	{
		namespace Security
		{
			namespace AccessControl
			{
				...
				mscorlib::System::Security::AccessControl::EventWaitHandleRights::__ENUM__  EventWaitHandleAccessRule::get_EventWaitHandleRights()
				{
					...
					return *(mscorlib::System::Security::AccessControl::EventWaitHandleRights::__ENUM__*)mono_object_unbox(__result__);
				}


				//	Get:AccessControlType
				mscorlib::System::Security::AccessControl::AccessControlType::__ENUM__  EventWaitHandleAccessRule::get_AccessControlType()
				{
				...
				mscorlib::System::Security::Principal::IdentityReference  EventWaitHandleAccessRule::get_IdentityReference()
				{
				...
				mscorlib::System::Security::AccessControl::InheritanceFlags::__ENUM__  EventWaitHandleAccessRule::get_InheritanceFlags()
				{
				...
				//	Get:IsInherited
				mscorlib::System::Boolean  EventWaitHandleAccessRule::get_IsInherited()
				{
				...
				mscorlib::System::Security::AccessControl::PropagationFlags::__ENUM__  EventWaitHandleAccessRule::get_PropagationFlags()
				{
