	...
	namespace System
	{
		namespace Security
		{
			namespace AccessControl
			{
				...
				//	Get:AccessRightType
				mscorlib::System::Type  DirectorySecurity::get_AccessRightType()
				{
				...
				//	Get:AccessRuleType
				mscorlib::System::Type  DirectorySecurity::get_AccessRuleType()
				{
				...
				//	Get:AuditRuleType
				mscorlib::System::Type  DirectorySecurity::get_AuditRuleType()
				{
				...
				mscorlib::System::Boolean  DirectorySecurity::get_AreAccessRulesCanonical()
				{
				...
				mscorlib::System::Boolean  DirectorySecurity::get_AreAccessRulesProtected()
				{
				...
				mscorlib::System::Boolean  DirectorySecurity::get_AreAuditRulesCanonical()
				{
				...
				mscorlib::System::Boolean  DirectorySecurity::get_AreAuditRulesProtected()
				{
