	...
	namespace System
	{
		namespace Security
		{
			namespace AccessControl
			{
				...
				//	Get:CryptoKeyRights
				mscorlib::System::Security::AccessControl::CryptoKeyRights::__ENUM__  CryptoKeyAccessRule::get_CryptoKeyRights()
				{
				...
				mscorlib::System::Security::AccessControl::AccessControlType::__ENUM__  CryptoKeyAccessRule::get_AccessControlType()
				{
				...
				mscorlib::System::Security::Principal::IdentityReference  CryptoKeyAccessRule::get_IdentityReference()
				{
				...
				mscorlib::System::Security::AccessControl::InheritanceFlags::__ENUM__  CryptoKeyAccessRule::get_InheritanceFlags()
				{
				...
				//	Get:IsInherited
				mscorlib::System::Boolean  CryptoKeyAccessRule::get_IsInherited()
				{
				...
				mscorlib::System::Security::AccessControl::PropagationFlags::__ENUM__  CryptoKeyAccessRule::get_PropagationFlags()
				{
