	...
	namespace System
	{
		namespace Security
		{
			namespace AccessControl
			{
				...
				//	Get/Set:AceFlags
				mscorlib::System::Security::AccessControl::AceFlags::__ENUM__  GenericAce::get_AceFlags()
				{
				...
				//	Get:AceType
				mscorlib::System::Security::AccessControl::AceType::__ENUM__  GenericAce::get_AceType()
				{
				...
				//	Get:AuditFlags
				mscorlib::System::Security::AccessControl::AuditFlags::__ENUM__  GenericAce::get_AuditFlags()
				{
				...
				//	Get:BinaryLength
				mscorlib::System::Int32  GenericAce::get_BinaryLength()
				{
				...
				mscorlib::System::Security::AccessControl::InheritanceFlags::__ENUM__  GenericAce::get_InheritanceFlags()
				{
				...
				//	Get:IsInherited
				mscorlib::System::Boolean  GenericAce::get_IsInherited()
				{
				...
				mscorlib::System::Security::AccessControl::PropagationFlags::__ENUM__  GenericAce::get_PropagationFlags()
				{
