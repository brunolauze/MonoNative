		...
		namespace Security
		{
			namespace AccessControl
			{
				...
				mscorlib::System::Security::AccessControl::RegistryRights::__ENUM__  RegistryAccessRule::get_RegistryRights() const
				{
					...
					return static_cast<mscorlib::System::Security::AccessControl::RegistryRights::__ENUM__>(*(mscorlib::System::Security::AccessControl::RegistryRights::__ENUM__*)mono_object_unbox(__result__));
				}
