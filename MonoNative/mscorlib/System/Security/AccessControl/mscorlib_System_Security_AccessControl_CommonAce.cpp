	...
	namespace System
	{
		namespace Security
		{
			namespace AccessControl
			{
				...
				//	Get:BinaryLength
				mscorlib::System::Int32  CommonAce::get_BinaryLength() const
				{
				...
				//	Get:AceQualifier
				mscorlib::System::Security::AccessControl::AceQualifier::__ENUM__  CommonAce::get_AceQualifier() const
				{
				...
				//	Get:IsCallback
				mscorlib::System::Boolean  CommonAce::get_IsCallback() const
				{
				...
				//	Get:OpaqueLength
				mscorlib::System::Int32  CommonAce::get_OpaqueLength() const
				{
				...
				//	Get/Set:AccessMask
				mscorlib::System::Int32  CommonAce::get_AccessMask() const
				{
				...
				mscorlib::System::Security::Principal::SecurityIdentifier  CommonAce::get_SecurityIdentifier() const
				{
				...
				//	Get/Set:AceFlags
				mscorlib::System::Security::AccessControl::AceFlags::__ENUM__  CommonAce::get_AceFlags() const
				{
				...
				//	Get:AceType
				mscorlib::System::Security::AccessControl::AceType::__ENUM__  CommonAce::get_AceType() const
				{
				...
				//	Get:AuditFlags
				mscorlib::System::Security::AccessControl::AuditFlags::__ENUM__  CommonAce::get_AuditFlags() const
				{
				...
				mscorlib::System::Security::AccessControl::InheritanceFlags::__ENUM__  CommonAce::get_InheritanceFlags() const
				{
				...
				//	Get:IsInherited
				mscorlib::System::Boolean  CommonAce::get_IsInherited() const
				{
				...
				mscorlib::System::Security::AccessControl::PropagationFlags::__ENUM__  CommonAce::get_PropagationFlags() const
				{
