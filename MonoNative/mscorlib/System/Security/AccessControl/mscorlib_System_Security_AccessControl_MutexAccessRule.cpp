	...
	namespace System
	{
		namespace Security
		{
			namespace AccessControl
			{
				...
				//	Get:MutexRights
				mscorlib::System::Security::AccessControl::MutexRights::__ENUM__  MutexAccessRule::get_MutexRights()
				{
				...
				mscorlib::System::Security::AccessControl::AccessControlType::__ENUM__  MutexAccessRule::get_AccessControlType()
				{
				...
				mscorlib::System::Security::Principal::IdentityReference  MutexAccessRule::get_IdentityReference()
				{
				...
				mscorlib::System::Security::AccessControl::InheritanceFlags::__ENUM__  MutexAccessRule::get_InheritanceFlags()
				{
				...
				//	Get:IsInherited
				mscorlib::System::Boolean  MutexAccessRule::get_IsInherited()
				{
				...
				mscorlib::System::Security::AccessControl::PropagationFlags::__ENUM__  MutexAccessRule::get_PropagationFlags()
				{
