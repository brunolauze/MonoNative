#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_ACCESSCONTROL_FILESECURITY_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_ACCESSCONTROL_FILESECURITY_H
	...
	namespace System
	{
		namespace Security
		{
			namespace AccessControl
			{
				...
				public:
					FileSecurity()
					: mscorlib::System::Security::AccessControl::FileSystemSecurity(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Security.AccessControl.FileSecurity"))
					{
						__native_object__ = Global::New("mscorlib", "System.Security.AccessControl", "FileSecurity");
					};
					...
					: mscorlib::System::Security::AccessControl::FileSystemSecurity(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Security.AccessControl.FileSecurity"))
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Security.AccessControl", "FileSecurity", 2, __parameter_types__, __parameters__);
					};
				
					FileSecurity(mscorlib::NativeTypeInfo *nativeTypeInfo)
					: mscorlib::System::Security::AccessControl::FileSystemSecurity(nativeTypeInfo)
					{
					};
				
					FileSecurity(MonoObject *nativeObject)
					...
					FileSecurity & operator=(FileSecurity &value) { __native_object__ = value.GetNativeObject(); return value; };
					bool operator==(FileSecurity &value) { return mscorlib::System::Object::Equals(value); };
