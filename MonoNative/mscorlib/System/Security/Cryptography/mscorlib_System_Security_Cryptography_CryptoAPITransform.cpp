	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				{
						Global::InvokeMethod("mscorlib", "System.Security.Cryptography", "CryptoAPITransform", 0, NULL, "Dispose", __native_object__, 0, NULL, NULL, NULL);
				}

				void CryptoAPITransform::Clear()
				{
						Global::InvokeMethod("mscorlib", "System.Security.Cryptography", "CryptoAPITransform", 0, NULL, "Clear", __native_object__, 0, NULL, NULL, NULL);
				}

				mscorlib::System::Int32 CryptoAPITransform::TransformBlock(std::vector<mscorlib::System::Byte*> inputBuffer, mscorlib::System::Int32 inputOffset, mscorlib::System::Int32 inputCount, std::vector<mscorlib::System::Byte*> outputBuffer, mscorlib::System::Int32 outputOffset)
				{
						...
						MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Security.Cryptography", "CryptoAPITransform", 0, NULL, "TransformBlock", __native_object__, 5, __parameter_types__, __parameters__, NULL);
						return *(mscorlib::System::Int32*)mono_object_unbox(__result__);
				}

				std::vector<mscorlib::System::Byte*> CryptoAPITransform::TransformFinalBlock(std::vector<mscorlib::System::Byte*> inputBuffer, mscorlib::System::Int32 inputOffset, mscorlib::System::Int32 inputCount)
				{
						...
						__parameters__[1] = &inputOffset;
						__parameters__[2] = &inputCount;
						MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Security.Cryptography", "CryptoAPITransform", 0, NULL, "TransformFinalBlock", __native_object__, 3, __parameter_types__, __parameters__, NULL);
				...
				{
						Global::InvokeMethod("mscorlib", "System.Security.Cryptography", "CryptoAPITransform", 0, NULL, "Reset", __native_object__, 0, NULL, NULL, NULL);
				}
