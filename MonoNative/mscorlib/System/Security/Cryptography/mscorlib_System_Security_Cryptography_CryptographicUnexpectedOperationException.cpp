	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				//	Get:InnerException
				mscorlib::System::Exception  CryptographicUnexpectedOperationException::get_InnerException()
				{
				...
				//	Get/Set:HelpLink
				mscorlib::System::String  CryptographicUnexpectedOperationException::get_HelpLink()
				{
				...
				//	Get/Set:HResult
				mscorlib::System::Int32  CryptographicUnexpectedOperationException::get_HResult()
				{
				...
				//	Get:Message
				mscorlib::System::String  CryptographicUnexpectedOperationException::get_Message()
				{
				...
				//	Get/Set:Source
				mscorlib::System::String  CryptographicUnexpectedOperationException::get_Source()
				{
				...
				//	Get:StackTrace
				mscorlib::System::String  CryptographicUnexpectedOperationException::get_StackTrace()
				{
				...
				//	Get:TargetSite
				mscorlib::System::Reflection::MethodBase  CryptographicUnexpectedOperationException::get_TargetSite()
				{
				...
				//	Get:Data
				mscorlib::System::Collections::IDictionary  CryptographicUnexpectedOperationException::get_Data()
				{
