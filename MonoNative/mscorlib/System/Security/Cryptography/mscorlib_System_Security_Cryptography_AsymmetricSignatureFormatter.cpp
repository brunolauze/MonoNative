	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				//Public Methods
				void AsymmetricSignatureFormatter::SetHashAlgorithm(mscorlib::System::String strName)
				{
				...
				void AsymmetricSignatureFormatter::SetHashAlgorithm(const char *strName)
				{
						MonoType *__parameter_types__[1];
						void *__parameters__[1];
				...
				void AsymmetricSignatureFormatter::SetKey(mscorlib::System::Security::Cryptography::AsymmetricAlgorithm key)
				{
						MonoType *__parameter_types__[1];
						void *__parameters__[1];
						__parameter_types__[0] = Global::GetType(typeid(key).name());
						__parameters__[0] = (MonoObject*)key;
						Global::InvokeMethod("mscorlib", "System.Security.Cryptography", "AsymmetricSignatureFormatter", 0, NULL, "SetKey", __native_object__, 1, __parameter_types__, __parameters__, NULL);
				}

				std::vector<mscorlib::System::Byte*> AsymmetricSignatureFormatter::CreateSignature(std::vector<mscorlib::System::Byte*> rgbHash)
				{
						MonoType *__parameter_types__[1];
						void *__parameters__[1];
				...
				std::vector<mscorlib::System::Byte*> AsymmetricSignatureFormatter::CreateSignature(mscorlib::System::Security::Cryptography::HashAlgorithm hash)
				{
						MonoType *__parameter_types__[1];
						void *__parameters__[1];
