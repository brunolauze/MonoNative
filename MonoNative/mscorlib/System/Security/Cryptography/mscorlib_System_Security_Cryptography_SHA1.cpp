	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				//Public Methods
				mscorlib::System::Security::Cryptography::SHA1 SHA1::Create()
				{
						MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Security.Cryptography", "SHA1", 0, NULL, "Create", NullMonoObject, 0, NULL, NULL, NULL);
						return mscorlib::System::Security::Cryptography::SHA1(__result__);
				}

				mscorlib::System::Security::Cryptography::SHA1 SHA1::Create(mscorlib::System::String hashName)
				{
						MonoType *__parameter_types__[1];
						void *__parameters__[1];
						__parameter_types__[0] = Global::GetType(typeid(hashName).name());
						__parameters__[0] = (MonoObject*)hashName;
						MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Security.Cryptography", "SHA1", 0, NULL, "Create", NullMonoObject, 1, __parameter_types__, __parameters__, NULL);
						return mscorlib::System::Security::Cryptography::SHA1(__result__);
				}

				mscorlib::System::Security::Cryptography::SHA1 SHA1::Create(const char *hashName)
				{
						MonoType *__parameter_types__[1];
						void *__parameters__[1];
				...
				mscorlib::System::Boolean  SHA1::get_CanTransformMultipleBlocks() const
				{
				...
				mscorlib::System::Boolean  SHA1::get_CanReuseTransform() const
				{
				...
				//	Get:HashSize
				mscorlib::System::Int32  SHA1::get_HashSize() const
				{
				...
				//	Get:InputBlockSize
				mscorlib::System::Int32  SHA1::get_InputBlockSize() const
				{
				...
				//	Get:OutputBlockSize
				mscorlib::System::Int32  SHA1::get_OutputBlockSize() const
				{
