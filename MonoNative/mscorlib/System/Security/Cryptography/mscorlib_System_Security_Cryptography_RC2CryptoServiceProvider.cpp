	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				mscorlib::System::Int32  RC2CryptoServiceProvider::get_EffectiveKeySize()
				{
				...
				//	Get/Set:UseSalt
				mscorlib::System::Boolean  RC2CryptoServiceProvider::get_UseSalt()
				{
				...
				//	Get/Set:KeySize
				mscorlib::System::Int32  RC2CryptoServiceProvider::get_KeySize()
				{
				...
				//	Get/Set:BlockSize
				mscorlib::System::Int32  RC2CryptoServiceProvider::get_BlockSize()
				{
				...
				mscorlib::System::Int32  RC2CryptoServiceProvider::get_FeedbackSize()
				{
				...
				//	Get/Set:IV
				std::vector<mscorlib::System::Byte*>  RC2CryptoServiceProvider::get_IV()
				{
				...
				//	Get/Set:Key
				std::vector<mscorlib::System::Byte*>  RC2CryptoServiceProvider::get_Key()
				{
				...
				//	Get:LegalBlockSizes
				std::vector<mscorlib::System::Security::Cryptography::KeySizes*>  RC2CryptoServiceProvider::get_LegalBlockSizes()
				{
				...
				//	Get:LegalKeySizes
				std::vector<mscorlib::System::Security::Cryptography::KeySizes*>  RC2CryptoServiceProvider::get_LegalKeySizes()
				{
				...
				//	Get/Set:Mode
				mscorlib::System::Security::Cryptography::CipherMode::__ENUM__  RC2CryptoServiceProvider::get_Mode()
				{
				...
				//	Get/Set:Padding
				mscorlib::System::Security::Cryptography::PaddingMode::__ENUM__  RC2CryptoServiceProvider::get_Padding()
				{
