	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				mscorlib::System::Boolean  RIPEMD160Managed::get_CanTransformMultipleBlocks()
				{
				...
				mscorlib::System::Boolean  RIPEMD160Managed::get_CanReuseTransform()
				{
				...
				//	Get:Hash
				std::vector<mscorlib::System::Byte*>  RIPEMD160Managed::get_Hash()
				{
				...
				//	Get:HashSize
				mscorlib::System::Int32  RIPEMD160Managed::get_HashSize()
				{
				...
				//	Get:InputBlockSize
				mscorlib::System::Int32  RIPEMD160Managed::get_InputBlockSize()
				{
				...
				//	Get:OutputBlockSize
				mscorlib::System::Int32  RIPEMD160Managed::get_OutputBlockSize()
				{
