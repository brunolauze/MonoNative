	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				//	Get/Set:HashName
				mscorlib::System::String  HMACRIPEMD160::get_HashName() const
				{
				...
				void HMACRIPEMD160::set_HashName(mscorlib::System::String  value)
				{
				...
				//	Get/Set:Key
				std::vector<mscorlib::System::Byte*>  HMACRIPEMD160::get_Key() const
				{
				...
				void HMACRIPEMD160::set_Key(std::vector<mscorlib::System::Byte*>  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
				...
				mscorlib::System::Boolean  HMACRIPEMD160::get_CanTransformMultipleBlocks() const
				{
				...
				mscorlib::System::Boolean  HMACRIPEMD160::get_CanReuseTransform() const
				{
				...
				//	Get:Hash
				std::vector<mscorlib::System::Byte*>  HMACRIPEMD160::get_Hash() const
				{
				...
				//	Get:HashSize
				mscorlib::System::Int32  HMACRIPEMD160::get_HashSize() const
				{
				...
				//	Get:InputBlockSize
				mscorlib::System::Int32  HMACRIPEMD160::get_InputBlockSize() const
				{
				...
				//	Get:OutputBlockSize
				mscorlib::System::Int32  HMACRIPEMD160::get_OutputBlockSize() const
				{
