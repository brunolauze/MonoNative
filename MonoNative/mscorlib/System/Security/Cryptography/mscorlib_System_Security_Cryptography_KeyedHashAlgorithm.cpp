	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				//	Get/Set:Key
				std::vector<mscorlib::System::Byte*>  KeyedHashAlgorithm::get_Key()
				{
				...
				mscorlib::System::Boolean  KeyedHashAlgorithm::get_CanTransformMultipleBlocks()
				{
				...
				mscorlib::System::Boolean  KeyedHashAlgorithm::get_CanReuseTransform()
				{
				...
				//	Get:Hash
				std::vector<mscorlib::System::Byte*>  KeyedHashAlgorithm::get_Hash()
				{
				...
				//	Get:HashSize
				mscorlib::System::Int32  KeyedHashAlgorithm::get_HashSize()
				{
				...
				//	Get:InputBlockSize
				mscorlib::System::Int32  KeyedHashAlgorithm::get_InputBlockSize()
				{
				...
				//	Get:OutputBlockSize
				mscorlib::System::Int32  KeyedHashAlgorithm::get_OutputBlockSize()
				{
