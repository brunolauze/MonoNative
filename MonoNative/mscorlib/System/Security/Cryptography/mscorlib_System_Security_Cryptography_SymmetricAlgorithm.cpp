	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				//	Get/Set:BlockSize
				mscorlib::System::Int32  SymmetricAlgorithm::get_BlockSize()
				{
				...
				mscorlib::System::Int32  SymmetricAlgorithm::get_FeedbackSize()
				{
				...
				//	Get/Set:IV
				std::vector<mscorlib::System::Byte*>  SymmetricAlgorithm::get_IV()
				{
				...
				//	Get/Set:Key
				std::vector<mscorlib::System::Byte*>  SymmetricAlgorithm::get_Key()
				{
				...
				//	Get/Set:KeySize
				mscorlib::System::Int32  SymmetricAlgorithm::get_KeySize()
				{
				...
				//	Get:LegalBlockSizes
				std::vector<mscorlib::System::Security::Cryptography::KeySizes*>  SymmetricAlgorithm::get_LegalBlockSizes()
				{
				...
				//	Get:LegalKeySizes
				std::vector<mscorlib::System::Security::Cryptography::KeySizes*>  SymmetricAlgorithm::get_LegalKeySizes()
				{
				...
				//	Get/Set:Mode
				mscorlib::System::Security::Cryptography::CipherMode::__ENUM__  SymmetricAlgorithm::get_Mode()
				{
				...
				//	Get/Set:Padding
				mscorlib::System::Security::Cryptography::PaddingMode::__ENUM__  SymmetricAlgorithm::get_Padding()
				{
