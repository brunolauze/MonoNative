		...
		namespace Security
		{
			namespace Cryptography
			{
				...
				mscorlib::System::Security::Cryptography::CspProviderFlags::__ENUM__  CspParameters::get_Flags() const
				{
					...
					return static_cast<mscorlib::System::Security::Cryptography::CspProviderFlags::__ENUM__>(*(mscorlib::System::Security::Cryptography::CspProviderFlags::__ENUM__*)mono_object_unbox(__result__));
				}
