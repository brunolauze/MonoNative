	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				//	Get/Set:HashName
				mscorlib::System::String  HMACSHA1::get_HashName() const
				{
				...
				void HMACSHA1::set_HashName(mscorlib::System::String  value)
				{
				...
				//	Get/Set:Key
				std::vector<mscorlib::System::Byte*>  HMACSHA1::get_Key() const
				{
				...
				void HMACSHA1::set_Key(std::vector<mscorlib::System::Byte*>  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
				...
				mscorlib::System::Boolean  HMACSHA1::get_CanTransformMultipleBlocks() const
				{
				...
				mscorlib::System::Boolean  HMACSHA1::get_CanReuseTransform() const
				{
				...
				//	Get:Hash
				std::vector<mscorlib::System::Byte*>  HMACSHA1::get_Hash() const
				{
				...
				//	Get:HashSize
				mscorlib::System::Int32  HMACSHA1::get_HashSize() const
				{
				...
				//	Get:InputBlockSize
				mscorlib::System::Int32  HMACSHA1::get_InputBlockSize() const
				{
				...
				//	Get:OutputBlockSize
				mscorlib::System::Int32  HMACSHA1::get_OutputBlockSize() const
				{
