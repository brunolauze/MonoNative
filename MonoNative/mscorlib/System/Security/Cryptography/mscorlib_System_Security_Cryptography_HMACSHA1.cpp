	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				//	Get/Set:HashName
				mscorlib::System::String  HMACSHA1::get_HashName()
				{
				...
				//	Get/Set:Key
				std::vector<mscorlib::System::Byte*>  HMACSHA1::get_Key()
				{
				...
				mscorlib::System::Boolean  HMACSHA1::get_CanTransformMultipleBlocks()
				{
				...
				mscorlib::System::Boolean  HMACSHA1::get_CanReuseTransform()
				{
				...
				//	Get:Hash
				std::vector<mscorlib::System::Byte*>  HMACSHA1::get_Hash()
				{
				...
				//	Get:HashSize
				mscorlib::System::Int32  HMACSHA1::get_HashSize()
				{
				...
				//	Get:InputBlockSize
				mscorlib::System::Int32  HMACSHA1::get_InputBlockSize()
				{
				...
				//	Get:OutputBlockSize
				mscorlib::System::Int32  HMACSHA1::get_OutputBlockSize()
				{
