#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_CRYPTOGRAPHY_SHA512_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_CRYPTOGRAPHY_SHA512_H
	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				{
				public:
					SHA512(mscorlib::NativeTypeInfo *nativeTypeInfo)
					...
					SHA512(MonoObject *nativeObject)
					...
					SHA512 & operator=(SHA512 &value) { __native_object__ = value.GetNativeObject(); return value; };
					bool operator==(SHA512 &value) { return mscorlib::System::Object::Equals(value); };
					operator MonoObject*() { return __native_object__; };
					MonoObject* operator=(MonoObject* value) { return __native_object__ = value; };


					static mscorlib::System::Security::Cryptography::SHA512  Create();
					static mscorlib::System::Security::Cryptography::SHA512  Create(mscorlib::System::String hashName);
					static mscorlib::System::Security::Cryptography::SHA512  Create(const char *hashName);
