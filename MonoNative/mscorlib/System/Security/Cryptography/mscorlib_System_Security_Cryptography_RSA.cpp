	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				mscorlib::System::String  RSA::get_KeyExchangeAlgorithm()
				{
				...
				//	Get/Set:KeySize
				mscorlib::System::Int32  RSA::get_KeySize()
				{
				...
				//	Get:LegalKeySizes
				std::vector<mscorlib::System::Security::Cryptography::KeySizes*>  RSA::get_LegalKeySizes()
				{
				...
				mscorlib::System::String  RSA::get_SignatureAlgorithm()
				{
