#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_CRYPTOGRAPHY_RSAOAEPKEYEXCHANGEFORMATTER_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_CRYPTOGRAPHY_RSAOAEPKEYEXCHANGEFORMATTER_H
		...
		namespace Security
		{
			namespace Cryptography
			{
				...
				public:
					...
					: mscorlib::System::Security::Cryptography::AsymmetricKeyExchangeFormatter(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Security.Cryptography.RSAOAEPKeyExchangeFormatter"))
					{
						__native_object__ = Global::New("mscorlib", "System.Security.Cryptography", "RSAOAEPKeyExchangeFormatter");
					};
					...
					: mscorlib::System::Security::Cryptography::AsymmetricKeyExchangeFormatter(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Security.Cryptography.RSAOAEPKeyExchangeFormatter"))
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Security.Cryptography", "RSAOAEPKeyExchangeFormatter", 1, __parameter_types__, __parameters__);
					};
				
					RSAOAEPKeyExchangeFormatter(mscorlib::NativeTypeInfo *nativeTypeInfo)
					: mscorlib::System::Security::Cryptography::AsymmetricKeyExchangeFormatter(nativeTypeInfo)
					{
					};
				
					RSAOAEPKeyExchangeFormatter(MonoObject *nativeObject)
					...
					RSAOAEPKeyExchangeFormatter & operator=(RSAOAEPKeyExchangeFormatter &value) { __native_object__ = value.GetNativeObject(); return value; };
					bool operator==(RSAOAEPKeyExchangeFormatter &value) { return mscorlib::System::Object::Equals(value); };
					...
					//Public Properties
					__declspec(property(get=get_Parameter, put=set_Parameter)) std::vector<mscorlib::System::Byte*>  Parameter;
