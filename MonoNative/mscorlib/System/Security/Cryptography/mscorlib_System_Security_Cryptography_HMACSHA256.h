#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_CRYPTOGRAPHY_HMACSHA256_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_CRYPTOGRAPHY_HMACSHA256_H
	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				public:
					HMACSHA256()
					: mscorlib::System::Security::Cryptography::HMAC(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Security.Cryptography.HMACSHA256"))
					, mscorlib::System::IDisposable(NULL)
					, mscorlib::System::Security::Cryptography::ICryptoTransform(NULL)
					{
						__native_object__ = Global::New("mscorlib", "System.Security.Cryptography", "HMACSHA256");
					};
					...
					, mscorlib::System::Security::Cryptography::ICryptoTransform(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Security.Cryptography", "HMACSHA256", 1, __parameter_types__, __parameters__);
					};
				
					HMACSHA256(mscorlib::NativeTypeInfo *nativeTypeInfo)
					...
					HMACSHA256(MonoObject *nativeObject)
					...
					HMACSHA256 & operator=(HMACSHA256 &value) { __native_object__ = value.GetNativeObject(); return value; };
					bool operator==(HMACSHA256 &value) { return mscorlib::System::Object::Equals(value); };
