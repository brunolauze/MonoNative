#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_CRYPTOGRAPHY_AES_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_CRYPTOGRAPHY_AES_H
		...
		namespace Security
		{
			namespace Cryptography
			{
				...
				public:
					...
					Aes & operator=(Aes &value) { __native_object__ = value.GetNativeObject(); return value; };
					bool operator==(Aes &value) { return mscorlib::System::Object::Equals(value); };
