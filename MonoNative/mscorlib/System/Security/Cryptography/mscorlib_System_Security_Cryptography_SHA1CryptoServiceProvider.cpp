	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				//Public Methods
				void SHA1CryptoServiceProvider::Initialize()
				{
						Global::InvokeMethod("mscorlib", "System.Security.Cryptography", "SHA1CryptoServiceProvider", 0, NULL, "Initialize", __native_object__, 0, NULL, NULL, NULL);
				}

				//Get Set Properties Methods
				//	Get:CanTransformMultipleBlocks
				mscorlib::System::Boolean  SHA1CryptoServiceProvider::get_CanTransformMultipleBlocks() const
				{
				...
				mscorlib::System::Boolean  SHA1CryptoServiceProvider::get_CanReuseTransform() const
				{
				...
				//	Get:Hash
				std::vector<mscorlib::System::Byte*>  SHA1CryptoServiceProvider::get_Hash() const
				{
				...
				//	Get:HashSize
				mscorlib::System::Int32  SHA1CryptoServiceProvider::get_HashSize() const
				{
				...
				//	Get:InputBlockSize
				mscorlib::System::Int32  SHA1CryptoServiceProvider::get_InputBlockSize() const
				{
				...
				//	Get:OutputBlockSize
				mscorlib::System::Int32  SHA1CryptoServiceProvider::get_OutputBlockSize() const
				{
