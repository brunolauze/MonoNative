	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				mscorlib::System::Boolean  SHA1CryptoServiceProvider::get_CanTransformMultipleBlocks()
				{
				...
				mscorlib::System::Boolean  SHA1CryptoServiceProvider::get_CanReuseTransform()
				{
				...
				//	Get:Hash
				std::vector<mscorlib::System::Byte*>  SHA1CryptoServiceProvider::get_Hash()
				{
				...
				//	Get:HashSize
				mscorlib::System::Int32  SHA1CryptoServiceProvider::get_HashSize()
				{
				...
				//	Get:InputBlockSize
				mscorlib::System::Int32  SHA1CryptoServiceProvider::get_InputBlockSize()
				{
				...
				//	Get:OutputBlockSize
				mscorlib::System::Int32  SHA1CryptoServiceProvider::get_OutputBlockSize()
				{
