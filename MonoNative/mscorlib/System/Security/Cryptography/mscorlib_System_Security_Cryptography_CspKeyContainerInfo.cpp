	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				//	Get:Accessible
				mscorlib::System::Boolean  CspKeyContainerInfo::get_Accessible()
				{
				...
				mscorlib::System::Security::AccessControl::CryptoKeySecurity  CspKeyContainerInfo::get_CryptoKeySecurity()
				{
				...
				//	Get:Exportable
				mscorlib::System::Boolean  CspKeyContainerInfo::get_Exportable()
				{
				...
				//	Get:HardwareDevice
				mscorlib::System::Boolean  CspKeyContainerInfo::get_HardwareDevice()
				{
				...
				mscorlib::System::String  CspKeyContainerInfo::get_KeyContainerName()
				{
				...
				//	Get:KeyNumber
				mscorlib::System::Security::Cryptography::KeyNumber::__ENUM__  CspKeyContainerInfo::get_KeyNumber()
				{
				...
				//	Get:MachineKeyStore
				mscorlib::System::Boolean  CspKeyContainerInfo::get_MachineKeyStore()
				{
				...
				//	Get:Protected
				mscorlib::System::Boolean  CspKeyContainerInfo::get_Protected()
				{
				...
				//	Get:ProviderName
				mscorlib::System::String  CspKeyContainerInfo::get_ProviderName()
				{
				...
				//	Get:ProviderType
				mscorlib::System::Int32  CspKeyContainerInfo::get_ProviderType()
				{
				...
				mscorlib::System::Boolean  CspKeyContainerInfo::get_RandomlyGenerated()
				{
				...
				//	Get:Removable
				mscorlib::System::Boolean  CspKeyContainerInfo::get_Removable()
				{
				...
				mscorlib::System::String  CspKeyContainerInfo::get_UniqueKeyContainerName()
				{
