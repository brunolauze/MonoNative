	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				//Public Methods
				void SHA512Managed::Initialize()
				{
						Global::InvokeMethod("mscorlib", "System.Security.Cryptography", "SHA512Managed", 0, NULL, "Initialize", __native_object__, 0, NULL, NULL, NULL);
				}

				//Get Set Properties Methods
				//	Get:CanTransformMultipleBlocks
				mscorlib::System::Boolean  SHA512Managed::get_CanTransformMultipleBlocks() const
				{
				...
				mscorlib::System::Boolean  SHA512Managed::get_CanReuseTransform() const
				{
				...
				//	Get:Hash
				std::vector<mscorlib::System::Byte*>  SHA512Managed::get_Hash() const
				{
				...
				//	Get:HashSize
				mscorlib::System::Int32  SHA512Managed::get_HashSize() const
				{
				...
				//	Get:InputBlockSize
				mscorlib::System::Int32  SHA512Managed::get_InputBlockSize() const
				{
				...
				//	Get:OutputBlockSize
				mscorlib::System::Int32  SHA512Managed::get_OutputBlockSize() const
				{
