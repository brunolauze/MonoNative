#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_CRYPTOGRAPHY_HMACMD5_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_CRYPTOGRAPHY_HMACMD5_H
	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				public:
					HMACMD5()
					: mscorlib::System::Security::Cryptography::HMAC(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Security.Cryptography.HMACMD5"))
					, mscorlib::System::IDisposable(NULL)
					, mscorlib::System::Security::Cryptography::ICryptoTransform(NULL)
					{
						__native_object__ = Global::New("mscorlib", "System.Security.Cryptography", "HMACMD5");
					};
					...
					, mscorlib::System::Security::Cryptography::ICryptoTransform(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Security.Cryptography", "HMACMD5", 1, __parameter_types__, __parameters__);
					};
				
					HMACMD5(mscorlib::NativeTypeInfo *nativeTypeInfo)
					...
					HMACMD5(MonoObject *nativeObject)
					...
					HMACMD5 & operator=(HMACMD5 &value) { __native_object__ = value.GetNativeObject(); return value; };
					bool operator==(HMACMD5 &value) { return mscorlib::System::Object::Equals(value); };
