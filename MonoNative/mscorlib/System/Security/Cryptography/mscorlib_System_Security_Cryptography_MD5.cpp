	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				mscorlib::System::Boolean  MD5::get_CanTransformMultipleBlocks()
				{
				...
				mscorlib::System::Boolean  MD5::get_CanReuseTransform()
				{
				...
				//	Get:Hash
				std::vector<mscorlib::System::Byte*>  MD5::get_Hash()
				{
				...
				//	Get:HashSize
				mscorlib::System::Int32  MD5::get_HashSize()
				{
				...
				//	Get:InputBlockSize
				mscorlib::System::Int32  MD5::get_InputBlockSize()
				{
				...
				//	Get:OutputBlockSize
				mscorlib::System::Int32  MD5::get_OutputBlockSize()
				{
