	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				//Public Methods
				void RijndaelManaged::GenerateIV()
				{
						Global::InvokeMethod("mscorlib", "System.Security.Cryptography", "RijndaelManaged", 0, NULL, "GenerateIV", __native_object__, 0, NULL, NULL, NULL);
				}

				void RijndaelManaged::GenerateKey()
				{
						Global::InvokeMethod("mscorlib", "System.Security.Cryptography", "RijndaelManaged", 0, NULL, "GenerateKey", __native_object__, 0, NULL, NULL, NULL);
				}

				mscorlib::System::Security::Cryptography::ICryptoTransform RijndaelManaged::CreateDecryptor(std::vector<mscorlib::System::Byte*> rgbKey, std::vector<mscorlib::System::Byte*> rgbIV)
				{
						...
						MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Security.Cryptography", "RijndaelManaged", 0, NULL, "CreateDecryptor", __native_object__, 2, __parameter_types__, __parameters__, NULL);
						return mscorlib::System::Security::Cryptography::ICryptoTransform(__result__);
				}

				mscorlib::System::Security::Cryptography::ICryptoTransform RijndaelManaged::CreateEncryptor(std::vector<mscorlib::System::Byte*> rgbKey, std::vector<mscorlib::System::Byte*> rgbIV)
				{
						MonoType *__parameter_types__[2];
						void *__parameters__[2];
						__parameter_types__[0] = mono_class_get_type(mono_type_get_array_type(Global::GetType(typeid(rgbKey).name()))->eklass);
						...
						__parameters__[0] = Global::FromArray<mscorlib::System::Byte*>(rgbKey, typeid(mscorlib::System::Byte).name());
						__parameters__[1] = Global::FromArray<mscorlib::System::Byte*>(rgbIV, typeid(mscorlib::System::Byte).name());
						MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Security.Cryptography", "RijndaelManaged", 0, NULL, "CreateEncryptor", __native_object__, 2, __parameter_types__, __parameters__, NULL);
						return mscorlib::System::Security::Cryptography::ICryptoTransform(__result__);
				}

				//Get Set Properties Methods
				//	Get/Set:BlockSize
				mscorlib::System::Int32  RijndaelManaged::get_BlockSize() const
				{
				...
				void RijndaelManaged::set_BlockSize(mscorlib::System::Int32  value)
				{
				...
				mscorlib::System::Int32  RijndaelManaged::get_FeedbackSize() const
				{
				...
				void RijndaelManaged::set_FeedbackSize(mscorlib::System::Int32  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
					__parameter_types__[0] = Global::GetType(typeid(value).name());
				...
				//	Get/Set:IV
				std::vector<mscorlib::System::Byte*>  RijndaelManaged::get_IV() const
				{
				...
				void RijndaelManaged::set_IV(std::vector<mscorlib::System::Byte*>  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
				...
				//	Get/Set:Key
				std::vector<mscorlib::System::Byte*>  RijndaelManaged::get_Key() const
				{
				...
				void RijndaelManaged::set_Key(std::vector<mscorlib::System::Byte*>  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
					__parameter_types__[0] = mono_class_get_type(mono_type_get_array_type(Global::GetType(typeid(value).name()))->eklass);
				...
				//	Get/Set:KeySize
				mscorlib::System::Int32  RijndaelManaged::get_KeySize() const
				{
				...
				void RijndaelManaged::set_KeySize(mscorlib::System::Int32  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
					__parameter_types__[0] = Global::GetType(typeid(value).name());
				...
				//	Get:LegalBlockSizes
				std::vector<mscorlib::System::Security::Cryptography::KeySizes*>  RijndaelManaged::get_LegalBlockSizes() const
				{
				...
				//	Get:LegalKeySizes
				std::vector<mscorlib::System::Security::Cryptography::KeySizes*>  RijndaelManaged::get_LegalKeySizes() const
				{
				...
				//	Get/Set:Mode
				mscorlib::System::Security::Cryptography::CipherMode::__ENUM__  RijndaelManaged::get_Mode() const
				{
				...
				void RijndaelManaged::set_Mode(mscorlib::System::Security::Cryptography::CipherMode::__ENUM__  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
					__parameter_types__[0] = Global::GetType(typeid(value).name());
				...
				//	Get/Set:Padding
				mscorlib::System::Security::Cryptography::PaddingMode::__ENUM__  RijndaelManaged::get_Padding() const
				{
				...
				void RijndaelManaged::set_Padding(mscorlib::System::Security::Cryptography::PaddingMode::__ENUM__  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
					__parameter_types__[0] = Global::GetType(typeid(value).name());
