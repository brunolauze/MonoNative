	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				//Public Methods
				mscorlib::System::Security::Cryptography::DES DES::Create()
				{
						MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Security.Cryptography", "DES", 0, NULL, "Create", NullMonoObject, 0, NULL, NULL, NULL);
						return mscorlib::System::Security::Cryptography::DES(__result__);
				}

				mscorlib::System::Security::Cryptography::DES DES::Create(mscorlib::System::String algName)
				{
				...
				mscorlib::System::Boolean DES::IsWeakKey(std::vector<mscorlib::System::Byte*> rgbKey)
				{
						MonoType *__parameter_types__[1];
						void *__parameters__[1];
						...
						MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Security.Cryptography", "DES", 0, NULL, "IsWeakKey", NullMonoObject, 1, __parameter_types__, __parameters__, NULL);
						return *(mscorlib::System::Boolean*)mono_object_unbox(__result__);
				}

				mscorlib::System::Boolean DES::IsSemiWeakKey(std::vector<mscorlib::System::Byte*> rgbKey)
				{
						MonoType *__parameter_types__[1];
						void *__parameters__[1];
						__parameter_types__[0] = mono_class_get_type(mono_type_get_array_type(Global::GetType(typeid(rgbKey).name()))->eklass);
						__parameters__[0] = Global::FromArray<mscorlib::System::Byte*>(rgbKey, typeid(mscorlib::System::Byte).name());
						MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Security.Cryptography", "DES", 0, NULL, "IsSemiWeakKey", NullMonoObject, 1, __parameter_types__, __parameters__, NULL);
						return *(mscorlib::System::Boolean*)mono_object_unbox(__result__);
				}

				//Get Set Properties Methods
				//	Get/Set:Key
				std::vector<mscorlib::System::Byte*>  DES::get_Key()
				{
				...
				void DES::set_Key(std::vector<mscorlib::System::Byte*>  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
				...
				//	Get/Set:BlockSize
				mscorlib::System::Int32  DES::get_BlockSize()
				{
				...
				void DES::set_BlockSize(mscorlib::System::Int32  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
				...
				mscorlib::System::Int32  DES::get_FeedbackSize()
				{
				...
				void DES::set_FeedbackSize(mscorlib::System::Int32  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
					__parameter_types__[0] = Global::GetType(typeid(value).name());
				...
				//	Get/Set:IV
				std::vector<mscorlib::System::Byte*>  DES::get_IV()
				{
				...
				void DES::set_IV(std::vector<mscorlib::System::Byte*>  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
					__parameter_types__[0] = mono_class_get_type(mono_type_get_array_type(Global::GetType(typeid(value).name()))->eklass);
				...
				//	Get/Set:KeySize
				mscorlib::System::Int32  DES::get_KeySize()
				{
				...
				void DES::set_KeySize(mscorlib::System::Int32  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
					__parameter_types__[0] = Global::GetType(typeid(value).name());
				...
				//	Get:LegalBlockSizes
				std::vector<mscorlib::System::Security::Cryptography::KeySizes*>  DES::get_LegalBlockSizes()
				{
				...
				//	Get:LegalKeySizes
				std::vector<mscorlib::System::Security::Cryptography::KeySizes*>  DES::get_LegalKeySizes()
				{
				...
				//	Get/Set:Mode
				mscorlib::System::Security::Cryptography::CipherMode::__ENUM__  DES::get_Mode()
				{
				...
				//	Get/Set:Padding
				mscorlib::System::Security::Cryptography::PaddingMode::__ENUM__  DES::get_Padding()
				{
