	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				//	Get/Set:HashName
				mscorlib::System::String  HMACMD5::get_HashName()
				{
				...
				//	Get/Set:Key
				std::vector<mscorlib::System::Byte*>  HMACMD5::get_Key()
				{
				...
				mscorlib::System::Boolean  HMACMD5::get_CanTransformMultipleBlocks()
				{
				...
				mscorlib::System::Boolean  HMACMD5::get_CanReuseTransform()
				{
				...
				//	Get:Hash
				std::vector<mscorlib::System::Byte*>  HMACMD5::get_Hash()
				{
				...
				//	Get:HashSize
				mscorlib::System::Int32  HMACMD5::get_HashSize()
				{
				...
				//	Get:InputBlockSize
				mscorlib::System::Int32  HMACMD5::get_InputBlockSize()
				{
				...
				//	Get:OutputBlockSize
				mscorlib::System::Int32  HMACMD5::get_OutputBlockSize()
				{
