#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_CRYPTOGRAPHY_CRYPTOGRAPHICEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_CRYPTOGRAPHY_CRYPTOGRAPHICEXCEPTION_H
		...
		namespace Security
		{
			namespace Cryptography
			{
				...
				public:
					...
					: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Security.Cryptography.CryptographicException"))
					, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						__native_object__ = Global::New("mscorlib", "System.Security.Cryptography", "CryptographicException");
					};
					...
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						...
						__parameters__[0] = &hr;
						__native_object__ = Global::New("mscorlib", "System.Security.Cryptography", "CryptographicException", 1, __parameter_types__, __parameters__);
					};
					...
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Security.Cryptography", "CryptographicException", 2, __parameter_types__, __parameters__);
					};
					...
					CryptographicException(mscorlib::NativeTypeInfo *nativeTypeInfo)
					...
					CryptographicException(MonoObject *nativeObject)
					...
					CryptographicException & operator=(CryptographicException &value) { __native_object__ = value.GetNativeObject(); return value; };
					bool operator==(CryptographicException &value) { return mscorlib::System::Object::Equals(value); };
