	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				//Public Methods
				mscorlib::System::Security::Cryptography::SHA512 SHA512::Create()
				{
						MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Security.Cryptography", "SHA512", 0, NULL, "Create", NullMonoObject, 0, NULL, NULL, NULL);
						return mscorlib::System::Security::Cryptography::SHA512(__result__);
				}

				mscorlib::System::Security::Cryptography::SHA512 SHA512::Create(mscorlib::System::String hashName)
				{
						...
						MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Security.Cryptography", "SHA512", 0, NULL, "Create", NullMonoObject, 1, __parameter_types__, __parameters__, NULL);
						return mscorlib::System::Security::Cryptography::SHA512(__result__);
				}

				mscorlib::System::Security::Cryptography::SHA512 SHA512::Create(const char *hashName)
				{
						MonoType *__parameter_types__[1];
						void *__parameters__[1];
						__parameter_types__[0] = Global::GetType(typeid(hashName).name());
				...
				mscorlib::System::Boolean  SHA512::get_CanTransformMultipleBlocks() const
				{
				...
				mscorlib::System::Boolean  SHA512::get_CanReuseTransform() const
				{
				...
				//	Get:Hash
				std::vector<mscorlib::System::Byte*>  SHA512::get_Hash() const
				{
				...
				//	Get:HashSize
				mscorlib::System::Int32  SHA512::get_HashSize() const
				{
				...
				//	Get:InputBlockSize
				mscorlib::System::Int32  SHA512::get_InputBlockSize() const
				{
				...
				//	Get:OutputBlockSize
				mscorlib::System::Int32  SHA512::get_OutputBlockSize() const
				{
