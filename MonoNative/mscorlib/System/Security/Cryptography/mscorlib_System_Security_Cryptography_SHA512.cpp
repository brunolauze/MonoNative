	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				mscorlib::System::Boolean  SHA512::get_CanTransformMultipleBlocks()
				{
				...
				mscorlib::System::Boolean  SHA512::get_CanReuseTransform()
				{
				...
				//	Get:Hash
				std::vector<mscorlib::System::Byte*>  SHA512::get_Hash()
				{
				...
				//	Get:HashSize
				mscorlib::System::Int32  SHA512::get_HashSize()
				{
				...
				//	Get:InputBlockSize
				mscorlib::System::Int32  SHA512::get_InputBlockSize()
				{
				...
				//	Get:OutputBlockSize
				mscorlib::System::Int32  SHA512::get_OutputBlockSize()
				{
