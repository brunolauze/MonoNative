	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				//	Get/Set:Key
				std::vector<mscorlib::System::Byte*>  DESCryptoServiceProvider::get_Key() const
				{
				...
				//	Get/Set:BlockSize
				mscorlib::System::Int32  DESCryptoServiceProvider::get_BlockSize() const
				{
				...
				mscorlib::System::Int32  DESCryptoServiceProvider::get_FeedbackSize() const
				{
				...
				//	Get/Set:IV
				std::vector<mscorlib::System::Byte*>  DESCryptoServiceProvider::get_IV() const
				{
				...
				//	Get/Set:KeySize
				mscorlib::System::Int32  DESCryptoServiceProvider::get_KeySize() const
				{
				...
				//	Get:LegalBlockSizes
				std::vector<mscorlib::System::Security::Cryptography::KeySizes*>  DESCryptoServiceProvider::get_LegalBlockSizes() const
				{
				...
				//	Get:LegalKeySizes
				std::vector<mscorlib::System::Security::Cryptography::KeySizes*>  DESCryptoServiceProvider::get_LegalKeySizes() const
				{
				...
				//	Get/Set:Mode
				mscorlib::System::Security::Cryptography::CipherMode::__ENUM__  DESCryptoServiceProvider::get_Mode() const
				{
				...
				//	Get/Set:Padding
				mscorlib::System::Security::Cryptography::PaddingMode::__ENUM__  DESCryptoServiceProvider::get_Padding() const
				{
