	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				mscorlib::System::Boolean  SHA384Managed::get_CanTransformMultipleBlocks()
				{
				...
				mscorlib::System::Boolean  SHA384Managed::get_CanReuseTransform()
				{
				...
				//	Get:Hash
				std::vector<mscorlib::System::Byte*>  SHA384Managed::get_Hash()
				{
				...
				//	Get:HashSize
				mscorlib::System::Int32  SHA384Managed::get_HashSize()
				{
				...
				//	Get:InputBlockSize
				mscorlib::System::Int32  SHA384Managed::get_InputBlockSize()
				{
				...
				//	Get:OutputBlockSize
				mscorlib::System::Int32  SHA384Managed::get_OutputBlockSize()
				{
