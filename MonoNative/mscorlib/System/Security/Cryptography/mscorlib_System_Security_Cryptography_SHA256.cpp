	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				mscorlib::System::Boolean  SHA256::get_CanTransformMultipleBlocks()
				{
				...
				mscorlib::System::Boolean  SHA256::get_CanReuseTransform()
				{
				...
				//	Get:Hash
				std::vector<mscorlib::System::Byte*>  SHA256::get_Hash()
				{
				...
				//	Get:HashSize
				mscorlib::System::Int32  SHA256::get_HashSize()
				{
				...
				//	Get:InputBlockSize
				mscorlib::System::Int32  SHA256::get_InputBlockSize()
				{
				...
				//	Get:OutputBlockSize
				mscorlib::System::Int32  SHA256::get_OutputBlockSize()
				{
