	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				//	Get/Set:Padding
				mscorlib::System::Security::Cryptography::PaddingMode::__ENUM__  MACTripleDES::get_Padding()
				{
				...
				//	Get/Set:Key
				std::vector<mscorlib::System::Byte*>  MACTripleDES::get_Key()
				{
				...
				mscorlib::System::Boolean  MACTripleDES::get_CanTransformMultipleBlocks()
				{
				...
				mscorlib::System::Boolean  MACTripleDES::get_CanReuseTransform()
				{
				...
				//	Get:Hash
				std::vector<mscorlib::System::Byte*>  MACTripleDES::get_Hash()
				{
				...
				//	Get:HashSize
				mscorlib::System::Int32  MACTripleDES::get_HashSize()
				{
				...
				//	Get:InputBlockSize
				mscorlib::System::Int32  MACTripleDES::get_InputBlockSize()
				{
				...
				//	Get:OutputBlockSize
				mscorlib::System::Int32  MACTripleDES::get_OutputBlockSize()
				{
