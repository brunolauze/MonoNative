	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				//Public Methods
				void SHA256Managed::Initialize()
				{
						Global::InvokeMethod("mscorlib", "System.Security.Cryptography", "SHA256Managed", 0, NULL, "Initialize", __native_object__, 0, NULL, NULL, NULL);
				}

				//Get Set Properties Methods
				//	Get:CanTransformMultipleBlocks
				mscorlib::System::Boolean  SHA256Managed::get_CanTransformMultipleBlocks() const
				{
				...
				mscorlib::System::Boolean  SHA256Managed::get_CanReuseTransform() const
				{
				...
				//	Get:Hash
				std::vector<mscorlib::System::Byte*>  SHA256Managed::get_Hash() const
				{
				...
				//	Get:HashSize
				mscorlib::System::Int32  SHA256Managed::get_HashSize() const
				{
				...
				//	Get:InputBlockSize
				mscorlib::System::Int32  SHA256Managed::get_InputBlockSize() const
				{
				...
				//	Get:OutputBlockSize
				mscorlib::System::Int32  SHA256Managed::get_OutputBlockSize() const
				{
