	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				mscorlib::System::Boolean  SHA256Managed::get_CanTransformMultipleBlocks()
				{
				...
				mscorlib::System::Boolean  SHA256Managed::get_CanReuseTransform()
				{
				...
				//	Get:Hash
				std::vector<mscorlib::System::Byte*>  SHA256Managed::get_Hash()
				{
				...
				//	Get:HashSize
				mscorlib::System::Int32  SHA256Managed::get_HashSize()
				{
				...
				//	Get:InputBlockSize
				mscorlib::System::Int32  SHA256Managed::get_InputBlockSize()
				{
				...
				//	Get:OutputBlockSize
				mscorlib::System::Int32  SHA256Managed::get_OutputBlockSize()
				{
