#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_CRYPTOGRAPHY_RIJNDAEL_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_CRYPTOGRAPHY_RIJNDAEL_H
	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				{
				public:
					Rijndael(mscorlib::NativeTypeInfo *nativeTypeInfo)
					: mscorlib::System::Security::Cryptography::SymmetricAlgorithm(nativeTypeInfo)
					, mscorlib::System::IDisposable(NULL)
					{
					};
				
					Rijndael(MonoObject *nativeObject)
					...
					Rijndael & operator=(Rijndael &value) { __native_object__ = value.GetNativeObject(); return value; };
					bool operator==(Rijndael &value) { return mscorlib::System::Object::Equals(value); };
