#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_CRYPTOGRAPHY_TRIPLEDES_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_CRYPTOGRAPHY_TRIPLEDES_H
	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				{
				public:
					TripleDES(mscorlib::NativeTypeInfo *nativeTypeInfo)
					: mscorlib::System::Security::Cryptography::SymmetricAlgorithm(nativeTypeInfo)
					, mscorlib::System::IDisposable(NULL)
					{
					};
				
					TripleDES(MonoObject *nativeObject)
					...
					static mscorlib::System::Security::Cryptography::TripleDES  Create(const char *str);
