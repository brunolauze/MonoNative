	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				//Public Methods
				mscorlib::System::Security::Cryptography::Rijndael Rijndael::Create()
				{
						MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Security.Cryptography", "Rijndael", 0, NULL, "Create", NullMonoObject, 0, NULL, NULL, NULL);
						return mscorlib::System::Security::Cryptography::Rijndael(__result__);
				}

				mscorlib::System::Security::Cryptography::Rijndael Rijndael::Create(mscorlib::System::String algName)
				{
						...
						MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Security.Cryptography", "Rijndael", 0, NULL, "Create", NullMonoObject, 1, __parameter_types__, __parameters__, NULL);
						return mscorlib::System::Security::Cryptography::Rijndael(__result__);
				}

				mscorlib::System::Security::Cryptography::Rijndael Rijndael::Create(const char *algName)
				{
						MonoType *__parameter_types__[1];
						void *__parameters__[1];
						__parameter_types__[0] = Global::GetType(typeid(algName).name());
				...
				//	Get/Set:BlockSize
				mscorlib::System::Int32  Rijndael::get_BlockSize() const
				{
				...
				void Rijndael::set_BlockSize(mscorlib::System::Int32  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
				...
				mscorlib::System::Int32  Rijndael::get_FeedbackSize() const
				{
				...
				void Rijndael::set_FeedbackSize(mscorlib::System::Int32  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
					__parameter_types__[0] = Global::GetType(typeid(value).name());
				...
				//	Get/Set:IV
				std::vector<mscorlib::System::Byte*>  Rijndael::get_IV() const
				{
				...
				void Rijndael::set_IV(std::vector<mscorlib::System::Byte*>  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
				...
				//	Get/Set:Key
				std::vector<mscorlib::System::Byte*>  Rijndael::get_Key() const
				{
				...
				void Rijndael::set_Key(std::vector<mscorlib::System::Byte*>  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
					__parameter_types__[0] = mono_class_get_type(mono_type_get_array_type(Global::GetType(typeid(value).name()))->eklass);
				...
				//	Get/Set:KeySize
				mscorlib::System::Int32  Rijndael::get_KeySize() const
				{
				...
				void Rijndael::set_KeySize(mscorlib::System::Int32  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
					__parameter_types__[0] = Global::GetType(typeid(value).name());
				...
				//	Get:LegalBlockSizes
				std::vector<mscorlib::System::Security::Cryptography::KeySizes*>  Rijndael::get_LegalBlockSizes() const
				{
				...
				//	Get:LegalKeySizes
				std::vector<mscorlib::System::Security::Cryptography::KeySizes*>  Rijndael::get_LegalKeySizes() const
				{
				...
				//	Get/Set:Mode
				mscorlib::System::Security::Cryptography::CipherMode::__ENUM__  Rijndael::get_Mode() const
				{
				...
				void Rijndael::set_Mode(mscorlib::System::Security::Cryptography::CipherMode::__ENUM__  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
					__parameter_types__[0] = Global::GetType(typeid(value).name());
				...
				//	Get/Set:Padding
				mscorlib::System::Security::Cryptography::PaddingMode::__ENUM__  Rijndael::get_Padding() const
				{
				...
				void Rijndael::set_Padding(mscorlib::System::Security::Cryptography::PaddingMode::__ENUM__  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
					__parameter_types__[0] = Global::GetType(typeid(value).name());
