	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				//	Get/Set:BlockSize
				mscorlib::System::Int32  Aes::get_BlockSize()
				{
				...
				mscorlib::System::Int32  Aes::get_FeedbackSize()
				{
				...
				//	Get/Set:IV
				std::vector<mscorlib::System::Byte*>  Aes::get_IV()
				{
				...
				//	Get/Set:Key
				std::vector<mscorlib::System::Byte*>  Aes::get_Key()
				{
				...
				//	Get/Set:KeySize
				mscorlib::System::Int32  Aes::get_KeySize()
				{
				...
				//	Get:LegalBlockSizes
				std::vector<mscorlib::System::Security::Cryptography::KeySizes*>  Aes::get_LegalBlockSizes()
				{
				...
				//	Get:LegalKeySizes
				std::vector<mscorlib::System::Security::Cryptography::KeySizes*>  Aes::get_LegalKeySizes()
				{
				...
				//	Get/Set:Mode
				mscorlib::System::Security::Cryptography::CipherMode::__ENUM__  Aes::get_Mode()
				{
				...
				//	Get/Set:Padding
				mscorlib::System::Security::Cryptography::PaddingMode::__ENUM__  Aes::get_Padding()
				{
