	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				mscorlib::System::Boolean  SHA384::get_CanTransformMultipleBlocks()
				{
				...
				mscorlib::System::Boolean  SHA384::get_CanReuseTransform()
				{
				...
				//	Get:Hash
				std::vector<mscorlib::System::Byte*>  SHA384::get_Hash()
				{
				...
				//	Get:HashSize
				mscorlib::System::Int32  SHA384::get_HashSize()
				{
				...
				//	Get:InputBlockSize
				mscorlib::System::Int32  SHA384::get_InputBlockSize()
				{
				...
				//	Get:OutputBlockSize
				mscorlib::System::Int32  SHA384::get_OutputBlockSize()
				{
