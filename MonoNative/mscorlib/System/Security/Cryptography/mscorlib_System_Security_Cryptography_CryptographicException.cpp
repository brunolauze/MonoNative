	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				//	Get:InnerException
				mscorlib::System::Exception  CryptographicException::get_InnerException()
				{
				...
				//	Get/Set:HelpLink
				mscorlib::System::String  CryptographicException::get_HelpLink()
				{
				...
				//	Get/Set:HResult
				mscorlib::System::Int32  CryptographicException::get_HResult()
				{
				...
				//	Get:Message
				mscorlib::System::String  CryptographicException::get_Message()
				{
				...
				//	Get/Set:Source
				mscorlib::System::String  CryptographicException::get_Source()
				{
				...
				//	Get:StackTrace
				mscorlib::System::String  CryptographicException::get_StackTrace()
				{
				...
				//	Get:TargetSite
				mscorlib::System::Reflection::MethodBase  CryptographicException::get_TargetSite()
				{
				...
				//	Get:Data
				mscorlib::System::Collections::IDictionary  CryptographicException::get_Data()
				{
