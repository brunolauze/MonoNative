	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				//Public Methods
				void MD5CryptoServiceProvider::Initialize()
				{
						Global::InvokeMethod("mscorlib", "System.Security.Cryptography", "MD5CryptoServiceProvider", 0, NULL, "Initialize", __native_object__, 0, NULL, NULL, NULL);
				}

				//Get Set Properties Methods
				//	Get:CanTransformMultipleBlocks
				mscorlib::System::Boolean  MD5CryptoServiceProvider::get_CanTransformMultipleBlocks() const
				{
				...
				mscorlib::System::Boolean  MD5CryptoServiceProvider::get_CanReuseTransform() const
				{
				...
				//	Get:Hash
				std::vector<mscorlib::System::Byte*>  MD5CryptoServiceProvider::get_Hash() const
				{
				...
				//	Get:HashSize
				mscorlib::System::Int32  MD5CryptoServiceProvider::get_HashSize() const
				{
				...
				//	Get:InputBlockSize
				mscorlib::System::Int32  MD5CryptoServiceProvider::get_InputBlockSize() const
				{
				...
				//	Get:OutputBlockSize
				mscorlib::System::Int32  MD5CryptoServiceProvider::get_OutputBlockSize() const
				{
