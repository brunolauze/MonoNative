	...
	namespace System
	{
		namespace Security
		{
			namespace Cryptography
			{
				...
				mscorlib::System::Boolean  MD5CryptoServiceProvider::get_CanTransformMultipleBlocks()
				{
				...
				mscorlib::System::Boolean  MD5CryptoServiceProvider::get_CanReuseTransform()
				{
				...
				//	Get:Hash
				std::vector<mscorlib::System::Byte*>  MD5CryptoServiceProvider::get_Hash()
				{
				...
				//	Get:HashSize
				mscorlib::System::Int32  MD5CryptoServiceProvider::get_HashSize()
				{
				...
				//	Get:InputBlockSize
				mscorlib::System::Int32  MD5CryptoServiceProvider::get_InputBlockSize()
				{
				...
				//	Get:OutputBlockSize
				mscorlib::System::Int32  MD5CryptoServiceProvider::get_OutputBlockSize()
				{
