...
namespace mscorlib
{
	namespace System
	{
		namespace Security
		{
			...
			//	Get:InnerException
			mscorlib::System::Exception  XmlSyntaxException::get_InnerException()
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  XmlSyntaxException::get_HelpLink()
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  XmlSyntaxException::get_HResult()
			{
			...
			//	Get:Message
			mscorlib::System::String  XmlSyntaxException::get_Message()
			{
			...
			//	Get/Set:Source
			mscorlib::System::String  XmlSyntaxException::get_Source()
			{
			...
			//	Get:StackTrace
			mscorlib::System::String  XmlSyntaxException::get_StackTrace()
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  XmlSyntaxException::get_TargetSite()
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  XmlSyntaxException::get_Data()
			{
