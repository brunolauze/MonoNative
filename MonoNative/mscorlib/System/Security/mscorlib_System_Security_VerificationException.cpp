...
namespace mscorlib
{
	namespace System
	{
		namespace Security
		{
			...
			//	Get:InnerException
			mscorlib::System::Exception  VerificationException::get_InnerException()
			{
			...
			//	Get/Set:HelpLink
			mscorlib::System::String  VerificationException::get_HelpLink()
			{
			...
			//	Get/Set:HResult
			mscorlib::System::Int32  VerificationException::get_HResult()
			{
			...
			//	Get:Message
			mscorlib::System::String  VerificationException::get_Message()
			{
			...
			//	Get/Set:Source
			mscorlib::System::String  VerificationException::get_Source()
			{
			...
			//	Get:StackTrace
			mscorlib::System::String  VerificationException::get_StackTrace()
			{
			...
			//	Get:TargetSite
			mscorlib::System::Reflection::MethodBase  VerificationException::get_TargetSite()
			{
			...
			//	Get:Data
			mscorlib::System::Collections::IDictionary  VerificationException::get_Data()
			{
