#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_VERIFICATIONEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_VERIFICATIONEXCEPTION_H
	...
	namespace System
	{
		namespace Security
		{
			...
			public:
				...
				: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Security.VerificationException"))
				, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					__native_object__ = Global::New("mscorlib", "System.Security", "VerificationException");
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.Security", "VerificationException", 1, __parameter_types__, __parameters__);
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.Security", "VerificationException", 2, __parameter_types__, __parameters__);
				};
			
				VerificationException(mscorlib::NativeTypeInfo *nativeTypeInfo)
				...
				VerificationException(MonoObject *nativeObject)
				...
				VerificationException & operator=(VerificationException &value) { __native_object__ = value.GetNativeObject(); return value; };
				bool operator==(VerificationException &value) { return mscorlib::System::Object::Equals(value); };
