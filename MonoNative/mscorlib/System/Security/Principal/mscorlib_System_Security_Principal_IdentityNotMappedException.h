		...
		namespace Security
		{
			namespace Principal
			{
				...
				public:
					...
					bool operator==(IdentityNotMappedException &value) { return mscorlib::System::Object::Equals(value); };
					...
					mscorlib::System::Security::Principal::IdentityReferenceCollection  get_UnmappedIdentities() const;
