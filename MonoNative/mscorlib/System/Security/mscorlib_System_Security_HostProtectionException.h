	...
	namespace System
	{
		namespace Security
		{
			...
			public:
				...
				mscorlib::System::Security::Permissions::HostProtectionResource::__ENUM__  get_DemandedResources();

				//	Get:ProtectedResources
				mscorlib::System::Security::Permissions::HostProtectionResource::__ENUM__  get_ProtectedResources();
