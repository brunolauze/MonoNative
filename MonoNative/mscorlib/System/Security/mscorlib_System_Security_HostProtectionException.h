		...
		namespace Security
		{
			...
			public:
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__parameters__[0] = (MonoObject*)message;
					mscorlib::System::Int32 __param_protectedResources__ = protectedResources;
					__parameters__[1] = &__param_protectedResources__;
					mscorlib::System::Int32 __param_demandedResources__ = demandedResources;
				...
				bool operator==(HostProtectionException &value) { return mscorlib::System::Object::Equals(value); };
