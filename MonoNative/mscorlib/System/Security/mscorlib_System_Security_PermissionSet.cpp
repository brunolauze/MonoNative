...
namespace mscorlib
{
	namespace System
	{
		namespace Security
		{
			...
			//	Get:Count
			mscorlib::System::Int32  PermissionSet::get_Count()
			{
			...
			//	Get:IsSynchronized
			mscorlib::System::Boolean  PermissionSet::get_IsSynchronized()
			{
			...
			//	Get:IsReadOnly
			mscorlib::System::Boolean  PermissionSet::get_IsReadOnly()
			{
			...
			//	Get:SyncRoot
			mscorlib::System::Object  PermissionSet::get_SyncRoot()
			{
