...
namespace mscorlib
{
	namespace System
	{
		namespace Security
		{
			...
			//	Get:Scope
			mscorlib::System::Security::SecurityCriticalScope::__ENUM__  SecurityCriticalAttribute::get_Scope()
			{
			...
			//	Get:TypeId
			mscorlib::System::Object  SecurityCriticalAttribute::get_TypeId()
			{
