#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_XMLSYNTAXEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_XMLSYNTAXEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		namespace Security
		{
			...
			public:
				XmlSyntaxException()
				: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Security.XmlSyntaxException"))
				, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					__native_object__ = Global::New("mscorlib", "System.Security", "XmlSyntaxException");
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__parameters__[0] = &lineNumber;
					__native_object__ = Global::New("mscorlib", "System.Security", "XmlSyntaxException", 1, __parameter_types__, __parameters__);
				};
				...
				, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
				{
					...
					__native_object__ = Global::New("mscorlib", "System.Security", "XmlSyntaxException", 2, __parameter_types__, __parameters__);
				};
				...
				XmlSyntaxException(mscorlib::NativeTypeInfo *nativeTypeInfo)
				...
				XmlSyntaxException(MonoObject *nativeObject)
				...
				XmlSyntaxException & operator=(XmlSyntaxException &value) { __native_object__ = value.GetNativeObject(); return value; };
				bool operator==(XmlSyntaxException &value) { return mscorlib::System::Object::Equals(value); };
