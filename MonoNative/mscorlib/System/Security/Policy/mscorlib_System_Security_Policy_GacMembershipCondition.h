#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_POLICY_GACMEMBERSHIPCONDITION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_POLICY_GACMEMBERSHIPCONDITION_H
		...
		namespace Security
		{
			namespace Policy
			{
				...
				public:
					...
					: mscorlib::System::Object(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Security.Policy.GacMembershipCondition"))
					...
					{
						__native_object__ = Global::New("mscorlib", "System.Security.Policy", "GacMembershipCondition");
					};
				
					GacMembershipCondition(mscorlib::NativeTypeInfo *nativeTypeInfo)
					...
					GacMembershipCondition(MonoObject *nativeObject)
					...
					GacMembershipCondition & operator=(GacMembershipCondition &value) { __native_object__ = value.GetNativeObject(); return value; };
					bool operator==(GacMembershipCondition &value) { return mscorlib::System::Object::Equals(value); };
