	...
	namespace System
	{
		namespace Security
		{
			namespace Policy
			{
				...
				mscorlib::System::Security::NamedPermissionSet PolicyLevel::ChangeNamedPermissionSet(const char *name, mscorlib::System::Security::PermissionSet pSet)
				{
						MonoType *__parameter_types__[2];
						void *__parameters__[2];
						__parameter_types__[0] = Global::GetType(typeid(name).name());
				...
				mscorlib::System::Security::NamedPermissionSet PolicyLevel::GetNamedPermissionSet(const char *name)
				{
						MonoType *__parameter_types__[1];
						void *__parameters__[1];
						__parameter_types__[0] = Global::GetType(typeid(name).name());
				...
				mscorlib::System::Security::NamedPermissionSet PolicyLevel::RemoveNamedPermissionSet(const char *name)
				{
						MonoType *__parameter_types__[1];
						void *__parameters__[1];
						__parameter_types__[0] = Global::GetType(typeid(name).name());
