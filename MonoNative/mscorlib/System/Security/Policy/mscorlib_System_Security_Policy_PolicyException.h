#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_POLICY_POLICYEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_POLICY_POLICYEXCEPTION_H
	...
	namespace System
	{
		namespace Security
		{
			namespace Policy
			{
				...
				public:
					PolicyException()
					: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Security.Policy.PolicyException"))
					, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						__native_object__ = Global::New("mscorlib", "System.Security.Policy", "PolicyException");
					};
					...
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Security.Policy", "PolicyException", 1, __parameter_types__, __parameters__);
					};
					...
					, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Security.Policy", "PolicyException", 2, __parameter_types__, __parameters__);
					};
				
					PolicyException(mscorlib::NativeTypeInfo *nativeTypeInfo)
					...
					PolicyException(MonoObject *nativeObject)
					...
					PolicyException & operator=(PolicyException &value) { __native_object__ = value.GetNativeObject(); return value; };
					bool operator==(PolicyException &value) { return mscorlib::System::Object::Equals(value); };
