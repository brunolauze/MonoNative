	...
	namespace System
	{
		namespace Security
		{
			namespace Policy
			{
				...
				//	Get:InnerException
				mscorlib::System::Exception  PolicyException::get_InnerException() const
				{
				...
				//	Get/Set:HelpLink
				mscorlib::System::String  PolicyException::get_HelpLink() const
				{
				...
				void PolicyException::set_HelpLink(mscorlib::System::String  value)
				{
				...
				//	Get/Set:HResult
				mscorlib::System::Int32  PolicyException::get_HResult() const
				{
				...
				void PolicyException::set_HResult(mscorlib::System::Int32  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
					__parameter_types__[0] = Global::GetType(typeid(value).name());
				...
				//	Get:Message
				mscorlib::System::String  PolicyException::get_Message() const
				{
				...
				//	Get:StackTrace
				mscorlib::System::String  PolicyException::get_StackTrace() const
				{
				...
				//	Get:TargetSite
				mscorlib::System::Reflection::MethodBase  PolicyException::get_TargetSite() const
				{
				...
				//	Get:Data
				mscorlib::System::Collections::IDictionary  PolicyException::get_Data() const
				{
