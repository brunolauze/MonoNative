	...
	namespace System
	{
		namespace Security
		{
			namespace Policy
			{
				...
				//	Get:InnerException
				mscorlib::System::Exception  PolicyException::get_InnerException()
				{
				...
				//	Get/Set:HelpLink
				mscorlib::System::String  PolicyException::get_HelpLink()
				{
				...
				//	Get/Set:HResult
				mscorlib::System::Int32  PolicyException::get_HResult()
				{
				...
				//	Get:Message
				mscorlib::System::String  PolicyException::get_Message()
				{
				...
				//	Get/Set:Source
				mscorlib::System::String  PolicyException::get_Source()
				{
				...
				//	Get:StackTrace
				mscorlib::System::String  PolicyException::get_StackTrace()
				{
				...
				//	Get:TargetSite
				mscorlib::System::Reflection::MethodBase  PolicyException::get_TargetSite()
				{
				...
				//	Get:Data
				mscorlib::System::Collections::IDictionary  PolicyException::get_Data()
				{
