	...
	namespace System
	{
		namespace Security
		{
			namespace Policy
			{
				...
				//	Get:MergeLogic
				mscorlib::System::String  FirstMatchCodeGroup::get_MergeLogic()
				{
				...
				mscorlib::System::Security::Policy::PolicyStatement  FirstMatchCodeGroup::get_PolicyStatement()
				{
				...
				//	Get/Set:Description
				mscorlib::System::String  FirstMatchCodeGroup::get_Description()
				{
				...
				mscorlib::System::Security::Policy::IMembershipCondition  FirstMatchCodeGroup::get_MembershipCondition()
				{
				...
				//	Get/Set:Name
				mscorlib::System::String  FirstMatchCodeGroup::get_Name()
				{
				...
				//	Get/Set:Children
				mscorlib::System::Collections::IList  FirstMatchCodeGroup::get_Children()
				{
				...
				//	Get:AttributeString
				mscorlib::System::String  FirstMatchCodeGroup::get_AttributeString()
				{
				...
				mscorlib::System::String  FirstMatchCodeGroup::get_PermissionSetName()
				{
