#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_POLICY_UNIONCODEGROUP_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_POLICY_UNIONCODEGROUP_H
	...
	namespace System
	{
		namespace Security
		{
			namespace Policy
			{
				...
				{
				public:
					UnionCodeGroup(mscorlib::System::Security::Policy::IMembershipCondition membershipCondition, mscorlib::System::Security::Policy::PolicyStatement policy)
					: mscorlib::System::Security::Policy::CodeGroup(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Security.Policy.UnionCodeGroup"))
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Security.Policy", "UnionCodeGroup", 2, __parameter_types__, __parameters__);
					};
				
					UnionCodeGroup(mscorlib::NativeTypeInfo *nativeTypeInfo)
					: mscorlib::System::Security::Policy::CodeGroup(nativeTypeInfo)
					{
					};
				
					UnionCodeGroup(MonoObject *nativeObject)
					...
					UnionCodeGroup & operator=(UnionCodeGroup &value) { __native_object__ = value.GetNativeObject(); return value; };
					bool operator==(UnionCodeGroup &value) { return mscorlib::System::Object::Equals(value); };
