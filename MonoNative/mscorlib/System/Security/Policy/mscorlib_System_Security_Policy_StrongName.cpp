	...
	namespace System
	{
		namespace Security
		{
			namespace Policy
			{
				...
				//	Get:Name
				mscorlib::System::String  StrongName::get_Name()
				{
				...
				//	Get:PublicKey
				mscorlib::System::Security::Permissions::StrongNamePublicKeyBlob  StrongName::get_PublicKey()
				{
				...
				//	Get:Version
				mscorlib::System::Version  StrongName::get_Version()
				{
