	...
	namespace System
	{
		namespace Security
		{
			namespace Permissions
			{
				...
				//Public Methods
				mscorlib::System::Security::IPermission ZoneIdentityPermissionAttribute::CreatePermission()
				{
						MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Security.Permissions", "ZoneIdentityPermissionAttribute", 0, NULL, "CreatePermission", __native_object__, 0, NULL, NULL, NULL);
						return mscorlib::System::Security::IPermission(__result__);
				}

				//Get Set Properties Methods
				//	Get/Set:Zone
				mscorlib::System::Security::SecurityZone::__ENUM__  ZoneIdentityPermissionAttribute::get_Zone()
				{
				...
				mscorlib::System::Boolean  ZoneIdentityPermissionAttribute::get_Unrestricted()
				{
				...
				void ZoneIdentityPermissionAttribute::set_Unrestricted(mscorlib::System::Boolean  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
					__parameter_types__[0] = Global::GetType(typeid(value).name());
				...
				//	Get/Set:Action
				mscorlib::System::Security::Permissions::SecurityAction::__ENUM__  ZoneIdentityPermissionAttribute::get_Action()
				{
				...
				//	Get:TypeId
				mscorlib::System::Object  ZoneIdentityPermissionAttribute::get_TypeId()
				{
