	...
	namespace System
	{
		namespace Security
		{
			namespace Permissions
			{
				...
				//	Get/Set:Name
				mscorlib::System::String  StrongNameIdentityPermission::get_Name()
				{
				...
				//	Get/Set:PublicKey
				mscorlib::System::Security::Permissions::StrongNamePublicKeyBlob  StrongNameIdentityPermission::get_PublicKey()
				{
				...
				//	Get/Set:Version
				mscorlib::System::Version  StrongNameIdentityPermission::get_Version()
				{
