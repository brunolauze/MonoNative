		...
		namespace Security
		{
			namespace Permissions
			{
				...
				mscorlib::System::Security::Permissions::SecurityPermissionFlag::__ENUM__  SecurityPermission::get_Flags() const
				{
					...
					return static_cast<mscorlib::System::Security::Permissions::SecurityPermissionFlag::__ENUM__>(*(mscorlib::System::Security::Permissions::SecurityPermissionFlag::__ENUM__*)mono_object_unbox(__result__));
				}
