	...
	namespace System
	{
		namespace Security
		{
			namespace Permissions
			{
				...
				//	Get/Set:Open
				mscorlib::System::Boolean  FileDialogPermissionAttribute::get_Open()
				{
				...
				//	Get/Set:Save
				mscorlib::System::Boolean  FileDialogPermissionAttribute::get_Save()
				{
				...
				mscorlib::System::Boolean  FileDialogPermissionAttribute::get_Unrestricted()
				{
				...
				//	Get/Set:Action
				mscorlib::System::Security::Permissions::SecurityAction::__ENUM__  FileDialogPermissionAttribute::get_Action()
				{
				...
				//	Get:TypeId
				mscorlib::System::Object  FileDialogPermissionAttribute::get_TypeId()
				{
