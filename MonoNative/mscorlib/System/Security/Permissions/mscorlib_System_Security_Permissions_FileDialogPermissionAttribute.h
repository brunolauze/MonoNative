#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_PERMISSIONS_FILEDIALOGPERMISSIONATTRIBUTE_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_PERMISSIONS_FILEDIALOGPERMISSIONATTRIBUTE_H
	...
	namespace System
	{
		namespace Security
		{
			namespace Permissions
			{
				...
				{
				public:
					FileDialogPermissionAttribute(mscorlib::System::Security::Permissions::SecurityAction::__ENUM__ action)
					: mscorlib::System::Security::Permissions::CodeAccessSecurityAttribute(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Security.Permissions.FileDialogPermissionAttribute"))
					, mscorlib::System::Runtime::InteropServices::_Attribute(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Security.Permissions", "FileDialogPermissionAttribute", 1, __parameter_types__, __parameters__);
					};
				
					FileDialogPermissionAttribute(mscorlib::NativeTypeInfo *nativeTypeInfo)
					: mscorlib::System::Security::Permissions::CodeAccessSecurityAttribute(nativeTypeInfo)
					, mscorlib::System::Runtime::InteropServices::_Attribute(NULL)
					{
					};
				
					FileDialogPermissionAttribute(MonoObject *nativeObject)
					...
					FileDialogPermissionAttribute & operator=(FileDialogPermissionAttribute &value) { __native_object__ = value.GetNativeObject(); return value; };
					bool operator==(FileDialogPermissionAttribute &value) { return mscorlib::System::Object::Equals(value); };
					...
					//Public Properties
					__declspec(property(get=get_Open, put=set_Open)) mscorlib::System::Boolean  Open;
					__declspec(property(get=get_Save, put=set_Save)) mscorlib::System::Boolean  Save;
					...
					//	Get/Set:Open
					mscorlib::System::Boolean  get_Open() const;
					void set_Open(mscorlib::System::Boolean  value);

					//	Get/Set:Save
					mscorlib::System::Boolean  get_Save() const;
					void set_Save(mscorlib::System::Boolean  value);
