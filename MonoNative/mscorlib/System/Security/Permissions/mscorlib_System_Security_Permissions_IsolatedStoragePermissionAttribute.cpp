	...
	namespace System
	{
		namespace Security
		{
			namespace Permissions
			{
				...
				mscorlib::System::Security::Permissions::IsolatedStorageContainment::__ENUM__  IsolatedStoragePermissionAttribute::get_UsageAllowed()
				{
				...
				//	Get/Set:UserQuota
				mscorlib::System::Int64  IsolatedStoragePermissionAttribute::get_UserQuota()
				{
				...
				mscorlib::System::Boolean  IsolatedStoragePermissionAttribute::get_Unrestricted()
				{
				...
				//	Get/Set:Action
				mscorlib::System::Security::Permissions::SecurityAction::__ENUM__  IsolatedStoragePermissionAttribute::get_Action()
				{
				...
				//	Get:TypeId
				mscorlib::System::Object  IsolatedStoragePermissionAttribute::get_TypeId()
				{
