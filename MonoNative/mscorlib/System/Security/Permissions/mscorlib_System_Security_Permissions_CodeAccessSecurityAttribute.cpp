	...
	namespace System
	{
		namespace Security
		{
			namespace Permissions
			{
				...
				mscorlib::System::Boolean  CodeAccessSecurityAttribute::get_Unrestricted()
				{
				...
				//	Get/Set:Action
				mscorlib::System::Security::Permissions::SecurityAction::__ENUM__  CodeAccessSecurityAttribute::get_Action()
				{
				...
				//	Get:TypeId
				mscorlib::System::Object  CodeAccessSecurityAttribute::get_TypeId()
				{
