	...
	namespace System
	{
		namespace Security
		{
			namespace Permissions
			{
				...
				//	Get/Set:UserQuota
				mscorlib::System::Int64  IsolatedStorageFilePermission::get_UserQuota()
				{
				...
				mscorlib::System::Security::Permissions::IsolatedStorageContainment::__ENUM__  IsolatedStorageFilePermission::get_UsageAllowed()
				{
