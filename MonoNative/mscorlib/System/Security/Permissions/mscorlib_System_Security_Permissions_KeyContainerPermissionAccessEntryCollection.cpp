		...
		namespace Security
		{
			namespace Permissions
			{
				...
				void KeyContainerPermissionAccessEntryCollection::CopyTo(std::vector<mscorlib::System::Security::Permissions::KeyContainerPermissionAccessEntry*> array, mscorlib::System::Int32 index)
				{
						...
						__parameter_types__[0] = mono_class_get_type(mono_array_class_get(mono_class_from_mono_type(Global::GetType("mscorlib", "System.Security.Permissions", "KeyContainerPermissionAccessEntry")), 1));
