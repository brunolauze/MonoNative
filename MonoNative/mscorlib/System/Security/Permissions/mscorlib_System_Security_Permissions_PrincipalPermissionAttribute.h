#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_PERMISSIONS_PRINCIPALPERMISSIONATTRIBUTE_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_SECURITY_PERMISSIONS_PRINCIPALPERMISSIONATTRIBUTE_H
	...
	namespace System
	{
		namespace Security
		{
			namespace Permissions
			{
				...
				{
				public:
					PrincipalPermissionAttribute(mscorlib::System::Security::Permissions::SecurityAction::__ENUM__ action)
					: mscorlib::System::Security::Permissions::CodeAccessSecurityAttribute(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.Security.Permissions.PrincipalPermissionAttribute"))
					, mscorlib::System::Runtime::InteropServices::_Attribute(NULL)
					{
						...
						__native_object__ = Global::New("mscorlib", "System.Security.Permissions", "PrincipalPermissionAttribute", 1, __parameter_types__, __parameters__);
					};
				
					PrincipalPermissionAttribute(mscorlib::NativeTypeInfo *nativeTypeInfo)
					: mscorlib::System::Security::Permissions::CodeAccessSecurityAttribute(nativeTypeInfo)
					, mscorlib::System::Runtime::InteropServices::_Attribute(NULL)
					{
					};
				
					PrincipalPermissionAttribute(MonoObject *nativeObject)
					...
					PrincipalPermissionAttribute & operator=(PrincipalPermissionAttribute &value) { __native_object__ = value.GetNativeObject(); return value; };
					bool operator==(PrincipalPermissionAttribute &value) { return mscorlib::System::Object::Equals(value); };
					...
					//Public Properties
					__declspec(property(get=get_Authenticated, put=set_Authenticated)) mscorlib::System::Boolean  Authenticated;
					__declspec(property(get=get_Name, put=set_Name)) mscorlib::System::String  Name;
					__declspec(property(get=get_Role, put=set_Role)) mscorlib::System::String  Role;
					...
					mscorlib::System::Boolean  get_Authenticated() const;
					void set_Authenticated(mscorlib::System::Boolean  value);
					...
					//	Get/Set:Role
					mscorlib::System::String  get_Role() const;
					void set_Role(mscorlib::System::String  value);
