	...
	namespace System
	{
		namespace Security
		{
			namespace Permissions
			{
				...
				//Public Methods
				mscorlib::System::Security::IPermission GacIdentityPermissionAttribute::CreatePermission()
				{
						MonoObject *__result__ = Global::InvokeMethod("mscorlib", "System.Security.Permissions", "GacIdentityPermissionAttribute", 0, NULL, "CreatePermission", __native_object__, 0, NULL, NULL, NULL);
						return mscorlib::System::Security::IPermission(__result__);
				}

				//Get Set Properties Methods
				//	Get/Set:Unrestricted
				mscorlib::System::Boolean  GacIdentityPermissionAttribute::get_Unrestricted() const
				{
				...
				void GacIdentityPermissionAttribute::set_Unrestricted(mscorlib::System::Boolean  value)
				{
				...
				//	Get/Set:Action
				mscorlib::System::Security::Permissions::SecurityAction::__ENUM__  GacIdentityPermissionAttribute::get_Action() const
				{
				...
				void GacIdentityPermissionAttribute::set_Action(mscorlib::System::Security::Permissions::SecurityAction::__ENUM__  value)
				{
					MonoType *__parameter_types__[1];
					void *__parameters__[1];
					__parameter_types__[0] = Global::GetType(typeid(value).name());
				...
				//	Get:TypeId
				mscorlib::System::Object  GacIdentityPermissionAttribute::get_TypeId() const
				{
