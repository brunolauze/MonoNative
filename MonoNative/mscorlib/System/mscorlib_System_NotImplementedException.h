#ifndef __MONO_NATIVE_MSCORLIB_SYSTEM_NOTIMPLEMENTEDEXCEPTION_H
#define __MONO_NATIVE_MSCORLIB_SYSTEM_NOTIMPLEMENTEDEXCEPTION_H
...
namespace mscorlib
{
	namespace System
	{
		...
		public:
			...
			: mscorlib::System::SystemException(mscorlib::NativeTypeInfo::GetTypeInfo("mscorlib","System.NotImplementedException"))
			, mscorlib::System::Runtime::InteropServices::_Exception(NULL)
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				__native_object__ = Global::New("mscorlib", "System", "NotImplementedException");
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "NotImplementedException", 1, __parameter_types__, __parameters__);
			};
			...
			, mscorlib::System::Runtime::Serialization::ISerializable(NULL)
			{
				...
				__native_object__ = Global::New("mscorlib", "System", "NotImplementedException", 2, __parameter_types__, __parameters__);
			};
		
			NotImplementedException(mscorlib::NativeTypeInfo *nativeTypeInfo)
			...
			NotImplementedException(MonoObject *nativeObject)
			...
			NotImplementedException & operator=(NotImplementedException &value) { __native_object__ = value.GetNativeObject(); return value; };
			bool operator==(NotImplementedException &value) { return mscorlib::System::Object::Equals(value); };
