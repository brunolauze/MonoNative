...
namespace mscorlib
{
	namespace System
	{
		...
		//	Get:InnerException
		mscorlib::System::Exception  IndexOutOfRangeException::get_InnerException()
		{
		...
		//	Get/Set:HelpLink
		mscorlib::System::String  IndexOutOfRangeException::get_HelpLink()
		{
		...
		//	Get/Set:HResult
		mscorlib::System::Int32  IndexOutOfRangeException::get_HResult()
		{
		...
		//	Get:Message
		mscorlib::System::String  IndexOutOfRangeException::get_Message()
		{
		...
		//	Get/Set:Source
		mscorlib::System::String  IndexOutOfRangeException::get_Source()
		{
		...
		//	Get:StackTrace
		mscorlib::System::String  IndexOutOfRangeException::get_StackTrace()
		{
		...
		//	Get:TargetSite
		mscorlib::System::Reflection::MethodBase  IndexOutOfRangeException::get_TargetSite()
		{
		...
		//	Get:Data
		mscorlib::System::Collections::IDictionary  IndexOutOfRangeException::get_Data()
		{
