...
namespace mscorlib
{
	namespace System
	{
		...
		//	Get:InnerException
		mscorlib::System::Exception  FormatException::get_InnerException() const
		{
		...
		//	Get/Set:HelpLink
		mscorlib::System::String  FormatException::get_HelpLink() const
		{
		...
		void FormatException::set_HelpLink(mscorlib::System::String  value)
		{
		...
		//	Get/Set:HResult
		mscorlib::System::Int32  FormatException::get_HResult() const
		{
		...
		void FormatException::set_HResult(mscorlib::System::Int32  value)
		{
			MonoType *__parameter_types__[1];
			void *__parameters__[1];
			__parameter_types__[0] = Global::GetType(typeid(value).name());
		...
		//	Get:Message
		mscorlib::System::String  FormatException::get_Message() const
		{
		...
		//	Get:StackTrace
		mscorlib::System::String  FormatException::get_StackTrace() const
		{
		...
		//	Get:TargetSite
		mscorlib::System::Reflection::MethodBase  FormatException::get_TargetSite() const
		{
		...
		//	Get:Data
		mscorlib::System::Collections::IDictionary  FormatException::get_Data() const
		{
