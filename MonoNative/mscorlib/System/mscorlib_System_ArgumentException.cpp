...
namespace mscorlib
{
	namespace System
	{
		...
		//Public Methods
		void ArgumentException::GetObjectData(mscorlib::System::Runtime::Serialization::SerializationInfo info, mscorlib::System::Runtime::Serialization::StreamingContext context)
		{
				...
				Global::InvokeMethod("mscorlib", "System", "ArgumentException", 0, NULL, "GetObjectData", __native_object__, 2, __parameter_types__, __parameters__, NULL);
		}

		//Get Set Properties Methods
		//	Get:ParamName
		mscorlib::System::String  ArgumentException::get_ParamName() const
		{
		...
		//	Get:Message
		mscorlib::System::String  ArgumentException::get_Message() const
		{
		...
		//	Get:InnerException
		mscorlib::System::Exception  ArgumentException::get_InnerException() const
		{
		...
		//	Get/Set:HelpLink
		mscorlib::System::String  ArgumentException::get_HelpLink() const
		{
		...
		void ArgumentException::set_HelpLink(mscorlib::System::String  value)
		{
		...
		//	Get/Set:HResult
		mscorlib::System::Int32  ArgumentException::get_HResult() const
		{
		...
		void ArgumentException::set_HResult(mscorlib::System::Int32  value)
		{
			MonoType *__parameter_types__[1];
			void *__parameters__[1];
			__parameter_types__[0] = Global::GetType(typeid(value).name());
		...
		//	Get:StackTrace
		mscorlib::System::String  ArgumentException::get_StackTrace() const
		{
		...
		//	Get:TargetSite
		mscorlib::System::Reflection::MethodBase  ArgumentException::get_TargetSite() const
		{
		...
		//	Get:Data
		mscorlib::System::Collections::IDictionary  ArgumentException::get_Data() const
		{
