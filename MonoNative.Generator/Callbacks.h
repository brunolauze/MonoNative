...
#ifndef __MSCORLIB_CALLBACKS_H
#define __MSCORLIB_CALLBACKS_H

#define __MSCORLIB_GET_CALLBACK_FACTORY_BIND_FREE(freeFuncPtr) \
    (mscorlib::GetCallbackFactory(freeFuncPtr).Bind<freeFuncPtr>())
#define BIND_FREE_CB __MSCORLIB_GET_CALLBACK_FACTORY_BIND_FREE

#define __MSCORLIB_GET_CALLBACK_FACTORY_BIND_MEMBER(memFuncPtr, instancePtr) \
    (mscorlib::GetCallbackFactory(memFuncPtr).Bind<memFuncPtr>(instancePtr))
#define BIND_MEM_CB __MSCORLIB_GET_CALLBACK_FACTORY_BIND_MEMBER
