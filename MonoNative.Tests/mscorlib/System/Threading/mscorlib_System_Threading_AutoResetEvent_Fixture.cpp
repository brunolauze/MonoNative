...
// Name: AutoResetEvent
// C++ Typed Name: mscorlib::System::Threading::AutoResetEvent
...
namespace mscorlib
{
	namespace System
	{
		namespace Threading
		{
			...
			TEST(mscorlib_System_Threading_AutoResetEvent_Fixture,Constructor_1)
			{
			...
			//			Property Get Method
			TEST(mscorlib_System_Threading_AutoResetEvent_Fixture,get_Handle_Test)
			{
			...
			//		Return Type: mscorlib::System::IntPtr
			//			Property Set Method
			TEST(mscorlib_System_Threading_AutoResetEvent_Fixture,set_Handle_Test)
			{
			...
			//			Property Get Method
			TEST(mscorlib_System_Threading_AutoResetEvent_Fixture,get_SafeWaitHandle_Test)
			{
			...
			//		Return Type: mscorlib::Microsoft::Win32::SafeHandles::SafeWaitHandle
			//			Property Set Method
			TEST(mscorlib_System_Threading_AutoResetEvent_Fixture,set_SafeWaitHandle_Test)
			{
