...
// C++ Typed Name: mscorlib::System::Reflection::Emit::CustomAttributeBuilder
	...
	namespace System
	{
		namespace Reflection
		{
			namespace Emit
			{
				...
				TEST(mscorlib_System_Reflection_Emit_CustomAttributeBuilder_Fixture,Constructor_1)
				{
				...
				TEST(mscorlib_System_Reflection_Emit_CustomAttributeBuilder_Fixture,Constructor_2)
				{
				...
				TEST(mscorlib_System_Reflection_Emit_CustomAttributeBuilder_Fixture,Constructor_3)
				{
				...
				TEST(mscorlib_System_Reflection_Emit_CustomAttributeBuilder_Fixture,Constructor_4)
				{
